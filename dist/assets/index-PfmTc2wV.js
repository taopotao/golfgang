 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Iy;function eI(){if(Iy)return ol;Iy=1;var n=rp(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,o=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function c(h,p,y){var w,T={},S=null,R=null;y!==void 0&&(S=""+y),p.key!==void 0&&(S=""+p.key),p.ref!==void 0&&(R=p.ref);for(w in p)i.call(p,w)&&!l.hasOwnProperty(w)&&(T[w]=p[w]);if(h&&h.defaultProps)for(w in p=h.defaultProps,p)T[w]===void 0&&(T[w]=p[w]);return{$$typeof:e,type:h,key:S,ref:R,props:T,_owner:o.current}}return ol.Fragment=t,ol.jsx=c,ol.jsxs=c,ol}var Sy;function tI(){return Sy||(Sy=1,Zh.exports=eI()),Zh.exports}var v=tI(),$=rp();const O_=D_($),nI=XT({__proto__:null,default:O_},[$]);var ic={},tf={exports:{}},hn={},nf={exports:{}},rf={};/**
 * @license React
 ...
 *
 * @license MIT
 */function wl(){return wl=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(n[i]=t[i])}return n},wl.apply(this,arguments)}const lp=$.createContext(null),LI=$.createContext(null),Xi=$.createContext(null),Jc=$.createContext(null),ai=$.createContext({outlet:null,matches:[],isDataRoute:!1}),F_=$.createContext(null);function jI(n,e){let{relative:t}=e===void 0?{}:e;oa()||mt(!1);let{basename:i,navigator:o}=$.useContext(Xi),{hash:l,pathname:c,search:h}=B_(n,{relative:t}),p=c;return i!=="/"&&(p=c==="/"?i:Ui([i,c])),o.createHref({pathname:p,search:h,hash:l})}function oa(){return $.useContext(Jc)!=null}function aa(){return oa()||mt(!1),$.useContext(Jc).location}function U_(n){$.useContext(Xi).static||$.useLayoutEffect(n)}function la(){let{isDataRoute:n}=$.useContext(ai);return n?JI():MI()}function MI(){oa()||mt(!1);let n=$.useContext(lp),{basename:e,future:t,navigator:i}=$.useContext(Xi),{matches:o}=$.useContext(ai),{pathname:l}=aa(),c=JSON.stringify(op(o,t.v7_relativeSplatPath)),h=$.useRef(!1);return U_(()=>{h.current=!0}),$.useCallback(function(y,w){if(w===void 0&&(w={}),!h.current)return;if(typeof y=="number"){i.go(y);return}let T=ap(y,JSON.parse(c),l,w.relative==="path");n==null&&e!=="/"&&(T.pathname=T.pathname==="/"?e:Ui([e,T.pathname])),(w.replace?i.replace:i.push)(T,w.state,w)},[e,i,c,l,n])}function FI(){let{matches:n}=$.useContext(ai),e=n[n.length-1];return e?e.params:{}}function B_(n,e){let{relative:t}=e===void 0?{}:e,{future:i}=$.useContext(Xi),{matches:o}=$.useContext(ai),{pathname:l}=aa(),c=JSON.stringify(op(o,i.v7_relativeSplatPath));return $.useMemo(()=>ap(n,JSON.parse(c),l,t==="path"),[n,c,l,t])}function UI(n,e){return BI(n,e)}function BI(n,e,t,i){oa()||mt(!1);let{navigator:o}=$.useContext(Xi),{matches:l}=$.useContext(ai),c=l[l.length-1],h=c?c.params:{};c&&c.pathname;let p=c?c.pathnameBase:"/";c&&c.route;let y=aa(),w;if(e){var T;let M=typeof e=="string"?sa(e):e;p==="/"||(T=M.pathname)!=null&&T.startsWith(p)||mt(!1),w=M}else w=y;let S=w.pathname||"/",R=S;if(p!=="/"){let M=p.replace(/^\//,"").split("/");R="/"+S.replace(/^\//,"").split("/").slice(M.length).join("/")}let j=hI(n,{pathname:R}),z=HI(j&&j.map(M=>Object.assign({},M,{params:Object.assign({},h,M.params),pathname:Ui([p,o.encodeLocation?o.encodeLocation(M.pathname).pathname:M.pathname]),pathnameBase:M.pathnameBase==="/"?p:Ui([p,o.encodeLocation?o.encodeLocation(M.pathnameBase).pathname:M.pathnameBase])})),l,t,i);return e&&z?$.createElement(Jc.Provider,{value:{location:wl({pathname:"/",search:"",hash:"",state:null,key:"default"},w),navigationType:Mi.Pop}},z):z}function zI(){let n=YI(),e=OI(n)?n.status+" "+n.statusText:n instanceof Error?n.message:JSON.stringify(n),t=n instanceof Error?n.stack:null,o={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return $.createElement($.Fragment,null,$.createElement("h2",null,"Unexpected Application Error!"),$.createElement("h3",{style:{fontStyle:"italic"}},e),t?$.createElement("pre",{style:o},t):null,null)}const $I=$.createElement(zI,null);class WI extends $.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:t.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){console.error("React Router caught the following error during render",e,t)}render(){return this.state.error!==void 0?$.createElement(ai.Provider,{value:this.props.routeContext},$.createElement(F_.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function qI(n){let{routeContext:e,match:t,children:i}=n,o=$.useContext(lp);return o&&o.static&&o.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=t.route.id),$.createElement(ai.Provider,{value:e},i)}function HI(n,e,t,i){var o;if(e===void 0&&(e=[]),t===void 0&&(t=null),i===void 0&&(i=null),n==null){var l;if(!t)return null;if(t.errors)n=t.matches;else if((l=i)!=null&&l.v7_partialHydration&&e.length===0&&!t.initialized&&t.matches.length>0)n=t.matches;else return null}let c=n,h=(o=t)==null?void 0:o.errors;if(h!=null){let w=c.findIndex(T=>T.route.id&&(h==null?void 0:h[T.route.id])!==void 0);w>=0||mt(!1),c=c.slice(0,Math.min(c.length,w+1))}let p=!1,y=-1;if(t&&i&&i.v7_partialHydration)for(let w=0;w<c.length;w++){let T=c[w];if((T.route.HydrateFallback||T.route.hydrateFallbackElement)&&(y=w),T.route.id){let{loaderData:S,errors:R}=t,j=T.route.loader&&S[T.route.id]===void 0&&(!R||R[T.route.id]===void 0);if(T.route.lazy||j){p=!0,y>=0?c=c.slice(0,y+1):c=[c[0]];break}}}return c.reduceRight((w,T,S)=>{let R,j=!1,z=null,M=null;t&&(R=h&&T.route.id?h[T.route.id]:void 0,z=T.route.errorElement||$I,p&&(y<0&&S===0?(XI("route-fallback"),j=!0,M=null):y===S&&(j=!0,M=T.route.hydrateFallbackElement||null)));let ee=e.concat(c.slice(0,S+1)),se=()=>{let J;return R?J=z:j?J=M:T.route.Component?J=$.createElement(T.route.Component,null):T.route.element?J=T.route.element:J=w,$.createElement(qI,{match:T,routeContext:{outlet:w,matches:ee,isDataRoute:t!=null},children:J})};return t&&(T.route.ErrorBoundary||T.route.errorElement||S===0)?$.createElement(WI,{location:t.location,revalidation:t.revalidation,component:z,error:R,children:se(),routeContext:{outlet:null,matches:ee,isDataRoute:!0}}):se()},null)}var z_=(function(n){return n.UseBlocker="useBlocker",n.UseRevalidator="useRevalidator",n.UseNavigateStable="useNavigate",n})(z_||{}),$_=(function(n){return n.UseBlocker="useBlocker",n.UseLoaderData="useLoaderData",n.UseActionData="useActionData",n.UseRouteError="useRouteError",n.UseNavigation="useNavigation",n.UseRouteLoaderData="useRouteLoaderData",n.UseMatches="useMatches",n.UseRevalidator="useRevalidator",n.UseNavigateStable="useNavigate",n.UseRouteId="useRouteId",n})($_||{});function KI(n){let e=$.useContext(lp);return e||mt(!1),e}function GI(n){let e=$.useContext(LI);return e||mt(!1),e}function QI(n){let e=$.useContext(ai);return e||mt(!1),e}function W_(n){let e=QI(),t=e.matches[e.matches.length-1];return t.route.id||mt(!1),t.route.id}function YI(){var n;let e=$.useContext(F_),t=GI(),i=W_();return e!==void 0?e:(n=t.errors)==null?void 0:n[i]}function JI(){let{router:n}=KI(z_.UseNavigateStable),e=W_($_.UseNavigateStable),t=$.useRef(!1);return U_(()=>{t.current=!0}),$.useCallback(function(o,l){l===void 0&&(l={}),t.current&&(typeof o=="number"?n.navigate(o):n.navigate(o,wl({fromRouteId:e},l)))},[n,e])}const Vy={};function XI(n,e,t){Vy[n]||(Vy[n]=!0)}function ZI(n,e){n==null||n.v7_startTransition,n==null||n.v7_relativeSplatPath}function Ac(n){let{to:e,replace:t,state:i,relative:o}=n;oa()||mt(!1);let{future:l,static:c}=$.useContext(Xi),{matches:h}=$.useContext(ai),{pathname:p}=aa(),y=la(),w=ap(e,op(h,l.v7_relativeSplatPath),p,o==="path"),T=JSON.stringify(w);return $.useEffect(()=>y(JSON.parse(T),{replace:t,state:i,relative:o}),[y,T,o,t,i]),null}function jn(n){mt(!1)}function eS(n){let{basename:e="/",children:t=null,location:i,navigationType:o=Mi.Pop,navigator:l,static:c=!1,future:h}=n;oa()&&mt(!1);let p=e.replace(/^\/*/,"/"),y=$.useMemo(()=>({basename:p,navigator:l,static:c,future:wl({v7_relativeSplatPath:!1},h)}),[p,h,l,c]);typeof i=="string"&&(i=sa(i));let{pathname:w="/",search:T="",hash:S="",state:R=null,key:j="default"}=i,z=$.useMemo(()=>{let M=sp(w,p);return M==null?null:{location:{pathname:M,search:T,hash:S,state:R,key:j},navigationType:o}},[p,w,T,S,R,j,o]);return z==null?null:$.createElement(Xi.Provider,{value:y},$.createElement(Jc.Provider,{children:t,value:z}))}function tS(n){let{children:e,location:t}=n;return UI(Af(e),t)}new Promise(()=>{});function Af(n,e){e===void 0&&(e=[]);let t=[];return $.Children.forEach(n,(i,o)=>{if(!$.isValidElement(i))return;let l=[...e,o];if(i.type===$.Fragment){t.push.apply(t,Af(i.props.children,l));return}i.type!==jn&&mt(!1),!i.props.index||!i.props.children||mt(!1);let c={id:i.props.id||l.join("-"),caseSensitive:i.props.caseSensitive,element:i.props.element,Component:i.props.Component,index:i.props.index,path:i.props.path,loader:i.props.loader,action:i.props.action,errorElement:i.props.errorElement,ErrorBoundary:i.props.ErrorBoundary,hasErrorBoundary:i.props.ErrorBoundary!=null||i.props.errorElement!=null,shouldRevalidate:i.props.shouldRevalidate,handle:i.props.handle,lazy:i.props.lazy};i.props.children&&(c.children=Af(i.props.children,l)),t.push(c)}),t}/**
 ...
 *
 * @license MIT
 */function kf(){return kf=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(n[i]=t[i])}return n},kf.apply(this,arguments)}function nS(n,e){if(n==null)return{};var t={},i=Object.keys(n),o,l;for(l=0;l<i.length;l++)o=i[l],!(e.indexOf(o)>=0)&&(t[o]=n[o]);return t}function rS(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function iS(n,e){return n.button===0&&(!e||e==="_self")&&!rS(n)}const sS=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],oS="6";try{window.__reactRouterVersion=oS}catch{}const aS="startTransition",Ly=nI[aS];function lS(n){let{basename:e,children:t,future:i,window:o}=n,l=$.useRef();l.current==null&&(l.current=uI({window:o,v5Compat:!0}));let c=l.current,[h,p]=$.useState({action:c.action,location:c.location}),{v7_startTransition:y}=i||{},w=$.useCallback(T=>{y&&Ly?Ly(()=>p(T)):p(T)},[p,y]);return $.useLayoutEffect(()=>c.listen(w),[c,w]),$.useEffect(()=>ZI(i),[i]),$.createElement(eS,{basename:e,children:t,location:h.location,navigationType:h.action,navigator:c,future:i})}const uS=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",cS=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Mn=$.forwardRef(function(e,t){let{onClick:i,relative:o,reloadDocument:l,replace:c,state:h,target:p,to:y,preventScrollReset:w,viewTransition:T}=e,S=nS(e,sS),{basename:R}=$.useContext(Xi),j,z=!1;if(typeof y=="string"&&cS.test(y)&&(j=y,uS))try{let J=new URL(window.location.href),ge=y.startsWith("//")?new URL(J.protocol+y):new URL(y),Re=sp(ge.pathname,R);ge.origin===J.origin&&Re!=null?y=Re+ge.search+ge.hash:z=!0}catch{}let M=jI(y,{relative:o}),ee=dS(y,{replace:c,state:h,target:p,preventScrollReset:w,relative:o,viewTransition:T});function se(J){i&&i(J),J.defaultPrevented||ee(J)}return $.createElement("a",kf({},S,{href:j||M,onClick:z||l?i:se,ref:t,target:p}))});var jy;(function(n){n.UseScrollRestoration="useScrollRestoration",n.UseSubmit="useSubmit",n.UseSubmitFetcher="useSubmitFetcher",n.UseFetcher="useFetcher",n.useViewTransitionState="useViewTransitionState"})(jy||(jy={}));var My;(function(n){n.UseFetcher="useFetcher",n.UseFetchers="useFetchers",n.UseScrollRestoration="useScrollRestoration"})(My||(My={}));function dS(n,e){let{target:t,replace:i,state:o,preventScrollReset:l,relative:c,viewTransition:h}=e===void 0?{}:e,p=la(),y=aa(),w=B_(n,{relative:c});return $.useCallback(T=>{if(iS(T,t)){T.preventDefault();let S=i!==void 0?i:Sc(y)===Sc(w);p(n,{replace:S,state:o,preventScrollReset:l,relative:c,viewTransition:h})}},[y,p,w,i,o,t,n,l,c,h])}const hS=()=>{};var Fy={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xc=new dp("@firebase/auth");function K1(n,...e){xc.logLevel<=Ve.WARN&&xc.warn(`Auth (${ua}): ${n}`,...e)}function pc(n,...e){xc.logLevel<=Ve.ERROR&&xc.error(`Auth (${ua}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bf(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function G1(){return Yy()==="http:"||Yy()==="https:"}function Yy(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Q1(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(G1()||CS()||"connection"in navigator)?navigator.onLine:!0}function Y1(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CA(n,e){const t=$s(n,"auth");if(t.isInitialized()){const o=t.getImmediate(),l=t.getOptions();if(ti(l,e??{}))return o;lr(o,"already-initialized")}return t.initialize({options:e})}function xA(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(Xr);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function RA(n,e,t){const i=Zi(n);Ae(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const o=!1,l=Sw(e),{host:c,port:h}=PA(e),p=h===null?"":`:${h}`,y={url:`${l}//${c}${p}/`},w=Object.freeze({host:c,port:h,protocol:l.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!i._canInitEmulator){Ae(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),Ae(ti(y,i.config.emulator)&&ti(w,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=y,i.emulatorConfig=w,i.settings.appVerificationDisabledForTesting=!0,Bs(c)?(up(`${l}//${c}${p}`),cp("Auth",!0)):NA()}function Sw(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function PA(n){const e=Sw(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(i);if(o){const l=o[1];return{host:l,port:iv(i.substr(l.length+1))}}else{const[l,c]=i.split(":");return{host:l,port:iv(c)}}}function iv(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function NA(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UA(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function BA(n){const e=al(ll(n)).link,t=e?al(ll(e)).deep_link_id:null,i=al(ll(n)).deep_link_id;return(i?al(ll(i)).link:null)||i||t||e||n}class _p{constructor(e){var t,i,o,l,c,h;const p=al(ll(e)),y=(t=p.apiKey)!==null&&t!==void 0?t:null,w=(i=p.oobCode)!==null&&i!==void 0?i:null,T=UA((o=p.mode)!==null&&o!==void 0?o:null);Ae(y&&w&&T,"argument-error"),this.apiKey=y,this.operation=T,this.code=w,this.continueUrl=(l=p.continueUrl)!==null&&l!==void 0?l:null,this.languageCode=(c=p.lang)!==null&&c!==void 0?c:null,this.tenantId=(h=p.tenantId)!==null&&h!==void 0?h:null}static parseLink(e){const t=BA(e);try{return new _p(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fw{constructor(e,t,i,o,l=!1){this.auth=e,this.resolver=i,this.user=o,this.bypassAuthState=l,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:o,tenantId:l,error:c,type:h}=e;if(c){this.reject(c);return}const p={auth:this.auth,requestUri:t,sessionId:i,tenantId:l||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(h)(p))}catch(y){this.reject(y)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return yk;case"linkViaPopup":case"linkViaRedirect":return _k;case"reauthViaPopup":case"reauthViaRedirect":return vk;default:lr(this.auth,"internal-error")}}resolve(e){ri(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){ri(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hk={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Kk=500,Gk=600,Qk="_blank",Yk="http://localhost";class cv{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Jk(n,e,t,i=Kk,o=Gk){const l=Math.max((window.screen.availHeight-o)/2,0).toString(),c=Math.max((window.screen.availWidth-i)/2,0).toString();let h="";const p=Object.assign(Object.assign({},Hk),{width:i.toString(),height:o.toString(),top:l,left:c}),y=Jt().toLowerCase();t&&(h=mw(y)?Qk:t),fw(y)&&(e=e||Yk,p.scrollbars="yes");const w=Object.entries(p).reduce((S,[R,j])=>`${S}${R}=${j},`,"");if(hA(y)&&h!=="_self")return Xk(e||"",h),new cv(null);const T=window.open(e||"",h,w);Ae(T,n,"popup-blocked");try{T.focus()}catch{}return new cv(T)}function Xk(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oC(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function aC(n){ar(new Bn("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:h}=i.options;Ae(c&&!c.includes(":"),"invalid-api-key",{appName:i.name});const p={apiKey:c,authDomain:h,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ew(n)},y=new vA(i,o,l,p);return xA(y,t),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),ar(new Bn("auth-internal",e=>{const t=Zi(e.getProvider("auth").getImmediate());return(i=>new sC(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),yn(hv,fv,oC(n)),yn(hv,fv,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ke(n,e,t){let i="Unexpected state";typeof e=="string"?i=e:t=e,Kw(n,i,t)}function Kw(n,e,t){let i=`FIRESTORE (${ca}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{i+=" CONTEXT: "+JSON.stringify(t)}catch{i+=" CONTEXT: "+t}throw ii(i),new Error(i)}function qe(n,e,t,i){let o="Unexpected state";typeof t=="string"?o=t:i=t,n||Kw(e,o,i)}function Pe(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function da(n){if(n.code!==G.FAILED_PRECONDITION||n.message!==xC)throw n;de("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e((t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)}),(t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)}))}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&ke(59440),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new Q(((i,o)=>{this.nextCallback=l=>{this.wrapSuccess(e,l).next(i,o)},this.catchCallback=l=>{this.wrapFailure(t,l).next(i,o)}}))}toPromise(){return new Promise(((e,t)=>{this.next(e,t)}))}wrapUserFunction(e){try{const t=e();return t instanceof Q?t:Q.resolve(t)}catch(t){return Q.reject(t)}}wrapSuccess(e,t){return e?this.wrapUserFunction((()=>e(t))):Q.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction((()=>e(t))):Q.reject(t)}static resolve(e){return new Q(((t,i)=>{t(e)}))}static reject(e){return new Q(((t,i)=>{i(e)}))}static waitFor(e){return new Q(((t,i)=>{let o=0,l=0,c=!1;e.forEach((h=>{++o,h.next((()=>{++l,c&&l===o&&t()}),(p=>i(p)))})),c=!0,l===o&&t()}))}static or(e){let t=Q.resolve(!1);for(const i of e)t=t.next((o=>o?Q.resolve(o):i()));return t}static forEach(e,t){const i=[];return e.forEach(((o,l)=>{i.push(t.call(this,o,l))})),this.waitFor(i)}static mapArray(e,t){return new Q(((i,o)=>{const l=e.length,c=new Array(l);let h=0;for(let p=0;p<l;p++){const y=p;t(e[y]).next((w=>{c[y]=w,++h,h===l&&i(c)}),(w=>o(w)))}}))}static doWhile(e,t){return new Q(((i,o)=>{const l=()=>{e()===!0?t().next((()=>{l()}),o):i()};l()}))}}function PC(n){const e=n.match(/Android ([\d.]+)/i),t=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(t)}function ha(n){return n.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tE="server_timestamp",nE="__type__",rE="__previous_value__",iE="__local_write_time__";function Ap(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{})[nE])===null||t===void 0?void 0:t.stringValue)===tE}function ad(n){const e=n.mapValue.fields[rE];return Ap(e)?ad(e):e}function Sl(n){const e=Hi(n.mapValue.fields[iE].timestampValue);return new Qe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VC{constructor(e,t,i,o,l,c,h,p,y,w){this.databaseId=e,this.appId=t,this.persistenceKey=i,this.host=o,this.ssl=l,this.forceLongPolling=c,this.autoDetectLongPolling=h,this.longPollingOptions=p,this.useFetchStreams=y,this.isUsingEmulator=w}}const Lc="(default)";class Al{constructor(e,t){this.projectId=e,this.database=t||Lc}static empty(){return new Al("","")}get isDefaultDatabase(){return this.database===Lc}isEqual(e){return e instanceof Al&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lE{}class Et extends lE{constructor(e,t,i){super(),this.field=e,this.op=t,this.value=i}static create(e,t,i){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,i):new BC(e,t,i):t==="array-contains"?new WC(e,i):t==="in"?new qC(e,i):t==="not-in"?new HC(e,i):t==="array-contains-any"?new KC(e,i):new Et(e,t,i)}static createKeyFieldInFilter(e,t,i){return t==="in"?new zC(e,i):new $C(e,i)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(Jo(t,this.value)):t!==null&&Gi(this.value)===Gi(t)&&this.matchesComparison(Jo(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return ke(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ur extends lE{constructor(e,t){super(),this.filters=e,this.op=t,this.he=null}static create(e,t){return new ur(e,t)}matches(e){return uE(this)?this.filters.find((t=>!t.matches(e)))===void 0:this.filters.find((t=>t.matches(e)))!==void 0}getFlattenedFilters(){return this.he!==null||(this.he=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.he}getFilters(){return Object.assign([],this.filters)}}function uE(n){return n.op==="and"}function cE(n){return UC(n)&&uE(n)}function UC(n){for(const e of n.filters)if(e instanceof ur)return!1;return!0}function Ff(n){if(n instanceof Et)return n.field.canonicalString()+n.op.toString()+Xo(n.value);if(cE(n))return n.filters.map((e=>Ff(e))).join(",");{const e=n.filters.map((t=>Ff(t))).join(",");return`${n.op}(${e})`}}function dE(n,e){return n instanceof Et?(function(i,o){return o instanceof Et&&i.op===o.op&&i.field.isEqual(o.field)&&Pr(i.value,o.value)})(n,e):n instanceof ur?(function(i,o){return o instanceof ur&&i.op===o.op&&i.filters.length===o.filters.length?i.filters.reduce(((l,c,h)=>l&&dE(c,o.filters[h])),!0):!1})(n,e):void ke(19439)}function hE(n){return n instanceof Et?(function(t){return`${t.field.canonicalString()} ${t.op} ${Xo(t.value)}`})(n):n instanceof ur?(function(t){return t.op.toString()+" {"+t.getFilters().map(hE).join(" ,")+"}"})(n):"Filter"}class BC extends Et{constructor(e,t,i){super(e,t,i),this.key=Ee.fromName(i.referenceValue)}matches(e){const t=Ee.comparator(e.key,this.key);return this.matchesComparison(t)}}class zC extends Et{constructor(e,t){super(e,"in",t),this.keys=fE("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class $C extends Et{constructor(e,t){super(e,"not-in",t),this.keys=fE("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function fE(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map((i=>Ee.fromName(i.referenceValue)))}class WC extends Et{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return kp(t)&&kl(t.arrayValue,this.value)}}class qC extends Et{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&kl(this.value.arrayValue,t)}}class HC extends Et{constructor(e,t){super(e,"not-in",t)}matches(e){if(kl(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!kl(this.value.arrayValue,t)}}class KC extends Et{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!kp(t)||!t.arrayValue.values)&&t.arrayValue.values.some((i=>kl(this.value.arrayValue,i)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GC{constructor(e,t=null,i=[],o=[],l=null,c=null,h=null){this.path=e,this.collectionGroup=t,this.orderBy=i,this.filters=o,this.limit=l,this.startAt=c,this.endAt=h,this.Pe=null}}function Vv(n,e=null,t=[],i=[],o=null,l=null,c=null){return new GC(n,e,t,i,o,l,c)}function Cp(n){const e=Pe(n);if(e.Pe===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map((i=>Ff(i))).join(","),t+="|ob:",t+=e.orderBy.map((i=>(function(l){return l.field.canonicalString()+l.dir})(i))).join(","),od(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((i=>Xo(i))).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((i=>Xo(i))).join(",")),e.Pe=t}return e.Pe}function xp(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!FC(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!dE(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Ov(n.startAt,e.startAt)&&Ov(n.endAt,e.endAt)}function Uf(n){return Ee.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZC=new ut(Ee.comparator);function si(){return ZC}const yE=new ut(Ee.comparator);function cl(...n){let e=yE;for(const t of n)e=e.insert(t.key,t);return e}function vE(n){let e=yE;return n.forEach(((t,i)=>e=e.insert(t,i.overlayedDocument))),e}function Ns(){return yl()}function _E(){return yl()}function yl(){return new qs((n=>n.toString()),((n,e)=>n.isEqual(e)))}const ex=new ut(Ee.comparator),tx=new xt(Ee.comparator);function Le(...n){let e=tx;for(const t of n)e=e.add(t);return e}const nx=new xt(De);function rx(){return nx}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rp(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Vc(e)?"-0":e}}function wE(n){return{integerValue:""+n}}function ix(n,e){return NC(e)?wE(e):Rp(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dd{constructor(){this._=void 0}}function sx(n,e,t){return n instanceof Uc?(function(o,l){const c={fields:{[nE]:{stringValue:tE},[iE]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return l&&Ap(l)&&(l=ad(l)),l&&(c.fields[rE]=l),{mapValue:c}})(t,e):n instanceof Zo?TE(n,e):n instanceof ea?IE(n,e):(function(o,l){const c=EE(o,l),h=jv(c)+jv(o.Ee);return Mf(c)&&Mf(o.Ee)?wE(h):Rp(o.serializer,h)})(n,e)}function ox(n,e,t){return n instanceof Zo?TE(n,e):n instanceof ea?IE(n,e):t}function EE(n,e){return n instanceof Bc?(function(i){return Mf(i)||(function(l){return!!l&&"doubleValue"in l})(i)})(e)?e:{integerValue:0}:null}class Uc extends dd{}class Zo extends dd{constructor(e){super(),this.elements=e}}function TE(n,e){const t=SE(e);for(const i of n.elements)t.some((o=>Pr(o,i)))||t.push(i);return{arrayValue:{values:t}}}class ea extends dd{constructor(e){super(),this.elements=e}}function IE(n,e){let t=SE(e);for(const i of n.elements)t=t.filter((o=>!Pr(o,i)));return{arrayValue:{values:t}}}class Bc extends dd{constructor(e,t){super(),this.serializer=e,this.Ee=t}}function jv(n){return pt(n.integerValue||n.doubleValue)}function SE(n){return kp(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AE{constructor(e,t){this.field=e,this.transform=t}}function ax(n,e){return n.field.isEqual(e.field)&&(function(i,o){return i instanceof Zo&&o instanceof Zo||i instanceof ea&&o instanceof ea?Yo(i.elements,o.elements,Pr):i instanceof Bc&&o instanceof Bc?Pr(i.Ee,o.Ee):i instanceof Uc&&o instanceof Uc})(n.transform,e.transform)}class lx{constructor(e,t){this.version=e,this.transformResults=t}}class Un{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Un}static exists(e){return new Un(void 0,e)}static updateTime(e){return new Un(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Ec(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class hd{}function kE(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Pp(n.key,Un.none()):new Ll(n.key,n.data,Un.none());{const t=n.data,i=mn.empty();let o=new xt(Bt.comparator);for(let l of e.fields)if(!o.has(l)){let c=t.field(l);c===null&&l.length>1&&(l=l.popLast(),c=t.field(l)),c===null?i.delete(l):i.set(l,c),o=o.add(l)}return new ts(n.key,i,new kn(o.toArray()),Un.none())}}function ux(n,e,t){n instanceof Ll?(function(o,l,c){const h=o.value.clone(),p=Fv(o.fieldTransforms,l,c.transformResults);h.setAll(p),l.convertToFoundDocument(c.version,h).setHasCommittedMutations()})(n,e,t):n instanceof ts?(function(o,l,c){if(!Ec(o.precondition,l))return void l.convertToUnknownDocument(c.version);const h=Fv(o.fieldTransforms,l,c.transformResults),p=l.data;p.setAll(CE(o)),p.setAll(h),l.convertToFoundDocument(c.version,p).setHasCommittedMutations()})(n,e,t):(function(o,l,c){l.convertToNoDocument(c.version).setHasCommittedMutations()})(0,e,t)}function vl(n,e,t,i){return n instanceof Ll?(function(l,c,h,p){if(!Ec(l.precondition,c))return h;const y=l.value.clone(),w=Uv(l.fieldTransforms,p,c);return y.setAll(w),c.convertToFoundDocument(c.version,y).setHasLocalMutations(),null})(n,e,t,i):n instanceof ts?(function(l,c,h,p){if(!Ec(l.precondition,c))return h;const y=Uv(l.fieldTransforms,p,c),w=c.data;return w.setAll(CE(l)),w.setAll(y),c.convertToFoundDocument(c.version,w).setHasLocalMutations(),h===null?null:h.unionWith(l.fieldMask.fields).unionWith(l.fieldTransforms.map((T=>T.field)))})(n,e,t,i):(function(l,c,h){return Ec(l.precondition,c)?(c.convertToNoDocument(c.version).setHasLocalMutations(),null):h})(n,e,t)}function cx(n,e){let t=null;for(const i of n.fieldTransforms){const o=e.data.field(i.field),l=EE(i.transform,o||null);l!=null&&(t===null&&(t=mn.empty()),t.set(i.field,l))}return t||null}function Mv(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(i,o){return i===void 0&&o===void 0||!(!i||!o)&&Yo(i,o,((l,c)=>ax(l,c)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Ll extends hd{constructor(e,t,i,o=[]){super(),this.key=e,this.value=t,this.precondition=i,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class ts extends hd{constructor(e,t,i,o,l=[]){super(),this.key=e,this.data=t,this.fieldMask=i,this.precondition=o,this.fieldTransforms=l,this.type=1}getFieldMask(){return this.fieldMask}}function CE(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const i=n.data.field(t);e.set(t,i)}})),e}function Fv(n,e,t){const i=new Map;qe(n.length===t.length,32656,{Ae:t.length,Re:n.length});for(let o=0;o<t.length;o++){const l=n[o],c=l.transform,h=e.data.field(l.field);i.set(l.field,ox(c,h,t[o]))}return i}function Uv(n,e,t){const i=new Map;for(const o of n){const l=o.transform,c=t.data.field(o.field);i.set(o.field,sx(l,c,e))}return i}class Pp extends hd{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class dx extends hd{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hv={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},ME=41943040;class fn{static withCacheSize(e){return new fn(e,fn.DEFAULT_COLLECTION_PERCENTILE,fn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,t,i){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cc=null;function Gf(){return cc===null?cc=(function(){return 268435456+Math.round(2147483648*Math.random())})():cc++,"0x"+cc.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zv="PersistentStream";class $E{constructor(e,t,i,o,l,c,h,p){this.Fi=e,this.w_=i,this.S_=o,this.connection=l,this.authCredentialsProvider=c,this.appCheckCredentialsProvider=h,this.listener=p,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new zE(e,t)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,(()=>this.L_())))}k_(e){this.q_(),this.stream.send(e)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,e!==4?this.F_.reset():t&&t.code===G.RESOURCE_EXHAUSTED?(ii(t.toString()),ii("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):t&&t.code===G.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.n_(t)}U_(){}auth(){this.state=1;const e=this.K_(this.b_),t=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([i,o])=>{this.b_===t&&this.W_(i,o)}),(i=>{e((()=>{const o=new ue(G.UNKNOWN,"Fetching auth token failed: "+i.message);return this.G_(o)}))}))}W_(e,t){const i=this.K_(this.b_);this.stream=this.z_(e,t),this.stream.Zo((()=>{i((()=>this.listener.Zo()))})),this.stream.e_((()=>{i((()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,(()=>(this.x_()&&(this.state=3),Promise.resolve()))),this.listener.e_())))})),this.stream.n_((o=>{i((()=>this.G_(o)))})),this.stream.onMessage((o=>{i((()=>++this.C_==1?this.j_(o):this.onNext(o)))}))}O_(){this.state=5,this.F_.g_((async()=>{this.state=0,this.start()}))}G_(e){return de(Zv,`close with error: ${e}`),this.stream=null,this.close(4,e)}K_(e){return t=>{this.Fi.enqueueAndForget((()=>this.b_===e?t():(de(Zv,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class vR extends $E{constructor(e,t,i,o,l,c){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,i,o,c),this.serializer=l}z_(e,t){return this.connection.P_("Listen",e,t)}j_(e){return this.onNext(e)}onNext(e){this.F_.reset();const t=Sx(this.serializer,e),i=(function(l){if(!("targetChange"in l))return xe.min();const c=l.targetChange;return c.targetIds&&c.targetIds.length?xe.min():c.readTime?Cr(c.readTime):xe.min()})(e);return this.listener.J_(t,i)}H_(e){const t={};t.database=Hf(this.serializer),t.addTarget=(function(l,c){let h;const p=c.target;if(h=Uf(p)?{documents:Cx(l,p)}:{query:xx(l,p).Vt},h.targetId=c.targetId,c.resumeToken.approximateByteSize()>0){h.resumeToken=NE(l,c.resumeToken);const y=$f(l,c.expectedCount);y!==null&&(h.expectedCount=y)}else if(c.snapshotVersion.compareTo(xe.min())>0){h.readTime=zc(l,c.snapshotVersion.toTimestamp());const y=$f(l,c.expectedCount);y!==null&&(h.expectedCount=y)}return h})(this.serializer,e);const i=Px(this.serializer,e);i&&(t.labels=i),this.k_(t)}Y_(e){const t={};t.database=Hf(this.serializer),t.removeTarget=e,this.k_(t)}}class _R extends $E{constructor(e,t,i,o,l,c){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,i,o,c),this.serializer=l}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(e,t){return this.connection.P_("Write",e,t)}j_(e){return qe(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,qe(!e.writeResults||e.writeResults.length===0,55816),this.listener.ea()}onNext(e){qe(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.F_.reset();const t=kx(e.writeResults,e.commitTime),i=Cr(e.commitTime);return this.listener.ta(i,t)}na(){const e={};e.database=Hf(this.serializer),this.k_(e)}X_(e){const t={streamToken:this.lastStreamToken,writes:e.map((i=>Ax(this.serializer,i)))};this.k_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wR{}class ER extends wR{constructor(e,t,i,o){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=i,this.serializer=o,this.ra=!1}ia(){if(this.ra)throw new ue(G.FAILED_PRECONDITION,"The client has already been terminated.")}Wo(e,t,i,o){return this.ia(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([l,c])=>this.connection.Wo(e,Wf(t,i),o,l,c))).catch((l=>{throw l.name==="FirebaseError"?(l.code===G.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),l):new ue(G.UNKNOWN,l.toString())}))}Jo(e,t,i,o,l){return this.ia(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([c,h])=>this.connection.Jo(e,Wf(t,i),o,c,h,l))).catch((c=>{throw c.name==="FirebaseError"?(c.code===G.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),c):new ue(G.UNKNOWN,c.toString())}))}terminate(){this.ra=!0,this.connection.terminate()}}class TR{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.sa=0,this.oa=null,this._a=!0}aa(){this.sa===0&&(this.ua("Unknown"),this.oa=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this.oa=null,this.ca("Backend didn't respond within 10 seconds."),this.ua("Offline"),Promise.resolve()))))}la(e){this.state==="Online"?this.ua("Unknown"):(this.sa++,this.sa>=1&&(this.ha(),this.ca(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.ua("Offline")))}set(e){this.ha(),this.sa=0,e==="Online"&&(this._a=!1),this.ua(e)}ua(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}ca(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ms="RemoteStore";class IR{constructor(e,t,i,o,l){this.localStore=e,this.datastore=t,this.asyncQueue=i,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=l,this.Ea.xo((c=>{i.enqueueAndForget((async()=>{Hs(this)&&(de(Ms,"Restarting streams for network reachability change."),await(async function(p){const y=Pe(p);y.Ia.add(4),await Ml(y),y.Aa.set("Unknown"),y.Ia.delete(4),await md(y)})(this))}))})),this.Aa=new TR(i,o)}}async function md(n){if(Hs(n))for(const e of n.da)await e(!0)}async function Ml(n){for(const e of n.da)await e(!1)}function WE(n,e){const t=Pe(n);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),Bp(t)?Up(t):fa(t).x_()&&Fp(t,e))}function Mp(n,e){const t=Pe(n),i=fa(t);t.Ta.delete(e),i.x_()&&qE(t,e),t.Ta.size===0&&(i.x_()?i.B_():Hs(t)&&t.Aa.set("Unknown"))}function Fp(n,e){if(n.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(xe.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}fa(n).H_(e)}function qE(n,e){n.Ra.$e(e),fa(n).Y_(e)}function Up(n){n.Ra=new yx({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>n.Ta.get(e)||null,lt:()=>n.datastore.serializer.databaseId}),fa(n).start(),n.Aa.aa()}function Bp(n){return Hs(n)&&!fa(n).M_()&&n.Ta.size>0}function Hs(n){return Pe(n).Ia.size===0}function HE(n){n.Ra=void 0}async function SR(n){n.Aa.set("Online")}async function AR(n){n.Ta.forEach(((e,t)=>{Fp(n,e)}))}async function kR(n,e){HE(n),Bp(n)?(n.Aa.la(e),Up(n)):n.Aa.set("Unknown")}async function CR(n,e,t){if(n.Aa.set("Online"),e instanceof PE&&e.state===2&&e.cause)try{await(async function(o,l){const c=l.cause;for(const h of l.targetIds)o.Ta.has(h)&&(await o.remoteSyncer.rejectListen(h,c),o.Ta.delete(h),o.Ra.removeTarget(h))})(n,e)}catch(i){de(Ms,"Failed to remove targets %s: %s ",e.targetIds.join(","),i),await Wc(n,i)}else if(e instanceof Tc?n.Ra.Ye(e):e instanceof RE?n.Ra.it(e):n.Ra.et(e),!t.isEqual(xe.min()))try{const i=await BE(n.localStore);t.compareTo(i)>=0&&await(function(l,c){const h=l.Ra.Pt(c);return h.targetChanges.forEach(((p,y)=>{if(p.resumeToken.approximateByteSize()>0){const w=l.Ta.get(y);w&&l.Ta.set(y,w.withResumeToken(p.resumeToken,c))}})),h.targetMismatches.forEach(((p,y)=>{const w=l.Ta.get(p);if(!w)return;l.Ta.set(p,w.withResumeToken(zt.EMPTY_BYTE_STRING,w.snapshotVersion)),qE(l,p);const T=new Fi(w.target,p,y,w.sequenceNumber);Fp(l,T)})),l.remoteSyncer.applyRemoteEvent(h)})(n,t)}catch(i){de(Ms,"Failed to raise snapshot:",i),await Wc(n,i)}}async function Wc(n,e,t){if(!ha(e))throw e;n.Ia.add(1),await Ml(n),n.Aa.set("Offline"),t||(t=()=>BE(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{de(Ms,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await md(n)}))}function KE(n,e){return e().catch((t=>Wc(n,t,e)))}async function gd(n){const e=Pe(n),t=Qi(e);let i=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:Sp;for(;xR(e);)try{const o=await uR(e.localStore,i);if(o===null){e.Pa.length===0&&t.B_();break}i=o.batchId,RR(e,o)}catch(o){await Wc(e,o)}GE(e)&&QE(e)}function xR(n){return Hs(n)&&n.Pa.length<10}function RR(n,e){n.Pa.push(e);const t=Qi(n);t.x_()&&t.Z_&&t.X_(e.mutations)}function GE(n){return Hs(n)&&!Qi(n).M_()&&n.Pa.length>0}function QE(n){Qi(n).start()}async function PR(n){Qi(n).na()}async function NR(n){const e=Qi(n);for(const t of n.Pa)e.X_(t.mutations)}async function bR(n,e,t){const i=n.Pa.shift(),o=Np.from(i,e,t);await KE(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await gd(n)}async function DR(n,e){e&&Qi(n).Z_&&await(async function(i,o){if((function(c){return mx(c)&&c!==G.ABORTED})(o.code)){const l=i.Pa.shift();Qi(i).N_(),await KE(i,(()=>i.remoteSyncer.rejectFailedWrite(l.batchId,o))),await gd(i)}})(n,e),GE(n)&&QE(n)}async function e_(n,e){const t=Pe(n);t.asyncQueue.verifyOperationInProgress(),de(Ms,"RemoteStore received new credentials");const i=Hs(t);t.Ia.add(3),await Ml(t),i&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await md(t)}async function OR(n,e){const t=Pe(n);e?(t.Ia.delete(2),await md(t)):e||(t.Ia.add(2),await Ml(t),t.Aa.set("Unknown"))}function fa(n){return n.Va||(n.Va=(function(t,i,o){const l=Pe(t);return l.ia(),new vR(i,l.connection,l.authCredentials,l.appCheckCredentials,l.serializer,o)})(n.datastore,n.asyncQueue,{Zo:SR.bind(null,n),e_:AR.bind(null,n),n_:kR.bind(null,n),J_:CR.bind(null,n)}),n.da.push((async e=>{e?(n.Va.N_(),Bp(n)?Up(n):n.Aa.set("Unknown")):(await n.Va.stop(),HE(n))}))),n.Va}function Qi(n){return n.ma||(n.ma=(function(t,i,o){const l=Pe(t);return l.ia(),new _R(i,l.connection,l.authCredentials,l.appCheckCredentials,l.serializer,o)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),e_:PR.bind(null,n),n_:DR.bind(null,n),ea:NR.bind(null,n),ta:bR.bind(null,n)}),n.da.push((async e=>{e?(n.ma.N_(),await gd(n)):(await n.ma.stop(),n.Pa.length>0&&(de(Ms,`Stopping write stream with ${n.Pa.length} pending writes`),n.Pa=[]))}))),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YE{constructor(e){this.key=e}}class JE{constructor(e){this.key=e}}class FR{constructor(e,t){this.query=e,this.Ha=t,this.Ya=null,this.hasCachedResults=!1,this.current=!1,this.Za=Le(),this.mutatedKeys=Le(),this.Xa=gE(e),this.eu=new Go(this.Xa)}get tu(){return this.Ha}nu(e,t){const i=t?t.ru:new t_,o=t?t.eu:this.eu;let l=t?t.mutatedKeys:this.mutatedKeys,c=o,h=!1;const p=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,y=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(e.inorderTraversal(((w,T)=>{const S=o.get(w),R=cd(this.query,T)?T:null,j=!!S&&this.mutatedKeys.has(S.key),z=!!R&&(R.hasLocalMutations||this.mutatedKeys.has(R.key)&&R.hasCommittedMutations);let M=!1;S&&R?S.data.isEqual(R.data)?j!==z&&(i.track({type:3,doc:R}),M=!0):this.iu(S,R)||(i.track({type:2,doc:R}),M=!0,(p&&this.Xa(R,p)>0||y&&this.Xa(R,y)<0)&&(h=!0)):!S&&R?(i.track({type:0,doc:R}),M=!0):S&&!R&&(i.track({type:1,doc:S}),M=!0,(p||y)&&(h=!0)),M&&(R?(c=c.add(R),l=z?l.add(w):l.delete(w)):(c=c.delete(w),l=l.delete(w)))})),this.query.limit!==null)for(;c.size>this.query.limit;){const w=this.query.limitType==="F"?c.last():c.first();c=c.delete(w.key),l=l.delete(w.key),i.track({type:1,doc:w})}return{eu:c,ru:i,Ds:h,mutatedKeys:l}}iu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,i,o){const l=this.eu;this.eu=e.eu,this.mutatedKeys=e.mutatedKeys;const c=e.ru.pa();c.sort(((w,T)=>(function(R,j){const z=M=>{switch(M){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return ke(20277,{At:M})}};return z(R)-z(j)})(w.type,T.type)||this.Xa(w.doc,T.doc))),this.su(i),o=o!=null&&o;const h=t&&!o?this.ou():[],p=this.Za.size===0&&this.current&&!o?1:0,y=p!==this.Ya;return this.Ya=p,c.length!==0||y?{snapshot:new na(this.query,e.eu,l,c,e.mutatedKeys,p===0,y,!1,!!i&&i.resumeToken.approximateByteSize()>0),_u:h}:{_u:h}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({eu:this.eu,ru:new t_,mutatedKeys:this.mutatedKeys,Ds:!1},!1)):{_u:[]}}au(e){return!this.Ha.has(e)&&!!this.eu.has(e)&&!this.eu.get(e).hasLocalMutations}su(e){e&&(e.addedDocuments.forEach((t=>this.Ha=this.Ha.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Ha=this.Ha.delete(t))),this.current=e.current)}ou(){if(!this.current)return[];const e=this.Za;this.Za=Le(),this.eu.forEach((i=>{this.au(i.key)&&(this.Za=this.Za.add(i.key))}));const t=[];return e.forEach((i=>{this.Za.has(i)||t.push(new JE(i))})),this.Za.forEach((i=>{e.has(i)||t.push(new YE(i))})),t}uu(e){this.Ha=e.qs,this.Za=Le();const t=this.nu(e.documents);return this.applyChanges(t,!0)}cu(){return na.fromInitialDocuments(this.query,this.eu,this.mutatedKeys,this.Ya===0,this.hasCachedResults)}}const Gp="SyncEngine";class UR{constructor(e,t,i){this.query=e,this.targetId=t,this.view=i}}class BR{constructor(e){this.key=e,this.lu=!1}}class zR{constructor(e,t,i,o,l,c){this.localStore=e,this.remoteStore=t,this.eventManager=i,this.sharedClientState=o,this.currentUser=l,this.maxConcurrentLimboResolutions=c,this.hu={},this.Pu=new qs((h=>mE(h)),ud),this.Tu=new Map,this.Iu=new Set,this.du=new ut(Ee.comparator),this.Eu=new Map,this.Au=new Op,this.Ru={},this.Vu=new Map,this.mu=ta.ur(),this.onlineState="Unknown",this.fu=void 0}get isPrimaryClient(){return this.fu===!0}}async function $R(n,e,t=!0){const i=r0(n);let o;const l=i.Pu.get(e);return l?(i.sharedClientState.addLocalQueryTarget(l.targetId),o=l.view.cu()):o=await XE(i,e,t,!0),o}async function WR(n,e){const t=r0(n);await XE(t,e,!0,!1)}async function XE(n,e,t,i){const o=await cR(n.localStore,kr(e)),l=o.targetId,c=n.sharedClientState.addLocalQueryTarget(l,t);let h;return i&&(h=await qR(n,e,l,c==="current",o.resumeToken)),n.isPrimaryClient&&t&&WE(n.remoteStore,o),h}async function qR(n,e,t,i,o){n.gu=(T,S,R)=>(async function(z,M,ee,se){let J=M.view.nu(ee);J.Ds&&(J=await Qv(z.localStore,M.query,!1).then((({documents:b})=>M.view.nu(b,J))));const ge=se&&se.targetChanges.get(M.targetId),Re=se&&se.targetMismatches.get(M.targetId)!=null,ye=M.view.applyChanges(J,z.isPrimaryClient,ge,Re);return s_(z,M.targetId,ye._u),ye.snapshot})(n,T,S,R);const l=await Qv(n.localStore,e,!0),c=new FR(e,l.qs),h=c.nu(l.documents),p=jl.createSynthesizedTargetChangeForCurrentChange(t,i&&n.onlineState!=="Offline",o),y=c.applyChanges(h,n.isPrimaryClient,p);s_(n,t,y._u);const w=new UR(e,t,c);return n.Pu.set(e,w),n.Tu.has(t)?n.Tu.get(t).push(e):n.Tu.set(t,[e]),y.snapshot}async function HR(n,e,t){const i=Pe(n),o=i.Pu.get(e),l=i.Tu.get(o.targetId);if(l.length>1)return i.Tu.set(o.targetId,l.filter((c=>!ud(c,e)))),void i.Pu.delete(e);i.isPrimaryClient?(i.sharedClientState.removeLocalQueryTarget(o.targetId),i.sharedClientState.isActiveQueryTarget(o.targetId)||await Kf(i.localStore,o.targetId,!1).then((()=>{i.sharedClientState.clearQueryState(o.targetId),t&&Mp(i.remoteStore,o.targetId),Yf(i,o.targetId)})).catch(da)):(Yf(i,o.targetId),await Kf(i.localStore,o.targetId,!0))}async function KR(n,e){const t=Pe(n),i=t.Pu.get(e),o=t.Tu.get(i.targetId);t.isPrimaryClient&&o.length===1&&(t.sharedClientState.removeLocalQueryTarget(i.targetId),Mp(t.remoteStore,i.targetId))}async function GR(n,e,t){const i=tP(n);try{const o=await(function(c,h){const p=Pe(c),y=Qe.now(),w=h.reduce(((R,j)=>R.add(j.key)),Le());let T,S;return p.persistence.runTransaction("Locally write mutations","readwrite",(R=>{let j=si(),z=Le();return p.Os.getEntries(R,w).next((M=>{j=M,j.forEach(((ee,se)=>{se.isValidDocument()||(z=z.add(ee))}))})).next((()=>p.localDocuments.getOverlayedDocuments(R,j))).next((M=>{T=M;const ee=[];for(const se of h){const J=cx(se,T.get(se.key).overlayedDocument);J!=null&&ee.push(new ts(se.key,J,aE(J.value.mapValue),Un.exists(!0)))}return p.mutationQueue.addMutationBatch(R,y,ee,h)})).next((M=>{S=M;const ee=M.applyToLocalDocumentSet(T,z);return p.documentOverlayCache.saveOverlays(R,M.batchId,ee)}))})).then((()=>({batchId:S.batchId,changes:vE(T)})))})(i.localStore,e);i.sharedClientState.addPendingMutation(o.batchId),(function(c,h,p){let y=c.Ru[c.currentUser.toKey()];y||(y=new ut(De)),y=y.insert(h,p),c.Ru[c.currentUser.toKey()]=y})(i,o.batchId,t),await Fl(i,o.changes),await gd(i.remoteStore)}catch(o){const l=$p(o,"Failed to persist write");t.reject(l)}}async function ZE(n,e){const t=Pe(n);try{const i=await aR(t.localStore,e);e.targetChanges.forEach(((o,l)=>{const c=t.Eu.get(l);c&&(qe(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?c.lu=!0:o.modifiedDocuments.size>0?qe(c.lu,14607):o.removedDocuments.size>0&&(qe(c.lu,42227),c.lu=!1))})),await Fl(t,i,e)}catch(i){await da(i)}}function i_(n,e,t){const i=Pe(n);if(i.isPrimaryClient&&t===0||!i.isPrimaryClient&&t===1){const o=[];i.Pu.forEach(((l,c)=>{const h=c.view.va(e);h.snapshot&&o.push(h.snapshot)})),(function(c,h){const p=Pe(c);p.onlineState=h;let y=!1;p.queries.forEach(((w,T)=>{for(const S of T.wa)S.va(h)&&(y=!0)})),y&&Hp(p)})(i.eventManager,e),o.length&&i.hu.J_(o),i.onlineState=e,i.isPrimaryClient&&i.sharedClientState.setOnlineState(e)}}async function QR(n,e,t){const i=Pe(n);i.sharedClientState.updateQueryState(e,"rejected",t);const o=i.Eu.get(e),l=o&&o.key;if(l){let c=new ut(Ee.comparator);c=c.insert(l,Yt.newNoDocument(l,xe.min()));const h=Le().add(l),p=new fd(xe.min(),new Map,new ut(De),c,h);await ZE(i,p),i.du=i.du.remove(l),i.Eu.delete(e),Qp(i)}else await Kf(i.localStore,e,!1).then((()=>Yf(i,e,t))).catch(da)}async function YR(n,e){const t=Pe(n),i=e.batch.batchId;try{const o=await oR(t.localStore,e);t0(t,i,null),e0(t,i),t.sharedClientState.updateMutationState(i,"acknowledged"),await Fl(t,o)}catch(o){await da(o)}}async function JR(n,e,t){const i=Pe(n);try{const o=await(function(c,h){const p=Pe(c);return p.persistence.runTransaction("Reject batch","readwrite-primary",(y=>{let w;return p.mutationQueue.lookupMutationBatch(y,h).next((T=>(qe(T!==null,37113),w=T.keys(),p.mutationQueue.removeMutationBatch(y,T)))).next((()=>p.mutationQueue.performConsistencyCheck(y))).next((()=>p.documentOverlayCache.removeOverlaysForBatchId(y,w,h))).next((()=>p.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(y,w))).next((()=>p.localDocuments.getDocuments(y,w)))}))})(i.localStore,e);t0(i,e,t),e0(i,e),i.sharedClientState.updateMutationState(e,"rejected",t),await Fl(i,o)}catch(o){await da(o)}}function e0(n,e){(n.Vu.get(e)||[]).forEach((t=>{t.resolve()})),n.Vu.delete(e)}function t0(n,e,t){const i=Pe(n);let o=i.Ru[i.currentUser.toKey()];if(o){const l=o.get(e);l&&(t?l.reject(t):l.resolve(),o=o.remove(e)),i.Ru[i.currentUser.toKey()]=o}}function Yf(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const i of n.Tu.get(e))n.Pu.delete(i),t&&n.hu.pu(i,t);n.Tu.delete(e),n.isPrimaryClient&&n.Au.zr(e).forEach((i=>{n.Au.containsKey(i)||n0(n,i)}))}function n0(n,e){n.Iu.delete(e.path.canonicalString());const t=n.du.get(e);t!==null&&(Mp(n.remoteStore,t),n.du=n.du.remove(e),n.Eu.delete(t),Qp(n))}function s_(n,e,t){for(const i of t)i instanceof YE?(n.Au.addReference(i.key,e),XR(n,i)):i instanceof JE?(de(Gp,"Document no longer in limbo: "+i.key),n.Au.removeReference(i.key,e),n.Au.containsKey(i.key)||n0(n,i.key)):ke(19791,{yu:i})}function XR(n,e){const t=e.key,i=t.path.canonicalString();n.du.get(t)||n.Iu.has(i)||(de(Gp,"New document in limbo: "+t),n.Iu.add(i),Qp(n))}function Qp(n){for(;n.Iu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const e=n.Iu.values().next().value;n.Iu.delete(e);const t=new Ee(tt.fromString(e)),i=n.mu.next();n.Eu.set(i,new BR(t)),n.du=n.du.insert(t,i),WE(n.remoteStore,new Fi(kr(ld(t.path)),i,"TargetPurposeLimboResolution",sd.ue))}}async function Fl(n,e,t){const i=Pe(n),o=[],l=[],c=[];i.Pu.isEmpty()||(i.Pu.forEach(((h,p)=>{c.push(i.gu(p,e,t).then((y=>{var w;if((y||t)&&i.isPrimaryClient){const T=y?!y.fromCache:(w=t==null?void 0:t.targetChanges.get(p.targetId))===null||w===void 0?void 0:w.current;i.sharedClientState.updateQueryState(p.targetId,T?"current":"not-current")}if(y){o.push(y);const T=Lp.Es(p.targetId,y);l.push(T)}})))})),await Promise.all(c),i.hu.J_(o),await(async function(p,y){const w=Pe(p);try{await w.persistence.runTransaction("notifyLocalViewChanges","readwrite",(T=>Q.forEach(y,(S=>Q.forEach(S.Is,(R=>w.persistence.referenceDelegate.addReference(T,S.targetId,R))).next((()=>Q.forEach(S.ds,(R=>w.persistence.referenceDelegate.removeReference(T,S.targetId,R)))))))))}catch(T){if(!ha(T))throw T;de(jp,"Failed to update sequence numbers: "+T)}for(const T of y){const S=T.targetId;if(!T.fromCache){const R=w.Fs.get(S),j=R.snapshotVersion,z=R.withLastLimboFreeSnapshotVersion(j);w.Fs=w.Fs.insert(S,z)}}})(i.localStore,l))}async function ZR(n,e){const t=Pe(n);if(!t.currentUser.isEqual(e)){de(Gp,"User change. New user:",e.toKey());const i=await UE(t.localStore,e);t.currentUser=e,(function(l,c){l.Vu.forEach((h=>{h.forEach((p=>{p.reject(new ue(G.CANCELLED,c))}))})),l.Vu.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,i.removedBatchIds,i.addedBatchIds),await Fl(t,i.Bs)}}function eP(n,e){const t=Pe(n),i=t.Eu.get(e);if(i&&i.lu)return Le().add(i.key);{let o=Le();const l=t.Tu.get(e);if(!l)return o;for(const c of l){const h=t.Pu.get(c);o=o.unionWith(h.view.tu)}return o}}function r0(n){const e=Pe(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=ZE.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=eP.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=QR.bind(null,e),e.hu.J_=jR.bind(null,e.eventManager),e.hu.pu=MR.bind(null,e.eventManager),e}function tP(n){const e=Pe(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=YR.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=JR.bind(null,e),e}class qc{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=pd(e.databaseInfo.databaseId),this.sharedClientState=this.bu(e),this.persistence=this.Du(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Cu(e,this.localStore),this.indexBackfillerScheduler=this.Fu(e,this.localStore)}Cu(e,t){return null}Fu(e,t){return null}vu(e){return sR(this.persistence,new nR,e.initialUser,this.serializer)}Du(e){return new FE(Vp.Vi,this.serializer)}bu(e){return new hR}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}qc.provider={build:()=>new qc};class nP extends qc{constructor(e){super(),this.cacheSizeBytes=e}Cu(e,t){qe(this.persistence.referenceDelegate instanceof $c,46915);const i=this.persistence.referenceDelegate.garbageCollector;return new Bx(i,e.asyncQueue,t)}Du(e){const t=this.cacheSizeBytes!==void 0?fn.withCacheSize(this.cacheSizeBytes):fn.DEFAULT;return new FE((i=>$c.Vi(i,t)),this.serializer)}}class Jf{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=i=>i_(this.syncEngine,i,1),this.remoteStore.remoteSyncer.handleCredentialChange=ZR.bind(null,this.syncEngine),await OR(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new LR})()}createDatastore(e){const t=pd(e.databaseInfo.databaseId),i=(function(l){return new yR(l)})(e.databaseInfo);return(function(l,c,h,p){return new ER(l,c,h,p)})(e.authCredentials,e.appCheckCredentials,i,t)}createRemoteStore(e){return(function(i,o,l,c,h){return new IR(i,o,l,c,h)})(this.localStore,this.datastore,e.asyncQueue,(t=>i_(this.syncEngine,t,0)),(function(){return Xv.C()?new Xv:new fR})())}createSyncEngine(e,t){return(function(o,l,c,h,p,y,w){const T=new zR(o,l,c,h,p,y);return w&&(T.fu=!0),T})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await(async function(o){const l=Pe(o);de(Ms,"RemoteStore shutting down."),l.Ia.add(5),await Ml(l),l.Ea.shutdown(),l.Aa.set("Unknown")})(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}Jf.provider={build:()=>new Jf};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _d{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new ue(G.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Bt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dP=/^__.*__$/;class hP{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return this.fieldMask!==null?new ts(e,this.data,this.fieldMask,t,this.fieldTransforms):new Ll(e,this.data,t,this.fieldTransforms)}}class a0{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return new ts(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function l0(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw ke(40011,{Ec:n})}}class wd{constructor(e,t,i,o,l,c){this.settings=e,this.databaseId=t,this.serializer=i,this.ignoreUndefinedProperties=o,l===void 0&&this.Ac(),this.fieldTransforms=l||[],this.fieldMask=c||[]}get path(){return this.settings.path}get Ec(){return this.settings.Ec}Rc(e){return new wd(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Vc(e){var t;const i=(t=this.path)===null||t===void 0?void 0:t.child(e),o=this.Rc({path:i,mc:!1});return o.fc(e),o}gc(e){var t;const i=(t=this.path)===null||t===void 0?void 0:t.child(e),o=this.Rc({path:i,mc:!1});return o.Ac(),o}yc(e){return this.Rc({path:void 0,mc:!0})}wc(e){return Kc(e,this.settings.methodName,this.settings.Sc||!1,this.path,this.settings.bc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.fc(this.path.get(e))}fc(e){if(e.length===0)throw this.wc("Document fields must not be empty");if(l0(this.Ec)&&dP.test(e))throw this.wc('Document fields cannot begin and end with "__"')}}class fP{constructor(e,t,i){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=i||pd(e)}Dc(e,t,i,o=!1){return new wd({Ec:e,methodName:t,bc:i,path:Bt.emptyPath(),mc:!1,Sc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Ed(n){const e=n._freezeSettings(),t=pd(n._databaseId);return new fP(n._databaseId,!!e.ignoreUndefinedProperties,t)}function u0(n,e,t,i,o,l={}){const c=n.Dc(l.merge||l.mergeFields?2:0,e,t,o);Zp("Data must be an object, but it was:",c,i);const h=d0(i,c);let p,y;if(l.merge)p=new kn(c.fieldMask),y=c.fieldTransforms;else if(l.mergeFields){const w=[];for(const T of l.mergeFields){const S=Xf(e,T,t);if(!c.contains(S))throw new ue(G.INVALID_ARGUMENT,`Field '${S}' is specified in your field mask but missing from your input data.`);f0(w,S)||w.push(S)}p=new kn(w),y=c.fieldTransforms.filter((T=>p.covers(T.field)))}else p=null,y=c.fieldTransforms;return new hP(new mn(h),p,y)}class Td extends Ul{_toFieldTransform(e){if(e.Ec!==2)throw e.Ec===1?e.wc(`${this._methodName}() can only appear at the top level of your update data`):e.wc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Td}}function c0(n,e,t){return new wd({Ec:3,bc:e.settings.bc,methodName:n._methodName,mc:t},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class Jp extends Ul{constructor(e,t){super(e),this.vc=t}_toFieldTransform(e){const t=c0(this,e,!0),i=this.vc.map((l=>Gs(l,t))),o=new Zo(i);return new AE(e.path,o)}isEqual(e){return e instanceof Jp&&ti(this.vc,e.vc)}}class Xp extends Ul{constructor(e,t){super(e),this.vc=t}_toFieldTransform(e){const t=c0(this,e,!0),i=this.vc.map((l=>Gs(l,t))),o=new ea(i);return new AE(e.path,o)}isEqual(e){return e instanceof Xp&&ti(this.vc,e.vc)}}function pP(n,e,t,i){const o=n.Dc(1,e,t);Zp("Data must be an object, but it was:",o,i);const l=[],c=mn.empty();es(i,((p,y)=>{const w=em(e,p,t);y=Xe(y);const T=o.gc(w);if(y instanceof Td)l.push(w);else{const S=Gs(y,T);S!=null&&(l.push(w),c.set(w,S))}}));const h=new kn(l);return new a0(c,h,o.fieldTransforms)}function mP(n,e,t,i,o,l){const c=n.Dc(1,e,t),h=[Xf(e,i,t)],p=[o];if(l.length%2!=0)throw new ue(G.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let S=0;S<l.length;S+=2)h.push(Xf(e,l[S])),p.push(l[S+1]);const y=[],w=mn.empty();for(let S=h.length-1;S>=0;--S)if(!f0(y,h[S])){const R=h[S];let j=p[S];j=Xe(j);const z=c.gc(R);if(j instanceof Td)y.push(R);else{const M=Gs(j,z);M!=null&&(y.push(R),w.set(R,M))}}const T=new kn(y);return new a0(w,T,c.fieldTransforms)}function gP(n,e,t,i=!1){return Gs(t,n.Dc(i?4:3,e))}function Gs(n,e){if(h0(n=Xe(n)))return Zp("Unsupported field value:",e,n),d0(n,e);if(n instanceof Ul)return(function(i,o){if(!l0(o.Ec))throw o.wc(`${i._methodName}() can only be used with update() and set()`);if(!o.path)throw o.wc(`${i._methodName}() is not currently supported inside arrays`);const l=i._toFieldTransform(o);l&&o.fieldTransforms.push(l)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.mc&&e.Ec!==4)throw e.wc("Nested arrays are not supported");return(function(i,o){const l=[];let c=0;for(const h of i){let p=Gs(h,o.yc(c));p==null&&(p={nullValue:"NULL_VALUE"}),l.push(p),c++}return{arrayValue:{values:l}}})(n,e)}return(function(i,o){if((i=Xe(i))===null)return{nullValue:"NULL_VALUE"};if(typeof i=="number")return ix(o.serializer,i);if(typeof i=="boolean")return{booleanValue:i};if(typeof i=="string")return{stringValue:i};if(i instanceof Date){const l=Qe.fromDate(i);return{timestampValue:zc(o.serializer,l)}}if(i instanceof Qe){const l=new Qe(i.seconds,1e3*Math.floor(i.nanoseconds/1e3));return{timestampValue:zc(o.serializer,l)}}if(i instanceof xr)return{geoPointValue:{latitude:i.latitude,longitude:i.longitude}};if(i instanceof Fn)return{bytesValue:NE(o.serializer,i._byteString)};if(i instanceof dt){const l=o.databaseId,c=i.firestore._databaseId;if(!c.isEqual(l))throw o.wc(`Document reference is for database ${c.projectId}/${c.database} but should be for database ${l.projectId}/${l.database}`);return{referenceValue:Dp(i.firestore._databaseId||o.databaseId,i._key.path)}}if(i instanceof Rr)return(function(c,h){return{mapValue:{fields:{[sE]:{stringValue:oE},[jc]:{arrayValue:{values:c.toArray().map((y=>{if(typeof y!="number")throw h.wc("VectorValues must only contain numeric values.");return Rp(h.serializer,y)}))}}}}}})(i,o);throw o.wc(`Unsupported field value: ${id(i)}`)})(n,e)}function d0(n,e){const t={};return Zw(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):es(n,((i,o)=>{const l=Gs(o,e.Vc(i));l!=null&&(t[i]=l)})),{mapValue:{fields:t}}}function h0(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof Qe||n instanceof xr||n instanceof Fn||n instanceof dt||n instanceof Ul||n instanceof Rr)}function Zp(n,e,t){if(!h0(t)||!Jw(t)){const i=id(t);throw i==="an object"?e.wc(n+" a custom object"):e.wc(n+" "+i)}}function Xf(n,e,t){if((e=Xe(e))instanceof _d)return e._internalPath;if(typeof e=="string")return em(n,e);throw Kc("Field path arguments must be of type string or ",n,!1,void 0,t)}const yP=new RegExp("[~\\*/\\[\\]]");function em(n,e,t){if(e.search(yP)>=0)throw Kc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new _d(...e.split("."))._internalPath}catch{throw Kc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Kc(n,e,t,i,o){const l=i&&!i.isEmpty(),c=o!==void 0;let h=`Function ${e}() called with invalid data`;t&&(h+=" (via `toFirestore()`)"),h+=". ";let p="";return(l||c)&&(p+=" (found",l&&(p+=` in field ${i}`),c&&(p+=` in document ${o}`),p+=")"),new ue(G.INVALID_ARGUMENT,h+n+p)}function f0(n,e){return n.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p0{constructor(e,t,i,o,l){this._firestore=e,this._userDataWriter=t,this._key=i,this._document=o,this._converter=l}get id(){return this._key.path.lastSegment()}get ref(){return new dt(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new vP(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(tm("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class vP extends p0{data(){return super.data()}}function tm(n,e){return typeof e=="string"?em(n,e):e instanceof _d?e._internalPath:e._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E0=1e4,T0=`w:${om}`,I0="FIS_v2",CP="https://firebaseinstallations.googleapis.com/v1",xP=3600*1e3,RP="installations",PP="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function VP({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const i=A0(n),o=x0(n),l=e.getImmediate({optional:!0});if(l){const y=await l.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const c={fid:t,authVersion:I0,appId:n.appId,sdkVersion:T0},h={method:"POST",headers:o,body:JSON.stringify(c)},p=await R0(()=>fetch(i,h));if(p.ok){const y=await p.json();return{fid:y.fid||t,registrationStatus:2,refreshToken:y.refreshToken,authToken:k0(y.authToken)}}else throw await C0("Create Installation",p)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N0=new Map;function b0(n,e){const t=Ad(n);D0(t,e),UP(t,e)}function D0(n,e){const t=N0.get(n);if(t)for(const i of t)i(e)}function UP(n,e){const t=BP();t&&t.postMessage({key:n,fid:e}),zP()}let bs=null;function BP(){return!bs&&"BroadcastChannel"in self&&(bs=new BroadcastChannel("[Firebase] FID Change"),bs.onmessage=n=>{D0(n.data.key,n.data.fid)}),bs}function zP(){N0.size===0&&bs&&(bs.close(),bs=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $P="firebase-installations-database",WP=1,Us="firebase-installations-store";let vf=null;function am(){return vf||(vf=Zc($P,WP,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Us)}}})),vf}async function Gc(n,e){const t=Ad(n),o=(await am()).transaction(Us,"readwrite"),l=o.objectStore(Us),c=await l.get(t);return await l.put(e,t),await o.done,(!c||c.fid!==e.fid)&&b0(n,e.fid),e}async function O0(n){const e=Ad(n),i=(await am()).transaction(Us,"readwrite");await i.objectStore(Us).delete(e),await i.done}async function kd(n,e){const t=Ad(n),o=(await am()).transaction(Us,"readwrite"),l=o.objectStore(Us),c=await l.get(t),h=e(c);return h===void 0?await l.delete(t):await l.put(h,t),await o.done,h&&(!c||c.fid!==h.fid)&&b0(n,h.fid),h}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lm(n){let e;const t=await kd(n.appConfig,i=>{const o=qP(i),l=HP(n,o);return e=l.registrationPromise,l.installationEntry});return t.fid===Zf?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function qP(n){const e=n||{fid:MP(),registrationStatus:0};return V0(e)}function HP(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(Fs.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=KP(n,t);return{installationEntry:t,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:GP(n)}:{installationEntry:e}}async function KP(n,e){try{const t=await VP(n,e);return Gc(n.appConfig,t)}catch(t){throw S0(t)&&t.customData.serverCode===409?await O0(n.appConfig):await Gc(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function GP(n){let e=await g_(n.appConfig);for(;e.registrationStatus===1;)await P0(100),e=await g_(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:i}=await lm(n);return i||t}return e}function g_(n){return kd(n,e=>{if(!e)throw Fs.create("installation-not-found");return V0(e)})}function V0(n){return QP(n)?{fid:n.fid,registrationStatus:0}:n}function QP(n){return n.registrationStatus===1&&n.registrationTime+E0<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function YP({appConfig:n,heartbeatServiceProvider:e},t){const i=JP(n,t),o=bP(n,t),l=e.getImmediate({optional:!0});if(l){const y=await l.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const c={installation:{sdkVersion:T0,appId:n.appId}},h={method:"POST",headers:o,body:JSON.stringify(c)},p=await R0(()=>fetch(i,h));if(p.ok){const y=await p.json();return k0(y)}else throw await C0("Generate Auth Token",p)}function JP(n,{fid:e}){return`${A0(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function um(n,e=!1){let t;const i=await kd(n.appConfig,l=>{if(!L0(l))throw Fs.create("not-registered");const c=l.authToken;if(!e&&eN(c))return l;if(c.requestStatus===1)return t=XP(n,e),l;{if(!navigator.onLine)throw Fs.create("app-offline");const h=nN(l);return t=ZP(n,h),h}});return t?await t:i.authToken}async function XP(n,e){let t=await y_(n.appConfig);for(;t.authToken.requestStatus===1;)await P0(100),t=await y_(n.appConfig);const i=t.authToken;return i.requestStatus===0?um(n,e):i}function y_(n){return kd(n,e=>{if(!L0(e))throw Fs.create("not-registered");const t=e.authToken;return rN(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function ZP(n,e){try{const t=await YP(n,e),i=Object.assign(Object.assign({},e),{authToken:t});return await Gc(n.appConfig,i),t}catch(t){if(S0(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await O0(n.appConfig);else{const i=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Gc(n.appConfig,i)}throw t}}function L0(n){return n!==void 0&&n.registrationStatus===2}function eN(n){return n.requestStatus===2&&!tN(n)}function tN(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+xP}function nN(n){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:e})}function rN(n){return n.requestStatus===1&&n.requestTime+E0<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j0="installations",lN="installations-internal",uN=n=>{const e=n.getProvider("app").getImmediate(),t=aN(e),i=$s(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},cN=n=>{const e=n.getProvider("app").getImmediate(),t=$s(e,j0).getImmediate();return{getId:()=>iN(t),getToken:o=>sN(t,o)}};function dN(){ar(new Bn(j0,uN,"PUBLIC")),ar(new Bn(lN,cN,"PRIVATE"))}dN();yn(w0,om);yn(w0,om,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hN="/firebase-messaging-sw.js",fN="/firebase-cloud-messaging-push-scope",M0="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",pN="https://fcmregistrations.googleapis.com/v1",F0="google.c.a.c_id",mN="google.c.a.c_l",gN="google.c.a.ts",yN="google.c.a.e",v_=1e4;var __;(function(n){n[n.DATA_MESSAGE=1]="DATA_MESSAGE",n[n.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(__||(__={}));/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TN="firebase-messaging-database",IN=1,xl="firebase-messaging-store";let Ef=null;function U0(){return Ef||(Ef=Zc(TN,IN,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(xl)}}})),Ef}async function SN(n){const e=B0(n),i=await(await U0()).transaction(xl).objectStore(xl).get(e);if(i)return i;{const o=await wN(n.appConfig.senderId);if(o)return await cm(n,o),o}}async function cm(n,e){const t=B0(n),o=(await U0()).transaction(xl,"readwrite");return await o.objectStore(xl).put(e,t),await o.done,e}function B0({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jN(n){return typeof n=="object"&&!!n&&F0 in n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $N(n,e){e?n.vapidKey=e:n.vapidKey||(n.vapidKey=M0)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $0(n,e){if(!navigator)throw rn.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw rn.create("permission-blocked");return await $N(n,e==null?void 0:e.vapidKey),await zN(n,e==null?void 0:e.serviceWorkerRegistration),PN(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WN(n,e,t){const i=qN(e);(await n.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:t[F0],message_name:t[mN],message_time:t[gN],message_device_time:Math.floor(Date.now()/1e3)})}function qN(n){switch(n){case Cl.NOTIFICATION_CLICKED:return"notification_open";case Cl.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KN=n=>{const e=new FN(n.getProvider("app").getImmediate(),n.getProvider("installations-internal").getImmediate(),n.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",t=>HN(e,t)),e},GN=n=>{const e=n.getProvider("messaging").getImmediate();return{getToken:i=>$0(e,i)}};function QN(){ar(new Bn("messaging",KN,"PUBLIC")),ar(new Bn("messaging-internal",GN,"PRIVATE")),yn(I_,S_),yn(I_,S_,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function W0(){try{await Z_()}catch{return!1}return typeof window<"u"&&X_()&&NS()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ep(n=ed()){return W0().then(e=>{if(!e)throw rn.create("unsupported-browser")},e=>{throw rn.create("indexed-db-unsupported")}),$s(Xe(n),"messaging").getImmediate()}async function tp(n,e){return n=Xe(n),$0(n,e)}QN();const YN={apiKey:"AIzaSyAUNktXGZeeXlX3LKFolXZRVQZGDohlIF0",authDomain:"golfgang-79922.firebaseapp.com",projectId:"golfgang-79922",storageBucket:"golfgang-79922.appspot.com",messagingSenderId:"223762413770",appId:"1:223762413770:web:098607b8f30080df90dc33",measurementId:"G-T1FXETH3K0"},ra=nw(YN),$l=dC(ra),Je=uP(ra),q0=$.createContext(null);function JN({children:n}){const[e,t]=$.useState(null),[i,o]=$.useState(null),[l,c]=$.useState(!1),[h,p]=$.useState(!0);$.useEffect(()=>{const w=ZA($l,async T=>{if(!T){t(null),o(null),c(!1),p(!1);return}t(T);try{const S=Vt(Je,"users",T.uid),R=await im(S);if(R.exists()){const j=R.data();o(j),c((j==null?void 0:j.isAdmin)===!0)}else o({}),c(!1)}catch(S){console.error("Error loading user profile:",S),o({})}p(!1)});return()=>w()},[]);const y={user:e,profile:i,isAdmin:l,loading:h};return v.jsx(q0.Provider,{value:y,children:n})}function ns(){return $.useContext(q0)}function XN(){var p;const{user:n,isAdmin:e}=ns(),t=la(),i=aa(),[o,l]=$.useState(!1),c=async()=>{await ek($l),t("/login")},h=()=>l(!1);return v.jsxs(v.Fragment,{children:[v.jsx("style",{children:`
        .nav-desktop {
          display: flex;
        }
        .nav-mobile-burger {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nb="type.googleapis.com/google.protobuf.Int64Value",rb="type.googleapis.com/google.protobuf.UInt64Value";function K0(n,e){const t={};for(const i in n)n.hasOwnProperty(i)&&(t[i]=e(n[i]));return t}function Qc(n){if(n==null)return null;if(n instanceof Number&&(n=n.valueOf()),typeof n=="number"&&isFinite(n)||n===!0||n===!1||Object.prototype.toString.call(n)==="[object String]")return n;if(n instanceof Date)return n.toISOString();if(Array.isArray(n))return n.map(e=>Qc(e));if(typeof n=="function"||typeof n=="object")return K0(n,e=>Qc(e));throw new Error("Data cannot be encoded in JSON: "+n)}function ia(n){if(n==null)return n;if(n["@type"])switch(n["@type"]){case nb:case rb:{const e=Number(n.value);if(isNaN(e))throw new Error("Data cannot be decoded from JSON: "+n);return e}default:throw new Error("Data cannot be decoded from JSON: "+n)}return Array.isArray(n)?n.map(e=>ia(e)):typeof n=="function"||typeof n=="object"?K0(n,e=>ia(e)):n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const np="us-central1",ob=/^data: (.*?)(?:\n|$)/;function ab(n){let e=null;return{promise:new Promise((t,i)=>{e=setTimeout(()=>{i(new gn("deadline-exceeded","deadline-exceeded"))},n)}),cancel:()=>{e&&clearTimeout(e)}}}class lb{constructor(e,t,i,o,l=np,c=(...h)=>fetch(...h)){this.app=e,this.fetchImpl=c,this.emulatorOrigin=null,this.contextProvider=new sb(e,t,i,o),this.cancelAllRequests=new Promise(h=>{this.deleteService=()=>Promise.resolve(h())});try{const h=new URL(l);this.customDomain=h.origin+(h.pathname==="/"?"":h.pathname),this.region=np}catch{this.customDomain=null,this.region=l}}_delete(){return this.deleteService()}_url(e){const t=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${t}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${t}.cloudfunctions.net/${e}`}}function ub(n,e,t){const i=Bs(e);n.emulatorOrigin=`http${i?"s":""}://${e}:${t}`,i&&(up(n.emulatorOrigin),cp("Functions",!0))}function cb(n,e,t){const i=o=>hb(n,e,o,{});return i.stream=(o,l)=>pb(n,e,o,l),i}async function db(n,e,t,i){t["Content-Type"]="application/json";let o;try{o=await i(n,{method:"POST",body:JSON.stringify(e),headers:t})}catch{return{status:0,json:null}}let l=null;try{l=await o.json()}catch{}return{status:o.status,json:l}}async function G0(n,e){const t={},i=await n.contextProvider.getContext(e.limitedUseAppCheckTokens);return i.authToken&&(t.Authorization="Bearer "+i.authToken),i.messagingToken&&(t["Firebase-Instance-ID-Token"]=i.messagingToken),i.appCheckToken!==null&&(t["X-Firebase-AppCheck"]=i.appCheckToken),t}function hb(n,e,t,i){const o=n._url(e);return fb(n,o,t,i)}async function fb(n,e,t,i){t=Qc(t);const o={data:t},l=await G0(n,i),c=i.timeout||7e4,h=ab(c),p=await Promise.race([db(e,o,l,n.fetchImpl),h.promise,n.cancelAllRequests]);if(h.cancel(),!p)throw new gn("cancelled","Firebase Functions instance was deleted.");const y=Yc(p.status,p.json);if(y)throw y;if(!p.json)throw new gn("internal","Response is not valid JSON object.");let w=p.json.data;if(typeof w>"u"&&(w=p.json.result),typeof w>"u")throw new gn("internal","Response is missing data field.");return{data:ia(w)}}function pb(n,e,t,i){const o=n._url(e);return mb(n,o,t,i||{})}async function mb(n,e,t,i){var o;t=Qc(t);const l={data:t},c=await G0(n,i);c["Content-Type"]="application/json",c.Accept="text/event-stream";let h;try{h=await n.fetchImpl(e,{method:"POST",body:JSON.stringify(l),headers:c,signal:i==null?void 0:i.signal})}catch(R){if(R instanceof Error&&R.name==="AbortError"){const z=new gn("cancelled","Request was cancelled.");return{data:Promise.reject(z),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(z)}}}}}}const j=Yc(0,null);return{data:Promise.reject(j),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(j)}}}}}}let p,y;const w=new Promise((R,j)=>{p=R,y=j});(o=i==null?void 0:i.signal)===null||o===void 0||o.addEventListener("abort",()=>{const R=new gn("cancelled","Request was cancelled.");y(R)});const T=h.body.getReader(),S=gb(T,p,y,i==null?void 0:i.signal);return{stream:{[Symbol.asyncIterator](){const R=S.getReader();return{async next(){const{value:j,done:z}=await R.read();return{value:j,done:z}},async return(){return await R.cancel(),{done:!0,value:void 0}}}}},data:w}}function gb(n,e,t,i){const o=(c,h)=>{const p=c.match(ob);if(!p)return;const y=p[1];try{const w=JSON.parse(y);if("result"in w){e(ia(w.result));return}if("message"in w){h.enqueue(ia(w.message));return}if("error"in w){const T=Yc(0,w);h.error(T),t(T);return}}catch(w){if(w instanceof gn){h.error(w),t(w);return}}},l=new TextDecoder;return new ReadableStream({start(c){let h="";return p();async function p(){if(i!=null&&i.aborted){const y=new gn("cancelled","Request was cancelled");return c.error(y),t(y),Promise.resolve()}try{const{value:y,done:w}=await n.read();if(w){h.trim()&&o(h.trim(),c),c.close();return}if(i!=null&&i.aborted){const S=new gn("cancelled","Request was cancelled");c.error(S),t(S),await n.cancel();return}h+=l.decode(y,{stream:!0});const T=h.split(`
`);h=T.pop()||"";for(const S of T)S.trim()&&o(S.trim(),c);return p()}catch(y){const w=y instanceof gn?y:Yc(0,null);c.error(w),t(w)}}},cancel(){return n.cancel()}})}const x_="@firebase/functions",R_="0.12.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
