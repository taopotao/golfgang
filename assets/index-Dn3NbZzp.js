 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I_={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class cn extends rr{constructor(e,t,i){super(`${cm}/${e}`,t||""),this.details=i,Object.setPrototypeOf(this,cn.prototype)}}function ZN(n){if(n>=200&&n<300)return"ok";switch(n){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Kc(n,e){let t=ZN(n),i=t,o;try{const l=e&&e.error;if(l){const c=l.status;if(typeof c=="string"){if(!I_[c])return new cn("internal","internal");t=I_[c],i=c}const h=l.message;typeof h=="string"&&(i=h),o=l.details,o!==void 0&&(o=Zo(o))}}catch{}return t==="ok"?null:new cn(t,i,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zf="us-central1",tb=/^data: (.*?)(?:\n|$)/;function nb(n){let e=null;return{promise:new Promise((t,i)=>{e=setTimeout(()=>{i(new cn("deadline-exceeded","deadline-exceeded"))},n)}),cancel:()=>{e&&clearTimeout(e)}}}class rb{constructor(e,t,i,o,l=Zf,c=(...h)=>fetch(...h)){this.app=e,this.fetchImpl=c,this.emulatorOrigin=null,this.contextProvider=new eb(e,t,i,o),this.cancelAllRequests=new Promise(h=>{this.deleteService=()=>Promise.resolve(h())});try{const h=new URL(l);this.customDomain=h.origin+(h.pathname==="/"?"":h.pathname),this.region=Zf}catch{this.customDomain=null,this.region=l}}_delete(){return this.deleteService()}_url(e){const t=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${t}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${t}.cloudfunctions.net/${e}`}}function ib(n,e,t){const i=Vs(e);n.emulatorOrigin=`http${i?"s":""}://${e}:${t}`,i&&(op(n.emulatorOrigin),ap("Functions",!0))}function sb(n,e,t){const i=o=>ab(n,e,o,{});return i.stream=(o,l)=>ub(n,e,o,l),i}async function ob(n,e,t,i){t["Content-Type"]="application/json";let o;try{o=await i(n,{method:"POST",body:JSON.stringify(e),headers:t})}catch{return{status:0,json:null}}let l=null;try{l=await o.json()}catch{}return{status:o.status,json:l}}async function W0(n,e){const t={},i=await n.contextProvider.getContext(e.limitedUseAppCheckTokens);return i.authToken&&(t.Authorization="Bearer "+i.authToken),i.messagingToken&&(t["Firebase-Instance-ID-Token"]=i.messagingToken),i.appCheckToken!==null&&(t["X-Firebase-AppCheck"]=i.appCheckToken),t}function ab(n,e,t,i){const o=n._url(e);return lb(n,o,t,i)}async function lb(n,e,t,i){t=Hc(t);const o={data:t},l=await W0(n,i),c=i.timeout||7e4,h=nb(c),p=await Promise.race([ob(e,o,l,n.fetchImpl),h.promise,n.cancelAllRequests]);if(h.cancel(),!p)throw new cn("cancelled","Firebase Functions instance was deleted.");const y=Kc(p.status,p.json);if(y)throw y;if(!p.json)throw new cn("internal","Response is not valid JSON object.");let w=p.json.data;if(typeof w>"u"&&(w=p.json.result),typeof w>"u")throw new cn("internal","Response is missing data field.");return{data:Zo(w)}}function ub(n,e,t,i){const o=n._url(e);return cb(n,o,t,i||{})}async function cb(n,e,t,i){var o;t=Hc(t);const l={data:t},c=await W0(n,i);c["Content-Type"]="application/json",c.Accept="text/event-stream";let h;try{h=await n.fetchImpl(e,{method:"POST",body:JSON.stringify(l),headers:c,signal:i==null?void 0:i.signal})}catch(P){if(P instanceof Error&&P.name==="AbortError"){const z=new cn("cancelled","Request was cancelled.");return{data:Promise.reject(z),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(z)}}}}}}const j=Kc(0,null);return{data:Promise.reject(j),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(j)}}}}}}let p,y;const w=new Promise((P,j)=>{p=P,y=j});(o=i==null?void 0:i.signal)===null||o===void 0||o.addEventListener("abort",()=>{const P=new cn("cancelled","Request was cancelled.");y(P)});const T=h.body.getReader(),S=db(T,p,y,i==null?void 0:i.signal);return{stream:{[Symbol.asyncIterator](){const P=S.getReader();return{async next(){const{value:j,done:z}=await P.read();return{value:j,done:z}},async return(){return await P.cancel(),{done:!0,value:void 0}}}}},data:w}}function db(n,e,t,i){const o=(c,h)=>{const p=c.match(tb);if(!p)return;const y=p[1];try{const w=JSON.parse(y);if("result"in w){e(Zo(w.result));return}if("message"in w){h.enqueue(Zo(w.message));return}if("error"in w){const T=Kc(0,w);h.error(T),t(T);return}}catch(w){if(w instanceof cn){h.error(w),t(w);return}}},l=new TextDecoder;return new ReadableStream({start(c){let h="";return p();async function p(){if(i!=null&&i.aborted){const y=new cn("cancelled","Request was cancelled");return c.error(y),t(y),Promise.resolve()}try{const{value:y,done:w}=await n.read();if(w){h.trim()&&o(h.trim(),c),c.close();return}if(i!=null&&i.aborted){const S=new cn("cancelled","Request was cancelled");c.error(S),t(S),await n.cancel();return}h+=l.decode(y,{stream:!0});const T=h.split(`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hb="auth-internal",fb="app-check-internal",pb="messaging-internal";function mb(n){const e=(t,{instanceIdentifier:i})=>{const o=t.getProvider("app").getImmediate(),l=t.getProvider(hb),c=t.getProvider(pb),h=t.getProvider(fb);return new rb(o,l,c,h,i)};er(new Ln(cm,e,"PUBLIC").setMultipleInstances(!0)),dn(S_,A_,n),dn(S_,A_,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
