 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Sy;function nI(){return Sy||(Sy=1,(function(n){function e(oe,_e){var ae=oe.length;oe.push(_e);e:for(;0<ae;){var V=ae-1>>>1,K=oe[V];if(0<o(K,_e))oe[V]=_e,oe[ae]=K,ae=V;else break e}}function t(oe){return oe.length===0?null:oe[0]}function i(oe){if(oe.length===0)return null;var _e=oe[0],ae=oe.pop();if(ae!==_e){oe[0]=ae;e:for(var V=0,K=oe.length,H=K>>>1;V<H;){var le=2*(V+1)-1,he=oe[le],Y=le+1,re=oe[Y];if(0>o(he,ae))Y<K&&0>o(re,he)?(oe[V]=re,oe[Y]=ae,V=Y):(oe[V]=he,oe[le]=ae,V=le);else if(Y<K&&0>o(re,ae))oe[V]=re,oe[Y]=ae,V=Y;else break e}}return _e}function o(oe,_e){var ae=oe.sortIndex-_e.sortIndex;return ae!==0?ae:oe.id-_e.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;n.unstable_now=function(){return l.now()}}else{var c=Date,h=c.now();n.unstable_now=function(){return c.now()-h}}var p=[],y=[],w=1,T=null,S=3,P=!1,j=!1,z=!1,M=typeof setTimeout=="function"?setTimeout:null,te=typeof clearTimeout=="function"?clearTimeout:null,ie=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function X(oe){for(var _e=t(y);_e!==null;){if(_e.callback===null)i(y);else if(_e.startTime<=oe)i(y),_e.sortIndex=_e.expirationTime,e(p,_e);else break;_e=t(y)}}function ue(oe){if(z=!1,X(oe),!j)if(t(p)!==null)j=!0,ht(Ce);else{var _e=t(y);_e!==null&&Ue(ue,_e.startTime-oe)}}function Ce(oe,_e){j=!1,z&&(z=!1,te(A),A=-1),P=!0;var ae=S;try{for(X(_e),T=t(p);T!==null&&(!(T.expirationTime>_e)||oe&&!O());){var V=T.callback;if(typeof V=="function"){T.callback=null,S=T.priorityLevel;var K=V(T.expirationTime<=_e);_e=n.unstable_now(),typeof K=="function"?T.callback=K:T===t(p)&&i(p),X(_e)}else i(p);T=t(p)}if(T!==null)var H=!0;else{var le=t(y);le!==null&&Ue(ue,le.startTime-_e),H=!1}return H}finally{T=null,S=ae,P=!1}}var Re=!1,b=null,A=-1,R=5,x=-1;function O(){return!(n.unstable_now()-x<R)}function L(){if(b!==null){var oe=n.unstable_now();x=oe;var _e=!0;try{_e=b(!0,oe)}finally{_e?k():(Re=!1,b=null)}}else Re=!1}var k;if(typeof ie=="function")k=function(){ie(L)};else if(typeof MessageChannel<"u"){var Je=new MessageChannel,dt=Je.port2;Je.port1.onmessage=L,k=function(){dt.postMessage(null)}}else k=function(){M(L,0)};function ht(oe){b=oe,Re||(Re=!0,k())}function Ue(oe,_e){A=M(function(){oe(n.unstable_now())},_e)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(oe){oe.callback=null},n.unstable_continueExecution=function(){j||P||(j=!0,ht(Ce))},n.unstable_forceFrameRate=function(oe){0>oe||125<oe?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<oe?Math.floor(1e3/oe):5},n.unstable_getCurrentPriorityLevel=function(){return S},n.unstable_getFirstCallbackNode=function(){return t(p)},n.unstable_next=function(oe){switch(S){case 1:case 2:case 3:var _e=3;break;default:_e=S}var ae=S;S=_e;try{return oe()}finally{S=ae}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(oe,_e){switch(oe){case 1:case 2:case 3:case 4:case 5:break;default:oe=3}var ae=S;S=oe;try{return _e()}finally{S=ae}},n.unstable_scheduleCallback=function(oe,_e,ae){var V=n.unstable_now();switch(typeof ae=="object"&&ae!==null?(ae=ae.delay,ae=typeof ae=="number"&&0<ae?V+ae:V):ae=V,oe){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=ae+K,oe={id:w++,callback:_e,priorityLevel:oe,startTime:ae,expirationTime:K,sortIndex:-1},ae>V?(oe.sortIndex=ae,e(y,oe),t(p)===null&&oe===t(y)&&(z?(te(A),A=-1):z=!0,Ue(ue,ae-V))):(oe.sortIndex=K,e(p,oe),j||P||(j=!0,ht(Ce))),oe},n.unstable_shouldYield=O,n.unstable_wrapCallback=function(oe){var _e=S;return function(){var ae=S;S=_e;try{return oe.apply(this,arguments)}finally{S=ae}}}})(nf)),nf}var Ay;function rI(){return Ay||(Ay=1,tf.exports=nI()),tf.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kw(n,e,t=!1){if(ln(n.app))return Promise.reject(_r(n));const i="signIn",o=await Aw(n,i,e),l=await bs._fromIdTokenResponse(n,i,o);return t||await n._updateCurrentUser(l.user),l}async function $A(n,e){return kw(Qi(n),e)}async function WA(n,e){return Cw(Ke(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rw(n){const e=Qi(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function qA(n,e,t){const i=Qi(n);await xc(i,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",VA)}async function HA(n,e,t){if(ln(n.app))return Promise.reject(_r(n));const i=Qi(n),c=await xc(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",BA).catch(p=>{throw p.code==="auth/password-does-not-meet-requirements"&&Rw(n),p}),h=await bs._fromIdTokenResponse(i,"signIn",c);return await i._updateCurrentUser(h.user),h}function KA(n,e,t){return ln(n.app)?Promise.reject(_r(n)):$A(Ke(n),Us.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Rw(n),i})}function GA(n,e){const t=Ke(n);return ln(t.auth.app)?Promise.reject(_r(t.auth)):Pw(t,e,null)}function QA(n,e){return Pw(Ke(n),null,e)}async function Pw(n,e,t){const{auth:i}=n,l={idToken:await n.getIdToken(),returnSecureToken:!0};e&&(l.email=e),t&&(l.password=t);const c=await Ho(n,NA(i,l));await n._updateTokensIfNecessary(c,!0)}function YA(n,e,t,i){return Ke(n).onIdTokenChanged(e,t,i)}function JA(n,e,t){return Ke(n).beforeAuthStateChanged(e,t)}function XA(n,e,t,i){return Ke(n).onAuthStateChanged(e,t,i)}function ZA(n){return Ke(n).signOut()}const bc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var ji,Uw;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(b,A){function R(){}R.prototype=A.prototype,b.D=A.prototype,b.prototype=new R,b.prototype.constructor=b,b.C=function(x,O,L){for(var k=Array(arguments.length-2),Je=2;Je<arguments.length;Je++)k[Je-2]=arguments[Je];return A.prototype[O].apply(x,k)}}function t(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(i,t),i.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(b,A,R){R||(R=0);var x=Array(16);if(typeof A=="string")for(var O=0;16>O;++O)x[O]=A.charCodeAt(R++)|A.charCodeAt(R++)<<8|A.charCodeAt(R++)<<16|A.charCodeAt(R++)<<24;else for(O=0;16>O;++O)x[O]=A[R++]|A[R++]<<8|A[R++]<<16|A[R++]<<24;A=b.g[0],R=b.g[1],O=b.g[2];var L=b.g[3],k=A+(L^R&(O^L))+x[0]+3614090360&4294967295;A=R+(k<<7&4294967295|k>>>25),k=L+(O^A&(R^O))+x[1]+3905402710&4294967295,L=A+(k<<12&4294967295|k>>>20),k=O+(R^L&(A^R))+x[2]+606105819&4294967295,O=L+(k<<17&4294967295|k>>>15),k=R+(A^O&(L^A))+x[3]+3250441966&4294967295,R=O+(k<<22&4294967295|k>>>10),k=A+(L^R&(O^L))+x[4]+4118548399&4294967295,A=R+(k<<7&4294967295|k>>>25),k=L+(O^A&(R^O))+x[5]+1200080426&4294967295,L=A+(k<<12&4294967295|k>>>20),k=O+(R^L&(A^R))+x[6]+2821735955&4294967295,O=L+(k<<17&4294967295|k>>>15),k=R+(A^O&(L^A))+x[7]+4249261313&4294967295,R=O+(k<<22&4294967295|k>>>10),k=A+(L^R&(O^L))+x[8]+1770035416&4294967295,A=R+(k<<7&4294967295|k>>>25),k=L+(O^A&(R^O))+x[9]+2336552879&4294967295,L=A+(k<<12&4294967295|k>>>20),k=O+(R^L&(A^R))+x[10]+4294925233&4294967295,O=L+(k<<17&4294967295|k>>>15),k=R+(A^O&(L^A))+x[11]+2304563134&4294967295,R=O+(k<<22&4294967295|k>>>10),k=A+(L^R&(O^L))+x[12]+1804603682&4294967295,A=R+(k<<7&4294967295|k>>>25),k=L+(O^A&(R^O))+x[13]+4254626195&4294967295,L=A+(k<<12&4294967295|k>>>20),k=O+(R^L&(A^R))+x[14]+2792965006&4294967295,O=L+(k<<17&4294967295|k>>>15),k=R+(A^O&(L^A))+x[15]+1236535329&4294967295,R=O+(k<<22&4294967295|k>>>10),k=A+(O^L&(R^O))+x[1]+4129170786&4294967295,A=R+(k<<5&4294967295|k>>>27),k=L+(R^O&(A^R))+x[6]+3225465664&4294967295,L=A+(k<<9&4294967295|k>>>23),k=O+(A^R&(L^A))+x[11]+643717713&4294967295,O=L+(k<<14&4294967295|k>>>18),k=R+(L^A&(O^L))+x[0]+3921069994&4294967295,R=O+(k<<20&4294967295|k>>>12),k=A+(O^L&(R^O))+x[5]+3593408605&4294967295,A=R+(k<<5&4294967295|k>>>27),k=L+(R^O&(A^R))+x[10]+38016083&4294967295,L=A+(k<<9&4294967295|k>>>23),k=O+(A^R&(L^A))+x[15]+3634488961&4294967295,O=L+(k<<14&4294967295|k>>>18),k=R+(L^A&(O^L))+x[4]+3889429448&4294967295,R=O+(k<<20&4294967295|k>>>12),k=A+(O^L&(R^O))+x[9]+568446438&4294967295,A=R+(k<<5&4294967295|k>>>27),k=L+(R^O&(A^R))+x[14]+3275163606&4294967295,L=A+(k<<9&4294967295|k>>>23),k=O+(A^R&(L^A))+x[3]+4107603335&4294967295,O=L+(k<<14&4294967295|k>>>18),k=R+(L^A&(O^L))+x[8]+1163531501&4294967295,R=O+(k<<20&4294967295|k>>>12),k=A+(O^L&(R^O))+x[13]+2850285829&4294967295,A=R+(k<<5&4294967295|k>>>27),k=L+(R^O&(A^R))+x[2]+4243563512&4294967295,L=A+(k<<9&4294967295|k>>>23),k=O+(A^R&(L^A))+x[7]+1735328473&4294967295,O=L+(k<<14&4294967295|k>>>18),k=R+(L^A&(O^L))+x[12]+2368359562&4294967295,R=O+(k<<20&4294967295|k>>>12),k=A+(R^O^L)+x[5]+4294588738&4294967295,A=R+(k<<4&4294967295|k>>>28),k=L+(A^R^O)+x[8]+2272392833&4294967295,L=A+(k<<11&4294967295|k>>>21),k=O+(L^A^R)+x[11]+1839030562&4294967295,O=L+(k<<16&4294967295|k>>>16),k=R+(O^L^A)+x[14]+4259657740&4294967295,R=O+(k<<23&4294967295|k>>>9),k=A+(R^O^L)+x[1]+2763975236&4294967295,A=R+(k<<4&4294967295|k>>>28),k=L+(A^R^O)+x[4]+1272893353&4294967295,L=A+(k<<11&4294967295|k>>>21),k=O+(L^A^R)+x[7]+4139469664&4294967295,O=L+(k<<16&4294967295|k>>>16),k=R+(O^L^A)+x[10]+3200236656&4294967295,R=O+(k<<23&4294967295|k>>>9),k=A+(R^O^L)+x[13]+681279174&4294967295,A=R+(k<<4&4294967295|k>>>28),k=L+(A^R^O)+x[0]+3936430074&4294967295,L=A+(k<<11&4294967295|k>>>21),k=O+(L^A^R)+x[3]+3572445317&4294967295,O=L+(k<<16&4294967295|k>>>16),k=R+(O^L^A)+x[6]+76029189&4294967295,R=O+(k<<23&4294967295|k>>>9),k=A+(R^O^L)+x[9]+3654602809&4294967295,A=R+(k<<4&4294967295|k>>>28),k=L+(A^R^O)+x[12]+3873151461&4294967295,L=A+(k<<11&4294967295|k>>>21),k=O+(L^A^R)+x[15]+530742520&4294967295,O=L+(k<<16&4294967295|k>>>16),k=R+(O^L^A)+x[2]+3299628645&4294967295,R=O+(k<<23&4294967295|k>>>9),k=A+(O^(R|~L))+x[0]+4096336452&4294967295,A=R+(k<<6&4294967295|k>>>26),k=L+(R^(A|~O))+x[7]+1126891415&4294967295,L=A+(k<<10&4294967295|k>>>22),k=O+(A^(L|~R))+x[14]+2878612391&4294967295,O=L+(k<<15&4294967295|k>>>17),k=R+(L^(O|~A))+x[5]+4237533241&4294967295,R=O+(k<<21&4294967295|k>>>11),k=A+(O^(R|~L))+x[12]+1700485571&4294967295,A=R+(k<<6&4294967295|k>>>26),k=L+(R^(A|~O))+x[3]+2399980690&4294967295,L=A+(k<<10&4294967295|k>>>22),k=O+(A^(L|~R))+x[10]+4293915773&4294967295,O=L+(k<<15&4294967295|k>>>17),k=R+(L^(O|~A))+x[1]+2240044497&4294967295,R=O+(k<<21&4294967295|k>>>11),k=A+(O^(R|~L))+x[8]+1873313359&4294967295,A=R+(k<<6&4294967295|k>>>26),k=L+(R^(A|~O))+x[15]+4264355552&4294967295,L=A+(k<<10&4294967295|k>>>22),k=O+(A^(L|~R))+x[6]+2734768916&4294967295,O=L+(k<<15&4294967295|k>>>17),k=R+(L^(O|~A))+x[13]+1309151649&4294967295,R=O+(k<<21&4294967295|k>>>11),k=A+(O^(R|~L))+x[4]+4149444226&4294967295,A=R+(k<<6&4294967295|k>>>26),k=L+(R^(A|~O))+x[11]+3174756917&4294967295,L=A+(k<<10&4294967295|k>>>22),k=O+(A^(L|~R))+x[2]+718787259&4294967295,O=L+(k<<15&4294967295|k>>>17),k=R+(L^(O|~A))+x[9]+3951481745&4294967295,b.g[0]=b.g[0]+A&4294967295,b.g[1]=b.g[1]+(O+(k<<21&4294967295|k>>>11))&4294967295,b.g[2]=b.g[2]+O&4294967295,b.g[3]=b.g[3]+L&4294967295}i.prototype.u=function(b,A){A===void 0&&(A=b.length);for(var R=A-this.blockSize,x=this.B,O=this.h,L=0;L<A;){if(O==0)for(;L<=R;)o(this,b,L),L+=this.blockSize;if(typeof b=="string"){for(;L<A;)if(x[O++]=b.charCodeAt(L++),O==this.blockSize){o(this,x),O=0;break}}else for(;L<A;)if(x[O++]=b[L++],O==this.blockSize){o(this,x),O=0;break}}this.h=O,this.o+=A},i.prototype.v=function(){var b=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);b[0]=128;for(var A=1;A<b.length-8;++A)b[A]=0;var R=8*this.o;for(A=b.length-8;A<b.length;++A)b[A]=R&255,R/=256;for(this.u(b),b=Array(16),A=R=0;4>A;++A)for(var x=0;32>x;x+=8)b[R++]=this.g[A]>>>x&255;return b};function l(b,A){var R=h;return Object.prototype.hasOwnProperty.call(R,b)?R[b]:R[b]=A(b)}function c(b,A){this.h=A;for(var R=[],x=!0,O=b.length-1;0<=O;O--){var L=b[O]|0;x&&L==A||(R[O]=L,x=!1)}this.g=R}var h={};function p(b){return-128<=b&&128>b?l(b,function(A){return new c([A|0],0>A?-1:0)}):new c([b|0],0>b?-1:0)}function y(b){if(isNaN(b)||!isFinite(b))return T;if(0>b)return M(y(-b));for(var A=[],R=1,x=0;b>=R;x++)A[x]=b/R|0,R*=4294967296;return new c(A,0)}function w(b,A){if(b.length==0)throw Error("number format error: empty string");if(A=A||10,2>A||36<A)throw Error("radix out of range: "+A);if(b.charAt(0)=="-")return M(w(b.substring(1),A));if(0<=b.indexOf("-"))throw Error('number format error: interior "-" character');for(var R=y(Math.pow(A,8)),x=T,O=0;O<b.length;O+=8){var L=Math.min(8,b.length-O),k=parseInt(b.substring(O,O+L),A);8>L?(L=y(Math.pow(A,L)),x=x.j(L).add(y(k))):(x=x.j(R),x=x.add(y(k)))}return x}var T=p(0),S=p(1),P=p(16777216);n=c.prototype,n.m=function(){if(z(this))return-M(this).m();for(var b=0,A=1,R=0;R<this.g.length;R++){var x=this.i(R);b+=(0<=x?x:4294967296+x)*A,A*=4294967296}return b},n.toString=function(b){if(b=b||10,2>b||36<b)throw Error("radix out of range: "+b);if(j(this))return"0";if(z(this))return"-"+M(this).toString(b);for(var A=y(Math.pow(b,6)),R=this,x="";;){var O=ue(R,A).g;R=te(R,O.j(A));var L=((0<R.g.length?R.g[0]:R.h)>>>0).toString(b);if(R=O,j(R))return L+x;for(;6>L.length;)L="0"+L;x=L+x}},n.i=function(b){return 0>b?0:b<this.g.length?this.g[b]:this.h};function j(b){if(b.h!=0)return!1;for(var A=0;A<b.g.length;A++)if(b.g[A]!=0)return!1;return!0}function z(b){return b.h==-1}n.l=function(b){return b=te(this,b),z(b)?-1:j(b)?0:1};function M(b){for(var A=b.g.length,R=[],x=0;x<A;x++)R[x]=~b.g[x];return new c(R,~b.h).add(S)}n.abs=function(){return z(this)?M(this):this},n.add=function(b){for(var A=Math.max(this.g.length,b.g.length),R=[],x=0,O=0;O<=A;O++){var L=x+(this.i(O)&65535)+(b.i(O)&65535),k=(L>>>16)+(this.i(O)>>>16)+(b.i(O)>>>16);x=k>>>16,L&=65535,k&=65535,R[O]=k<<16|L}return new c(R,R[R.length-1]&-2147483648?-1:0)};function te(b,A){return b.add(M(A))}n.j=function(b){if(j(this)||j(b))return T;if(z(this))return z(b)?M(this).j(M(b)):M(M(this).j(b));if(z(b))return M(this.j(M(b)));if(0>this.l(P)&&0>b.l(P))return y(this.m()*b.m());for(var A=this.g.length+b.g.length,R=[],x=0;x<2*A;x++)R[x]=0;for(x=0;x<this.g.length;x++)for(var O=0;O<b.g.length;O++){var L=this.i(x)>>>16,k=this.i(x)&65535,Je=b.i(O)>>>16,dt=b.i(O)&65535;R[2*x+2*O]+=k*dt,ie(R,2*x+2*O),R[2*x+2*O+1]+=L*dt,ie(R,2*x+2*O+1),R[2*x+2*O+1]+=k*Je,ie(R,2*x+2*O+1),R[2*x+2*O+2]+=L*Je,ie(R,2*x+2*O+2)}for(x=0;x<A;x++)R[x]=R[2*x+1]<<16|R[2*x];for(x=A;x<2*A;x++)R[x]=0;return new c(R,0)};function ie(b,A){for(;(b[A]&65535)!=b[A];)b[A+1]+=b[A]>>>16,b[A]&=65535,A++}function X(b,A){this.g=b,this.h=A}function ue(b,A){if(j(A))throw Error("division by zero");if(j(b))return new X(T,T);if(z(b))return A=ue(M(b),A),new X(M(A.g),M(A.h));if(z(A))return A=ue(b,M(A)),new X(M(A.g),A.h);if(30<b.g.length){if(z(b)||z(A))throw Error("slowDivide_ only works with positive integers.");for(var R=S,x=A;0>=x.l(b);)R=Ce(R),x=Ce(x);var O=Re(R,1),L=Re(x,1);for(x=Re(x,2),R=Re(R,2);!j(x);){var k=L.add(x);0>=k.l(b)&&(O=O.add(R),L=k),x=Re(x,1),R=Re(R,1)}return A=te(b,O.j(A)),new X(O,A)}for(O=T;0<=b.l(A);){for(R=Math.max(1,Math.floor(b.m()/A.m())),x=Math.ceil(Math.log(R)/Math.LN2),x=48>=x?1:Math.pow(2,x-48),L=y(R),k=L.j(A);z(k)||0<k.l(b);)R-=x,L=y(R),k=L.j(A);j(L)&&(L=S),O=O.add(L),b=te(b,k)}return new X(O,b)}n.A=function(b){return ue(this,b).h},n.and=function(b){for(var A=Math.max(this.g.length,b.g.length),R=[],x=0;x<A;x++)R[x]=this.i(x)&b.i(x);return new c(R,this.h&b.h)},n.or=function(b){for(var A=Math.max(this.g.length,b.g.length),R=[],x=0;x<A;x++)R[x]=this.i(x)|b.i(x);return new c(R,this.h|b.h)},n.xor=function(b){for(var A=Math.max(this.g.length,b.g.length),R=[],x=0;x<A;x++)R[x]=this.i(x)^b.i(x);return new c(R,this.h^b.h)};function Ce(b){for(var A=b.g.length+1,R=[],x=0;x<A;x++)R[x]=b.i(x)<<1|b.i(x-1)>>>31;return new c(R,b.h)}function Re(b,A){var R=A>>5;A%=32;for(var x=b.g.length-R,O=[],L=0;L<x;L++)O[L]=0<A?b.i(L+R)>>>A|b.i(L+R+1)<<32-A:b.i(L+R);return new c(O,b.h)}i.prototype.digest=i.prototype.v,i.prototype.reset=i.prototype.s,i.prototype.update=i.prototype.u,Uw=i,c.prototype.add=c.prototype.add,c.prototype.multiply=c.prototype.j,c.prototype.modulo=c.prototype.A,c.prototype.compare=c.prototype.l,c.prototype.toNumber=c.prototype.m,c.prototype.toString=c.prototype.toString,c.prototype.getBits=c.prototype.i,c.fromNumber=y,c.fromString=w,ji=c}).apply(typeof pv<"u"?pv:typeof self<"u"?self:typeof window<"u"?window:{});var oc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $s{constructor(e,t,i){this.converter=t,this._query=i,this.type="query",this.firestore=e}withConverter(e){return new $s(this.firestore,e,this._query)}}class ot{constructor(e,t,i){this.converter=t,this._key=i,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Fi(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ot(this.firestore,e,this._key)}toJSON(){return{type:ot._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,i){if(Dl(t,ot._jsonSchema))return new ot(e,i||null,new we(Ye.fromString(t.referencePath)))}}ot._jsonSchemaVersion="firestore/documentReference/1.0",ot._jsonSchema={type:yt("string",ot._jsonSchemaVersion),referencePath:yt("string")};class Fi extends $s{constructor(e,t,i){super(e,t,ad(i)),this._path=i,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ot(this.firestore,null,new we(e))}withConverter(e){return new Fi(this.firestore,e,this._path)}}function Cr(n,e,...t){if(n=Ke(n),Qw("collection","path",e),n instanceof gd){const i=Ye.fromString(e,...t);return Ev(i),new Fi(n,null,i)}{if(!(n instanceof ot||n instanceof Fi))throw new ce(G.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=n._path.child(Ye.fromString(e,...t));return Ev(i),new Fi(n.firestore,null,i)}}function Pt(n,e,...t){if(n=Ke(n),arguments.length===1&&(e=Tp.newId()),Qw("doc","path",e),n instanceof gd){const i=Ye.fromString(e,...t);return wv(i),new ot(n,null,new we(i))}{if(!(n instanceof ot||n instanceof Fi))throw new ce(G.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=n._path.child(Ye.fromString(e,...t));return wv(i),new ot(n.firestore,n instanceof Fi?n.converter:null,new we(i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zf(n=Zc()){return $0().then(e=>{if(!e)throw Jt.create("unsupported-browser")},e=>{throw Jt.create("indexed-db-unsupported")}),Fs(Ke(n),"messaging").getImmediate()}async function ep(n,e){return n=Ke(n),z0(n,e)}GN();const QN={apiKey:"AIzaSyAUNktXGZeeXlX3LKFolXZRVQZGDohlIF0",authDomain:"golfgang-79922.firebaseapp.com",projectId:"golfgang-79922",storageBucket:"golfgang-79922.appspot.com",messagingSenderId:"223762413770",appId:"1:223762413770:web:098607b8f30080df90dc33",measurementId:"G-T1FXETH3K0"},ea=tw(QN),zl=ck(ea),He=lx(ea),W0=W.createContext(null);function YN({children:n}){const[e,t]=W.useState(null),[i,o]=W.useState(null),[l,c]=W.useState(!1),[h,p]=W.useState(!0);W.useEffect(()=>{const w=XA(zl,async T=>{if(!T){t(null),o(null),c(!1),p(!1);return}t(T);try{const S=Pt(He,"users",T.uid),P=await rm(S);if(P.exists()){const j=P.data();o(j),c((j==null?void 0:j.isAdmin)===!0)}else o({}),c(!1)}catch(S){console.error("Error loading user profile:",S),o({})}p(!1)});return()=>w()},[]);const y={user:e,profile:i,isAdmin:l,loading:h};return v.jsx(W0.Provider,{value:y,children:n})}function Xi(){return W.useContext(W0)}function JN(){var p;const{user:n,isAdmin:e}=Xi(),t=sa(),i=ia(),[o,l]=W.useState(!1),c=async()=>{await ZA(zl),t("/login")},h=()=>l(!1);return v.jsxs(v.Fragment,{children:[v.jsx("style",{children:`
        .nav-desktop {
          display: flex;
        }
        .nav-mobile-burger {
