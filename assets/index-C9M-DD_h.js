 ...
 */var iy;function xT(){if(iy)return Ne;iy=1;var n=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),T=Symbol.iterator;function S(L){return L===null||typeof L!="object"?null:(L=T&&L[T]||L["@@iterator"],typeof L=="function"?L:null)}var N={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},B=Object.assign,W={};function M(L,K,H){this.props=L,this.context=K,this.refs=W,this.updater=H||N}M.prototype.isReactComponent={},M.prototype.setState=function(L,K){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,K,"setState")},M.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function se(){}se.prototype=M.prototype;function ne(L,K,H){this.props=L,this.context=K,this.refs=W,this.updater=H||N}var X=ne.prototype=new se;X.constructor=ne,B(X,M.prototype),X.isPureReactComponent=!0;var ye=Array.isArray,Pe=Object.prototype.hasOwnProperty,ke={current:null},b={key:!0,ref:!0,__self:!0,__source:!0};function A(L,K,H){var G,Y={},le=null,Te=null;if(K!=null)for(G in K.ref!==void 0&&(Te=K.ref),K.key!==void 0&&(le=""+K.key),K)Pe.call(K,G)&&!b.hasOwnProperty(G)&&(Y[G]=K[G]);var _e=arguments.length-2;if(_e===1)Y.children=H;else if(1<_e){for(var be=Array(_e),st=0;st<_e;st++)be[st]=arguments[st+2];Y.children=be}if(L&&L.defaultProps)for(G in _e=L.defaultProps,_e)Y[G]===void 0&&(Y[G]=_e[G]);return{$$typeof:n,type:L,key:le,ref:Te,props:Y,_owner:ke.current}}function k(L,K){return{$$typeof:n,type:L.type,key:K,ref:L.ref,props:L.props,_owner:L._owner}}function x(L){return typeof L=="object"&&L!==null&&L.$$typeof===n}function O(L){var K={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(H){return K[H]})}var V=/\/+/g;function R(L,K){return typeof L=="object"&&L!==null&&L.key!=null?O(""+L.key):K.toString(36)}function Ge(L,K,H,G,Y){var le=typeof L;(le==="undefined"||le==="boolean")&&(L=null);var Te=!1;if(L===null)Te=!0;else switch(le){case"string":case"number":Te=!0;break;case"object":switch(L.$$typeof){case n:case e:Te=!0}}if(Te)return Te=L,Y=Y(Te),L=G===""?"."+R(Te,0):G,ye(Y)?(H="",L!=null&&(H=L.replace(V,"$&/")+"/"),Ge(Y,K,H,"",function(st){return st})):Y!=null&&(x(Y)&&(Y=k(Y,H+(!Y.key||Te&&Te.key===Y.key?"":(""+Y.key).replace(V,"$&/")+"/")+L)),K.push(Y)),1;if(Te=0,G=G===""?".":G+":",ye(L))for(var _e=0;_e<L.length;_e++){le=L[_e];var be=G+R(le,_e);Te+=Ge(le,K,H,be,Y)}else if(be=S(L),typeof be=="function")for(L=be.call(L),_e=0;!(le=L.next()).done;)le=le.value,be=G+R(le,_e++),Te+=Ge(le,K,H,be,Y);else if(le==="object")throw K=String(L),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.");return Te}function ht(L,K,H){if(L==null)return L;var G=[],Y=0;return Ge(L,G,"","",function(le){return K.call(H,le,Y++)}),G}function it(L){if(L._status===-1){var K=L._result;K=K(),K.then(function(H){(L._status===0||L._status===-1)&&(L._status=1,L._result=H)},function(H){(L._status===0||L._status===-1)&&(L._status=2,L._result=H)}),L._status===-1&&(L._status=0,L._result=K)}if(L._status===1)return L._result.default;throw L._result}var je={current:null},ie={transition:null},me={ReactCurrentDispatcher:je,ReactCurrentBatchConfig:ie,ReactCurrentOwner:ke};function ae(){throw Error("act(...) is not supported in production builds of React.")}return Ne.Children={map:ht,forEach:function(L,K,H){ht(L,function(){K.apply(this,arguments)},H)},count:function(L){var K=0;return ht(L,function(){K++}),K},toArray:function(L){return ht(L,function(K){return K})||[]},only:function(L){if(!x(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},Ne.Component=M,Ne.Fragment=t,Ne.Profiler=o,Ne.PureComponent=ne,Ne.StrictMode=i,Ne.Suspense=p,Ne.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=me,Ne.act=ae,Ne.cloneElement=function(L,K,H){if(L==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+L+".");var G=B({},L.props),Y=L.key,le=L.ref,Te=L._owner;if(K!=null){if(K.ref!==void 0&&(le=K.ref,Te=ke.current),K.key!==void 0&&(Y=""+K.key),L.type&&L.type.defaultProps)var _e=L.type.defaultProps;for(be in K)Pe.call(K,be)&&!b.hasOwnProperty(be)&&(G[be]=K[be]===void 0&&_e!==void 0?_e[be]:K[be])}var be=arguments.length-2;if(be===1)G.children=H;else if(1<be){_e=Array(be);for(var st=0;st<be;st++)_e[st]=arguments[st+2];G.children=_e}return{$$typeof:n,type:L.type,key:Y,ref:le,props:G,_owner:Te}},Ne.createContext=function(L){return L={$$typeof:c,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},L.Provider={$$typeof:l,_context:L},L.Consumer=L},Ne.createElement=A,Ne.createFactory=function(L){var K=A.bind(null,L);return K.type=L,K},Ne.createRef=function(){return{current:null}},Ne.forwardRef=function(L){return{$$typeof:f,render:L}},Ne.isValidElement=x,Ne.lazy=function(L){return{$$typeof:w,_payload:{_status:-1,_result:L},_init:it}},Ne.memo=function(L,K){return{$$typeof:y,type:L,compare:K===void 0?null:K}},Ne.startTransition=function(L){var K=ie.transition;ie.transition={};try{L()}finally{ie.transition=K}},Ne.unstable_act=ae,Ne.useCallback=function(L,K){return je.current.useCallback(L,K)},Ne.useContext=function(L){return je.current.useContext(L)},Ne.useDebugValue=function(){},Ne.useDeferredValue=function(L){return je.current.useDeferredValue(L)},Ne.useEffect=function(L,K){return je.current.useEffect(L,K)},Ne.useId=function(){return je.current.useId()},Ne.useImperativeHandle=function(L,K,H){return je.current.useImperativeHandle(L,K,H)},Ne.useInsertionEffect=function(L,K){return je.current.useInsertionEffect(L,K)},Ne.useLayoutEffect=function(L,K){return je.current.useLayoutEffect(L,K)},Ne.useMemo=function(L,K){return je.current.useMemo(L,K)},Ne.useReducer=function(L,K,H){return je.current.useReducer(L,K,H)},Ne.useRef=function(L){return je.current.useRef(L)},Ne.useState=function(L){return je.current.useState(L)},Ne.useSyncExternalStore=function(L,K,H){return je.current.useSyncExternalStore(L,K,H)},Ne.useTransition=function(){return je.current.useTransition()},Ne.version="18.3.1",Ne}var sy;function $f(){return sy||(sy=1,Wh.exports=xT()),Wh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ly;function OT(){return ly||(ly=1,(function(n){function e(ie,me){var ae=ie.length;ie.push(me);e:for(;0<ae;){var L=ae-1>>>1,K=ie[L];if(0<o(K,me))ie[L]=me,ie[ae]=K,ae=L;else break e}}function t(ie){return ie.length===0?null:ie[0]}function i(ie){if(ie.length===0)return null;var me=ie[0],ae=ie.pop();if(ae!==me){ie[0]=ae;e:for(var L=0,K=ie.length,H=K>>>1;L<H;){var G=2*(L+1)-1,Y=ie[G],le=G+1,Te=ie[le];if(0>o(Y,ae))le<K&&0>o(Te,Y)?(ie[L]=Te,ie[le]=ae,L=le):(ie[L]=Y,ie[G]=ae,L=G);else if(le<K&&0>o(Te,ae))ie[L]=Te,ie[le]=ae,L=le;else break e}}return me}function o(ie,me){var ae=ie.sortIndex-me.sortIndex;return ae!==0?ae:ie.id-me.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;n.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();n.unstable_now=function(){return c.now()-f}}var p=[],y=[],w=1,T=null,S=3,N=!1,B=!1,W=!1,M=typeof setTimeout=="function"?setTimeout:null,se=typeof clearTimeout=="function"?clearTimeout:null,ne=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function X(ie){for(var me=t(y);me!==null;){if(me.callback===null)i(y);else if(me.startTime<=ie)i(y),me.sortIndex=me.expirationTime,e(p,me);else break;me=t(y)}}function ye(ie){if(W=!1,X(ie),!B)if(t(p)!==null)B=!0,it(Pe);else{var me=t(y);me!==null&&je(ye,me.startTime-ie)}}function Pe(ie,me){B=!1,W&&(W=!1,se(A),A=-1),N=!0;var ae=S;try{for(X(me),T=t(p);T!==null&&(!(T.expirationTime>me)||ie&&!O());){var L=T.callback;if(typeof L=="function"){T.callback=null,S=T.priorityLevel;var K=L(T.expirationTime<=me);me=n.unstable_now(),typeof K=="function"?T.callback=K:T===t(p)&&i(p),X(me)}else i(p);T=t(p)}if(T!==null)var H=!0;else{var G=t(y);G!==null&&je(ye,G.startTime-me),H=!1}return H}finally{T=null,S=ae,N=!1}}var ke=!1,b=null,A=-1,k=5,x=-1;function O(){return!(n.unstable_now()-x<k)}function V(){if(b!==null){var ie=n.unstable_now();x=ie;var me=!0;try{me=b(!0,ie)}finally{me?R():(ke=!1,b=null)}}else ke=!1}var R;if(typeof ne=="function")R=function(){ne(V)};else if(typeof MessageChannel<"u"){var Ge=new MessageChannel,ht=Ge.port2;Ge.port1.onmessage=V,R=function(){ht.postMessage(null)}}else R=function(){M(V,0)};function it(ie){b=ie,ke||(ke=!0,R())}function je(ie,me){A=M(function(){ie(n.unstable_now())},me)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(ie){ie.callback=null},n.unstable_continueExecution=function(){B||N||(B=!0,it(Pe))},n.unstable_forceFrameRate=function(ie){0>ie||125<ie?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):k=0<ie?Math.floor(1e3/ie):5},n.unstable_getCurrentPriorityLevel=function(){return S},n.unstable_getFirstCallbackNode=function(){return t(p)},n.unstable_next=function(ie){switch(S){case 1:case 2:case 3:var me=3;break;default:me=S}var ae=S;S=me;try{return ie()}finally{S=ae}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(ie,me){switch(ie){case 1:case 2:case 3:case 4:case 5:break;default:ie=3}var ae=S;S=ie;try{return me()}finally{S=ae}},n.unstable_scheduleCallback=function(ie,me,ae){var L=n.unstable_now();switch(typeof ae=="object"&&ae!==null?(ae=ae.delay,ae=typeof ae=="number"&&0<ae?L+ae:L):ae=L,ie){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=ae+K,ie={id:w++,callback:me,priorityLevel:ie,startTime:ae,expirationTime:K,sortIndex:-1},ae>L?(ie.sortIndex=ae,e(y,ie),t(p)===null&&ie===t(y)&&(W?(se(A),A=-1):W=!0,je(ye,ae-L))):(ie.sortIndex=K,e(p,ie),B||N||(B=!0,it(Pe))),ie},n.unstable_shouldYield=O,n.unstable_wrapCallback=function(ie){var me=S;return function(){var ae=S;S=me;try{return ie.apply(this,arguments)}finally{S=ae}}}})(Kh)),Kh}var uy;function VT(){return uy||(uy=1,Hh.exports=OT()),Hh.exports}/**
 * @license React
 ...
 *
 * @license MIT
 */function fl(){return fl=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(n[i]=t[i])}return n},fl.apply(this,arguments)}const Gf=$.createContext(null),fI=$.createContext(null),qi=$.createContext(null),Bc=$.createContext(null),Zr=$.createContext({outlet:null,matches:[],isDataRoute:!1}),__=$.createContext(null);function pI(n,e){let{relative:t}=e===void 0?{}:e;Go()||dt(!1);let{basename:i,navigator:o}=$.useContext(qi),{hash:l,pathname:c,search:f}=E_(n,{relative:t}),p=c;return i!=="/"&&(p=c==="/"?i:bi([i,c])),o.createHref({pathname:p,search:f,hash:l})}function Go(){return $.useContext(Bc)!=null}function Qo(){return Go()||dt(!1),$.useContext(Bc).location}function w_(n){$.useContext(qi).static||$.useLayoutEffect(n)}function Yo(){let{isDataRoute:n}=$.useContext(Zr);return n?RI():mI()}function mI(){Go()||dt(!1);let n=$.useContext(Gf),{basename:e,future:t,navigator:i}=$.useContext(qi),{matches:o}=$.useContext(Zr),{pathname:l}=Qo(),c=JSON.stringify(Hf(o,t.v7_relativeSplatPath)),f=$.useRef(!1);return w_(()=>{f.current=!0}),$.useCallback(function(y,w){if(w===void 0&&(w={}),!f.current)return;if(typeof y=="number"){i.go(y);return}let T=Kf(y,JSON.parse(c),l,w.relative==="path");n==null&&e!=="/"&&(T.pathname=T.pathname==="/"?e:bi([e,T.pathname])),(w.replace?i.replace:i.push)(T,w.state,w)},[e,i,c,l,n])}function gI(){let{matches:n}=$.useContext(Zr),e=n[n.length-1];return e?e.params:{}}function E_(n,e){let{relative:t}=e===void 0?{}:e,{future:i}=$.useContext(qi),{matches:o}=$.useContext(Zr),{pathname:l}=Qo(),c=JSON.stringify(Hf(o,i.v7_relativeSplatPath));return $.useMemo(()=>Kf(n,JSON.parse(c),l,t==="path"),[n,c,l,t])}function yI(n,e){return vI(n,e)}function vI(n,e,t,i){Go()||dt(!1);let{navigator:o}=$.useContext(qi),{matches:l}=$.useContext(Zr),c=l[l.length-1],f=c?c.params:{};c&&c.pathname;let p=c?c.pathnameBase:"/";c&&c.route;let y=Qo(),w;if(e){var T;let M=typeof e=="string"?Ko(e):e;p==="/"||(T=M.pathname)!=null&&T.startsWith(p)||dt(!1),w=M}else w=y;let S=w.pathname||"/",N=S;if(p!=="/"){let M=p.replace(/^\//,"").split("/");N="/"+S.replace(/^\//,"").split("/").slice(M.length).join("/")}let B=$T(n,{pathname:N}),W=II(B&&B.map(M=>Object.assign({},M,{params:Object.assign({},f,M.params),pathname:bi([p,o.encodeLocation?o.encodeLocation(M.pathname).pathname:M.pathname]),pathnameBase:M.pathnameBase==="/"?p:bi([p,o.encodeLocation?o.encodeLocation(M.pathnameBase).pathname:M.pathnameBase])})),l,t,i);return e&&W?$.createElement(Bc.Provider,{value:{location:fl({pathname:"/",search:"",hash:"",state:null,key:"default"},w),navigationType:xi.Pop}},W):W}function _I(){let n=kI(),e=dI(n)?n.status+" "+n.statusText:n instanceof Error?n.message:JSON.stringify(n),t=n instanceof Error?n.stack:null,o={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return $.createElement($.Fragment,null,$.createElement("h2",null,"Unexpected Application Error!"),$.createElement("h3",{style:{fontStyle:"italic"}},e),t?$.createElement("pre",{style:o},t):null,null)}const wI=$.createElement(_I,null);class EI extends $.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:t.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){console.error("React Router caught the following error during render",e,t)}render(){return this.state.error!==void 0?$.createElement(Zr.Provider,{value:this.props.routeContext},$.createElement(__.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function TI(n){let{routeContext:e,match:t,children:i}=n,o=$.useContext(Gf);return o&&o.static&&o.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=t.route.id),$.createElement(Zr.Provider,{value:e},i)}function II(n,e,t,i){var o;if(e===void 0&&(e=[]),t===void 0&&(t=null),i===void 0&&(i=null),n==null){var l;if(!t)return null;if(t.errors)n=t.matches;else if((l=i)!=null&&l.v7_partialHydration&&e.length===0&&!t.initialized&&t.matches.length>0)n=t.matches;else return null}let c=n,f=(o=t)==null?void 0:o.errors;if(f!=null){let w=c.findIndex(T=>T.route.id&&(f==null?void 0:f[T.route.id])!==void 0);w>=0||dt(!1),c=c.slice(0,Math.min(c.length,w+1))}let p=!1,y=-1;if(t&&i&&i.v7_partialHydration)for(let w=0;w<c.length;w++){let T=c[w];if((T.route.HydrateFallback||T.route.hydrateFallbackElement)&&(y=w),T.route.id){let{loaderData:S,errors:N}=t,B=T.route.loader&&S[T.route.id]===void 0&&(!N||N[T.route.id]===void 0);if(T.route.lazy||B){p=!0,y>=0?c=c.slice(0,y+1):c=[c[0]];break}}}return c.reduceRight((w,T,S)=>{let N,B=!1,W=null,M=null;t&&(N=f&&T.route.id?f[T.route.id]:void 0,W=T.route.errorElement||wI,p&&(y<0&&S===0?(PI("route-fallback"),B=!0,M=null):y===S&&(B=!0,M=T.route.hydrateFallbackElement||null)));let se=e.concat(c.slice(0,S+1)),ne=()=>{let X;return N?X=W:B?X=M:T.route.Component?X=$.createElement(T.route.Component,null):T.route.element?X=T.route.element:X=w,$.createElement(TI,{match:T,routeContext:{outlet:w,matches:se,isDataRoute:t!=null},children:X})};return t&&(T.route.ErrorBoundary||T.route.errorElement||S===0)?$.createElement(EI,{location:t.location,revalidation:t.revalidation,component:W,error:N,children:ne(),routeContext:{outlet:null,matches:se,isDataRoute:!0}}):ne()},null)}var T_=(function(n){return n.UseBlocker="useBlocker",n.UseRevalidator="useRevalidator",n.UseNavigateStable="useNavigate",n})(T_||{}),I_=(function(n){return n.UseBlocker="useBlocker",n.UseLoaderData="useLoaderData",n.UseActionData="useActionData",n.UseRouteError="useRouteError",n.UseNavigation="useNavigation",n.UseRouteLoaderData="useRouteLoaderData",n.UseMatches="useMatches",n.UseRevalidator="useRevalidator",n.UseNavigateStable="useNavigate",n.UseRouteId="useRouteId",n})(I_||{});function SI(n){let e=$.useContext(Gf);return e||dt(!1),e}function AI(n){let e=$.useContext(fI);return e||dt(!1),e}function CI(n){let e=$.useContext(Zr);return e||dt(!1),e}function S_(n){let e=CI(),t=e.matches[e.matches.length-1];return t.route.id||dt(!1),t.route.id}function kI(){var n;let e=$.useContext(__),t=AI(),i=S_();return e!==void 0?e:(n=t.errors)==null?void 0:n[i]}function RI(){let{router:n}=SI(T_.UseNavigateStable),e=S_(I_.UseNavigateStable),t=$.useRef(!1);return w_(()=>{t.current=!0}),$.useCallback(function(o,l){l===void 0&&(l={}),t.current&&(typeof o=="number"?n.navigate(o):n.navigate(o,fl({fromRouteId:e},l)))},[n,e])}const vy={};function PI(n,e,t){vy[n]||(vy[n]=!0)}function xI(n,e){n==null||n.v7_startTransition,n==null||n.v7_relativeSplatPath}function yc(n){let{to:e,replace:t,state:i,relative:o}=n;Go()||dt(!1);let{future:l,static:c}=$.useContext(qi),{matches:f}=$.useContext(Zr),{pathname:p}=Qo(),y=Yo(),w=Kf(e,Hf(f,l.v7_relativeSplatPath),p,o==="path"),T=JSON.stringify(w);return $.useEffect(()=>y(JSON.parse(T),{replace:t,state:i,relative:o}),[y,T,o,t,i]),null}function xn(n){dt(!1)}function NI(n){let{basename:e="/",children:t=null,location:i,navigationType:o=xi.Pop,navigator:l,static:c=!1,future:f}=n;Go()&&dt(!1);let p=e.replace(/^\/*/,"/"),y=$.useMemo(()=>({basename:p,navigator:l,static:c,future:fl({v7_relativeSplatPath:!1},f)}),[p,f,l,c]);typeof i=="string"&&(i=Ko(i));let{pathname:w="/",search:T="",hash:S="",state:N=null,key:B="default"}=i,W=$.useMemo(()=>{let M=qf(w,p);return M==null?null:{location:{pathname:M,search:T,hash:S,state:N,key:B},navigationType:o}},[p,w,T,S,N,B,o]);return W==null?null:$.createElement(qi.Provider,{value:y},$.createElement(Bc.Provider,{children:t,value:W}))}function bI(n){let{children:e,location:t}=n;return yI(pf(e),t)}new Promise(()=>{});function pf(n,e){e===void 0&&(e=[]);let t=[];return $.Children.forEach(n,(i,o)=>{if(!$.isValidElement(i))return;let l=[...e,o];if(i.type===$.Fragment){t.push.apply(t,pf(i.props.children,l));return}i.type!==xn&&dt(!1),!i.props.index||!i.props.children||dt(!1);let c={id:i.props.id||l.join("-"),caseSensitive:i.props.caseSensitive,element:i.props.element,Component:i.props.Component,index:i.props.index,path:i.props.path,loader:i.props.loader,action:i.props.action,errorElement:i.props.errorElement,ErrorBoundary:i.props.ErrorBoundary,hasErrorBoundary:i.props.ErrorBoundary!=null||i.props.errorElement!=null,shouldRevalidate:i.props.shouldRevalidate,handle:i.props.handle,lazy:i.props.lazy};i.props.children&&(c.children=pf(i.props.children,l)),t.push(c)}),t}/**
 ...
 *
 * @license MIT
 */function mf(){return mf=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(n[i]=t[i])}return n},mf.apply(this,arguments)}function DI(n,e){if(n==null)return{};var t={},i=Object.keys(n),o,l;for(l=0;l<i.length;l++)o=i[l],!(e.indexOf(o)>=0)&&(t[o]=n[o]);return t}function OI(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function VI(n,e){return n.button===0&&(!e||e==="_self")&&!OI(n)}const LI=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],MI="6";try{window.__reactRouterVersion=MI}catch{}const jI="startTransition",_y=DT[jI];function FI(n){let{basename:e,children:t,future:i,window:o}=n,l=$.useRef();l.current==null&&(l.current=UT({window:o,v5Compat:!0}));let c=l.current,[f,p]=$.useState({action:c.action,location:c.location}),{v7_startTransition:y}=i||{},w=$.useCallback(T=>{y&&_y?_y(()=>p(T)):p(T)},[p,y]);return $.useLayoutEffect(()=>c.listen(w),[c,w]),$.useEffect(()=>xI(i),[i]),$.createElement(NI,{basename:e,children:t,location:f.location,navigationType:f.action,navigator:c,future:i})}const UI=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",BI=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Nn=$.forwardRef(function(e,t){let{onClick:i,relative:o,reloadDocument:l,replace:c,state:f,target:p,to:y,preventScrollReset:w,viewTransition:T}=e,S=DI(e,LI),{basename:N}=$.useContext(qi),B,W=!1;if(typeof y=="string"&&BI.test(y)&&(B=y,UI))try{let X=new URL(window.location.href),ye=y.startsWith("//")?new URL(X.protocol+y):new URL(y),Pe=qf(ye.pathname,N);ye.origin===X.origin&&Pe!=null?y=Pe+ye.search+ye.hash:W=!0}catch{}let M=pI(y,{relative:o}),se=zI(y,{replace:c,state:f,target:p,preventScrollReset:w,relative:o,viewTransition:T});function ne(X){i&&i(X),X.defaultPrevented||se(X)}return $.createElement("a",mf({},S,{href:B||M,onClick:W||l?i:ne,ref:t,target:p}))});var wy;(function(n){n.UseScrollRestoration="useScrollRestoration",n.UseSubmit="useSubmit",n.UseSubmitFetcher="useSubmitFetcher",n.UseFetcher="useFetcher",n.useViewTransitionState="useViewTransitionState"})(wy||(wy={}));var Ey;(function(n){n.UseFetcher="useFetcher",n.UseFetchers="useFetchers",n.UseScrollRestoration="useScrollRestoration"})(Ey||(Ey={}));function zI(n,e){let{target:t,replace:i,state:o,preventScrollReset:l,relative:c,viewTransition:f}=e===void 0?{}:e,p=Yo(),y=Qo(),w=E_(n,{relative:c});return $.useCallback(T=>{if(VI(T,t)){T.preventDefault();let S=i!==void 0?i:gc(y)===gc(w);p(n,{replace:S,state:o,preventScrollReset:l,relative:c,viewTransition:f})}},[y,p,w,i,o,t,n,l,c,f])}const $I=()=>{};var Ty={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jC(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function FC(n){Er(new Jn("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:c,authDomain:f}=i.options;Ie(c&&!c.includes(":"),"invalid-api-key",{appName:i.name});const p={apiKey:c,authDomain:f,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:nw(n)},y=new Y1(i,o,l,p);return oA(y,t),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),Er(new Jn("auth-internal",e=>{const t=Hi(e.getProvider("auth").getImmediate());return(i=>new MC(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Dn(Qy,Yy,jC(n)),Dn(Qy,Yy,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Iw,nl,Sw,cc,Sf,Aw,Cw,kw;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(u,m,v){return u==Array.prototype||u==Object.prototype||(u[m]=v.value),u};function t(u){u=[typeof globalThis=="object"&&globalThis,u,typeof window=="object"&&window,typeof self=="object"&&self,typeof ec=="object"&&ec];for(var m=0;m<u.length;++m){var v=u[m];if(v&&v.Math==Math)return v}throw Error("Cannot find global object")}var i=t(this);function o(u,m){if(m)e:{var v=i;u=u.split(".");for(var I=0;I<u.length-1;I++){var j=u[I];if(!(j in v))break e;v=v[j]}u=u[u.length-1],I=v[u],m=m(I),m!=I&&m!=null&&e(v,u,{configurable:!0,writable:!0,value:m})}}function l(u,m){u instanceof String&&(u+="");var v=0,I=!1,j={next:function(){if(!I&&v<u.length){var q=v++;return{value:m(q,u[q]),done:!1}}return I=!0,{done:!0,value:void 0}}};return j[Symbol.iterator]=function(){return j},j}o("Array.prototype.values",function(u){return u||function(){return l(this,function(m,v){return v})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var c=c||{},f=this||self;function p(u){var m=typeof u;return m=m!="object"?m:u?Array.isArray(u)?"array":m:"null",m=="array"||m=="object"&&typeof u.length=="number"}function y(u){var m=typeof u;return m=="object"&&u!=null||m=="function"}function w(u,m,v){return u.call.apply(u.bind,arguments)}function T(u,m,v){if(!u)throw Error();if(2<arguments.length){var I=Array.prototype.slice.call(arguments,2);return function(){var j=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(j,I),u.apply(m,j)}}return function(){return u.apply(m,arguments)}}function S(u,m,v){return S=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?w:T,S.apply(null,arguments)}function N(u,m){var v=Array.prototype.slice.call(arguments,1);return function(){var I=v.slice();return I.push.apply(I,arguments),u.apply(this,I)}}function B(u,m){function v(){}v.prototype=m.prototype,u.aa=m.prototype,u.prototype=new v,u.prototype.constructor=u,u.Qb=function(I,j,q){for(var oe=Array(arguments.length-2),ze=2;ze<arguments.length;ze++)oe[ze-2]=arguments[ze];return m.prototype[j].apply(I,oe)}}function W(u){const m=u.length;if(0<m){const v=Array(m);for(let I=0;I<m;I++)v[I]=u[I];return v}return[]}function M(u,m){for(let v=1;v<arguments.length;v++){const I=arguments[v];if(p(I)){const j=u.length||0,q=I.length||0;u.length=j+q;for(let oe=0;oe<q;oe++)u[j+oe]=I[oe]}else u.push(I)}}class se{constructor(m,v){this.i=m,this.j=v,this.h=0,this.g=null}get(){let m;return 0<this.h?(this.h--,m=this.g,this.g=m.next,m.next=null):m=this.i(),m}}function ne(u){return/^[\s\xa0]*$/.test(u)}function X(){var u=f.navigator;return u&&(u=u.userAgent)?u:""}function ye(u){return ye[" "](u),u}ye[" "]=function(){};var Pe=X().indexOf("Gecko")!=-1&&!(X().toLowerCase().indexOf("webkit")!=-1&&X().indexOf("Edge")==-1)&&!(X().indexOf("Trident")!=-1||X().indexOf("MSIE")!=-1)&&X().indexOf("Edge")==-1;function ke(u,m,v){for(const I in u)m.call(v,u[I],I,u)}function b(u,m){for(const v in u)m.call(void 0,u[v],v,u)}function A(u){const m={};for(const v in u)m[v]=u[v];return m}const k="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function x(u,m){let v,I;for(let j=1;j<arguments.length;j++){I=arguments[j];for(v in I)u[v]=I[v];for(let q=0;q<k.length;q++)v=k[q],Object.prototype.hasOwnProperty.call(I,v)&&(u[v]=I[v])}}function O(u){var m=1;u=u.split(":");const v=[];for(;0<m&&u.length;)v.push(u.shift()),m--;return u.length&&v.push(u.join(":")),v}function V(u){f.setTimeout(()=>{throw u},0)}function R(){var u=me;let m=null;return u.g&&(m=u.g,u.g=u.g.next,u.g||(u.h=null),m.next=null),m}class Ge{constructor(){this.h=this.g=null}add(m,v){const I=ht.get();I.set(m,v),this.h?this.h.next=I:this.g=I,this.h=I}}var ht=new se(()=>new it,u=>u.reset());class it{constructor(){this.next=this.g=this.h=null}set(m,v){this.h=m,this.g=v,this.next=null}reset(){this.next=this.g=this.h=null}}let je,ie=!1,me=new Ge,ae=()=>{const u=f.Promise.resolve(void 0);je=()=>{u.then(L)}};var L=()=>{for(var u;u=R();){try{u.h.call(u.g)}catch(v){V(v)}var m=ht;m.j(u),100>m.h&&(m.h++,u.next=m.g,m.g=u)}ie=!1};function K(){this.s=this.s,this.C=this.C}K.prototype.s=!1,K.prototype.ma=function(){this.s||(this.s=!0,this.N())},K.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function H(u,m){this.type=u,this.g=this.target=m,this.defaultPrevented=!1}H.prototype.h=function(){this.defaultPrevented=!0};var G=(function(){if(!f.addEventListener||!Object.defineProperty)return!1;var u=!1,m=Object.defineProperty({},"passive",{get:function(){u=!0}});try{const v=()=>{};f.addEventListener("test",v,m),f.removeEventListener("test",v,m)}catch{}return u})();function Y(u,m){if(H.call(this,u?u.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,u){var v=this.type=u.type,I=u.changedTouches&&u.changedTouches.length?u.changedTouches[0]:null;if(this.target=u.target||u.srcElement,this.g=m,m=u.relatedTarget){if(Pe){e:{try{ye(m.nodeName);var j=!0;break e}catch{}j=!1}j||(m=null)}}else v=="mouseover"?m=u.fromElement:v=="mouseout"&&(m=u.toElement);this.relatedTarget=m,I?(this.clientX=I.clientX!==void 0?I.clientX:I.pageX,this.clientY=I.clientY!==void 0?I.clientY:I.pageY,this.screenX=I.screenX||0,this.screenY=I.screenY||0):(this.clientX=u.clientX!==void 0?u.clientX:u.pageX,this.clientY=u.clientY!==void 0?u.clientY:u.pageY,this.screenX=u.screenX||0,this.screenY=u.screenY||0),this.button=u.button,this.key=u.key||"",this.ctrlKey=u.ctrlKey,this.altKey=u.altKey,this.shiftKey=u.shiftKey,this.metaKey=u.metaKey,this.pointerId=u.pointerId||0,this.pointerType=typeof u.pointerType=="string"?u.pointerType:le[u.pointerType]||"",this.state=u.state,this.i=u,u.defaultPrevented&&Y.aa.h.call(this)}}B(Y,H);var le={2:"touch",3:"pen",4:"mouse"};Y.prototype.h=function(){Y.aa.h.call(this);var u=this.i;u.preventDefault?u.preventDefault():u.returnValue=!1};var Te="closure_listenable_"+(1e6*Math.random()|0),_e=0;function be(u,m,v,I,j){this.listener=u,this.proxy=null,this.src=m,this.type=v,this.capture=!!I,this.ha=j,this.key=++_e,this.da=this.fa=!1}function st(u){u.da=!0,u.listener=null,u.proxy=null,u.src=null,u.ha=null}function vn(u){this.src=u,this.g={},this.h=0}vn.prototype.add=function(u,m,v,I,j){var q=u.toString();u=this.g[q],u||(u=this.g[q]=[],this.h++);var oe=_n(u,m,I,j);return-1<oe?(m=u[oe],v||(m.fa=!1)):(m=new be(m,this.src,q,!!I,j),m.fa=v,u.push(m)),m};function er(u,m){var v=m.type;if(v in u.g){var I=u.g[v],j=Array.prototype.indexOf.call(I,m,void 0),q;(q=0<=j)&&Array.prototype.splice.call(I,j,1),q&&(st(m),u.g[v].length==0&&(delete u.g[v],u.h--))}}function _n(u,m,v,I){for(var j=0;j<u.length;++j){var q=u[j];if(!q.da&&q.listener==m&&q.capture==!!v&&q.ha==I)return j}return-1}var Pt="closure_lm_"+(1e6*Math.random()|0),Fs={};function sa(u,m,v,I,j){if(Array.isArray(m)){for(var q=0;q<m.length;q++)sa(u,m[q],v,I,j);return null}return v=la(v),u&&u[Te]?u.K(m,v,y(I)?!!I.capture:!1,j):oa(u,m,v,!1,I,j)}function oa(u,m,v,I,j,q){if(!m)throw Error("Invalid event type");var oe=y(j)?!!j.capture:!!j,ze=Bs(u);if(ze||(u[Pt]=ze=new vn(u)),v=ze.add(m,v,I,oe,q),v.proxy)return v;if(I=Ml(),v.proxy=I,I.src=u,I.listener=v,u.addEventListener)G||(j=oe),j===void 0&&(j=!1),u.addEventListener(m.toString(),I,j);else if(u.attachEvent)u.attachEvent(kr(m.toString()),I);else if(u.addListener&&u.removeListener)u.addListener(I);else throw Error("addEventListener and attachEvent are unavailable.");return v}function Ml(){function u(v){return m.call(u.src,u.listener,v)}const m=aa;return u}function Us(u,m,v,I,j){if(Array.isArray(m))for(var q=0;q<m.length;q++)Us(u,m[q],v,I,j);else I=y(I)?!!I.capture:!!I,v=la(v),u&&u[Te]?(u=u.i,m=String(m).toString(),m in u.g&&(q=u.g[m],v=_n(q,v,I,j),-1<v&&(st(q[v]),Array.prototype.splice.call(q,v,1),q.length==0&&(delete u.g[m],u.h--)))):u&&(u=Bs(u))&&(m=u.g[m.toString()],u=-1,m&&(u=_n(m,v,I,j)),(v=-1<u?m[u]:null)&&Cr(v))}function Cr(u){if(typeof u!="number"&&u&&!u.da){var m=u.src;if(m&&m[Te])er(m.i,u);else{var v=u.type,I=u.proxy;m.removeEventListener?m.removeEventListener(v,I,u.capture):m.detachEvent?m.detachEvent(kr(v),I):m.addListener&&m.removeListener&&m.removeListener(I),(v=Bs(m))?(er(v,u),v.h==0&&(v.src=null,m[Pt]=null)):st(u)}}}function kr(u){return u in Fs?Fs[u]:Fs[u]="on"+u}function aa(u,m){if(u.da)u=!0;else{m=new Y(m,this);var v=u.listener,I=u.ha||u.src;u.fa&&Cr(u),u=v.call(I,m)}return u}function Bs(u){return u=u[Pt],u instanceof vn?u:null}var zs="__closure_events_fn_"+(1e9*Math.random()>>>0);function la(u){return typeof u=="function"?u:(u[zs]||(u[zs]=function(m){return u.handleEvent(m)}),u[zs])}function vt(){K.call(this),this.i=new vn(this),this.M=this,this.F=null}B(vt,K),vt.prototype[Te]=!0,vt.prototype.removeEventListener=function(u,m,v,I){Us(this,u,m,v,I)};function _t(u,m){var v,I=u.F;if(I)for(v=[];I;I=I.F)v.push(I);if(u=u.M,I=m.type||m,typeof m=="string")m=new H(m,u);else if(m instanceof H)m.target=m.target||u;else{var j=m;m=new H(I,u),x(m,j)}if(j=!0,v)for(var q=v.length-1;0<=q;q--){var oe=m.g=v[q];j=Rr(oe,I,!0,m)&&j}if(oe=m.g=u,j=Rr(oe,I,!0,m)&&j,j=Rr(oe,I,!1,m)&&j,v)for(q=0;q<v.length;q++)oe=m.g=v[q],j=Rr(oe,I,!1,m)&&j}vt.prototype.N=function(){if(vt.aa.N.call(this),this.i){var u=this.i,m;for(m in u.g){for(var v=u.g[m],I=0;I<v.length;I++)st(v[I]);delete u.g[m],u.h--}}this.F=null},vt.prototype.K=function(u,m,v,I){return this.i.add(String(u),m,!1,v,I)},vt.prototype.L=function(u,m,v,I){return this.i.add(String(u),m,!0,v,I)};function Rr(u,m,v,I){if(m=u.i.g[String(m)],!m)return!0;m=m.concat();for(var j=!0,q=0;q<m.length;++q){var oe=m[q];if(oe&&!oe.da&&oe.capture==v){var ze=oe.listener,wt=oe.ha||oe.src;oe.fa&&er(u.i,oe),j=ze.call(wt,I)!==!1&&j}}return j&&!I.defaultPrevented}function ua(u,m,v){if(typeof u=="function")v&&(u=S(u,v));else if(u&&typeof u.handleEvent=="function")u=S(u.handleEvent,u);else throw Error("Invalid listener argument");return 2147483647<Number(m)?-1:f.setTimeout(u,m||0)}function ti(u){u.g=ua(()=>{u.g=null,u.i&&(u.i=!1,ti(u))},u.l);const m=u.h;u.h=null,u.m.apply(null,m)}class Yi extends K{constructor(m,v){super(),this.m=m,this.l=v,this.h=null,this.i=!1,this.g=null}j(m){this.h=arguments,this.g?this.i=!0:ti(this)}N(){super.N(),this.g&&(f.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ji(u){K.call(this),this.h=u,this.g={}}B(Ji,K);var ca=[];function da(u){ke(u.g,function(m,v){this.g.hasOwnProperty(v)&&Cr(m)},u),u.g={}}Ji.prototype.N=function(){Ji.aa.N.call(this),da(this)},Ji.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ha=f.JSON.stringify,fa=f.JSON.parse,pa=class{stringify(u){return f.JSON.stringify(u,void 0)}parse(u){return f.JSON.parse(u,void 0)}};function Xi(){}Xi.prototype.h=null;function $s(u){return u.h||(u.h=u.i())}function Ws(){}var wn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function tr(){H.call(this,"d")}B(tr,H);function qs(){H.call(this,"c")}B(qs,H);var nr={},ma=null;function Zi(){return ma=ma||new vt}nr.La="serverreachability";function ga(u){H.call(this,nr.La,u)}B(ga,H);function Pr(u){const m=Zi();_t(m,new ga(m))}nr.STAT_EVENT="statevent";function ya(u,m){H.call(this,nr.STAT_EVENT,u),this.stat=m}B(ya,H);function lt(u){const m=Zi();_t(m,new ya(m,u))}nr.Ma="timingevent";function Hs(u,m){H.call(this,nr.Ma,u),this.size=m}B(Hs,H);function Vn(u,m){if(typeof u!="function")throw Error("Fn must not be null and must be a function");return f.setTimeout(function(){u()},m)}function es(){this.g=!0}es.prototype.xa=function(){this.g=!1};function ts(u,m,v,I,j,q){u.info(function(){if(u.g)if(q)for(var oe="",ze=q.split("&"),wt=0;wt<ze.length;wt++){var Le=ze[wt].split("=");if(1<Le.length){var St=Le[0];Le=Le[1];var ft=St.split("_");oe=2<=ft.length&&ft[1]=="type"?oe+(St+"="+Le+"&"):oe+(St+"=redacted&")}}else oe=null;else oe=q;return"XMLHTTP REQ ("+I+") [attempt "+j+"]: "+m+`
`+v+`
`+oe})}function Ks(u,m,v,I,j,q,oe){u.info(function(){return"XMLHTTP RESP ("+I+") [ attempt "+j+"]: "+m+`
`+v+`
`+q+" "+oe})}function Ln(u,m,v,I){u.info(function(){return"XMLHTTP TEXT ("+m+"): "+yd(u,v)+(I?" "+I:"")})}function va(u,m){u.info(function(){return"TIMEOUT: "+m})}es.prototype.info=function(){};function yd(u,m){if(!u.g)return m;if(!m)return null;try{var v=JSON.parse(m);if(v){for(u=0;u<v.length;u++)if(Array.isArray(v[u])){var I=v[u];if(!(2>I.length)){var j=I[1];if(Array.isArray(j)&&!(1>j.length)){var q=j[0];if(q!="noop"&&q!="stop"&&q!="close")for(var oe=1;oe<j.length;oe++)j[oe]=""}}}}return ha(v)}catch{return m}}var Gs={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},jl={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Mn;function ns(){}B(ns,Xi),ns.prototype.g=function(){return new XMLHttpRequest},ns.prototype.i=function(){return{}},Mn=new ns;function jn(u,m,v,I){this.j=u,this.i=m,this.l=v,this.R=I||1,this.U=new Ji(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Fl}function Fl(){this.i=null,this.g="",this.h=!1}var _a={},Qs={};function Ys(u,m,v){u.L=1,u.v=oi(cn(m)),u.m=v,u.P=!0,wa(u,null)}function wa(u,m){u.F=Date.now(),qe(u),u.A=cn(u.v);var v=u.A,I=u.R;Array.isArray(I)||(I=[String(I)]),li(v.i,"t",I),u.C=0,v=u.j.J,u.h=new Fl,u.g=ru(u.j,v?m:null,!u.m),0<u.O&&(u.M=new Yi(S(u.Y,u,u.g),u.O)),m=u.U,v=u.g,I=u.ca;var j="readystatechange";Array.isArray(j)||(j&&(ca[0]=j.toString()),j=ca);for(var q=0;q<j.length;q++){var oe=sa(v,j[q],I||m.handleEvent,!1,m.h||m);if(!oe)break;m.g[oe.key]=oe}m=u.H?A(u.H):{},u.m?(u.u||(u.u="POST"),m["Content-Type"]="application/x-www-form-urlencoded",u.g.ea(u.A,u.u,u.m,m)):(u.u="GET",u.g.ea(u.A,u.u,null,m)),Pr(),ts(u.i,u.u,u.A,u.l,u.R,u.m)}jn.prototype.ca=function(u){u=u.target;const m=this.M;m&&Xt(u)==3?m.j():this.Y(u)},jn.prototype.Y=function(u){try{if(u==this.g)e:{const ft=Xt(this.g);var m=this.g.Ba();const In=this.g.Z();if(!(3>ft)&&(ft!=3||this.g&&(this.h.h||this.g.oa()||Ca(this.g)))){this.J||ft!=4||m==7||(m==8||0>=In?Pr(3):Pr(2)),rs(this);var v=this.g.Z();this.X=v;t:if(Ul(this)){var I=Ca(this.g);u="";var j=I.length,q=Xt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){En(this),ni(this);var oe="";break t}this.h.i=new f.TextDecoder}for(m=0;m<j;m++)this.h.h=!0,u+=this.h.i.decode(I[m],{stream:!(q&&m==j-1)});I.length=0,this.h.g+=u,this.C=0,oe=this.h.g}else oe=this.g.oa();if(this.o=v==200,Ks(this.i,this.u,this.A,this.l,this.R,ft,v),this.o){if(this.T&&!this.K){t:{if(this.g){var ze,wt=this.g;if((ze=wt.g?wt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!ne(ze)){var Le=ze;break t}}Le=null}if(v=Le)Ln(this.i,this.l,v,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ea(this,v);else{this.o=!1,this.s=3,lt(12),En(this),ni(this);break e}}if(this.P){v=!0;let hn;for(;!this.J&&this.C<oe.length;)if(hn=vd(this,oe),hn==Qs){ft==4&&(this.s=4,lt(14),v=!1),Ln(this.i,this.l,null,"[Incomplete Response]");break}else if(hn==_a){this.s=4,lt(15),Ln(this.i,this.l,oe,"[Invalid Chunk]"),v=!1;break}else Ln(this.i,this.l,hn,null),Ea(this,hn);if(Ul(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ft!=4||oe.length!=0||this.h.h||(this.s=1,lt(16),v=!1),this.o=this.o&&v,!v)Ln(this.i,this.l,oe,"[Invalid Chunked Response]"),En(this),ni(this);else if(0<oe.length&&!this.W){this.W=!0;var St=this.j;St.g==this&&St.ba&&!St.M&&(St.j.info("Great, no buffering proxy detected. Bytes received: "+oe.length),Ra(St),St.M=!0,lt(11))}}else Ln(this.i,this.l,oe,null),Ea(this,oe);ft==4&&En(this),this.o&&!this.J&&(ft==4?ao(this.j,this):(this.o=!1,qe(this)))}else no(this.g),v==400&&0<oe.indexOf("Unknown SID")?(this.s=3,lt(12)):(this.s=0,lt(13)),En(this),ni(this)}}}catch{}finally{}};function Ul(u){return u.g?u.u=="GET"&&u.L!=2&&u.j.Ca:!1}function vd(u,m){var v=u.C,I=m.indexOf(`
`,v);return I==-1?Qs:(v=Number(m.substring(v,I)),isNaN(v)?_a:(I+=1,I+v>m.length?Qs:(m=m.slice(I,I+v),u.C=I+v,m)))}jn.prototype.cancel=function(){this.J=!0,En(this)};function qe(u){u.S=Date.now()+u.I,Bl(u,u.I)}function Bl(u,m){if(u.B!=null)throw Error("WatchDog timer not null");u.B=Vn(S(u.ba,u),m)}function rs(u){u.B&&(f.clearTimeout(u.B),u.B=null)}jn.prototype.ba=function(){this.B=null;const u=Date.now();0<=u-this.S?(va(this.i,this.A),this.L!=2&&(Pr(),lt(17)),En(this),this.s=2,ni(this)):Bl(this,this.S-u)};function ni(u){u.j.G==0||u.J||ao(u.j,u)}function En(u){rs(u);var m=u.M;m&&typeof m.ma=="function"&&m.ma(),u.M=null,da(u.U),u.g&&(m=u.g,u.g=null,m.abort(),m.ma())}function Ea(u,m){try{var v=u.j;if(v.G!=0&&(v.g==u||Ht(v.h,u))){if(!u.K&&Ht(v.h,u)&&v.G==3){try{var I=v.Da.g.parse(m)}catch{I=null}if(Array.isArray(I)&&I.length==3){var j=I;if(j[0]==0){e:if(!v.u){if(v.g)if(v.g.F+3e3<u.F)oo(v),$n(v);else break e;so(v),lt(18)}}else v.za=j[1],0<v.za-v.T&&37500>j[2]&&v.F&&v.v==0&&!v.C&&(v.C=Vn(S(v.Za,v),6e3));if(1>=$l(v.h)&&v.ca){try{v.ca()}catch{}v.ca=void 0}}else Or(v,11)}else if((u.K||v.g==u)&&oo(v),!ne(m))for(j=v.Da.g.parse(m),m=0;m<j.length;m++){let Le=j[m];if(v.T=Le[0],Le=Le[1],v.G==2)if(Le[0]=="c"){v.K=Le[1],v.ia=Le[2];const St=Le[3];St!=null&&(v.la=St,v.j.info("VER="+v.la));const ft=Le[4];ft!=null&&(v.Aa=ft,v.j.info("SVER="+v.Aa));const In=Le[5];In!=null&&typeof In=="number"&&0<In&&(I=1.5*In,v.L=I,v.j.info("backChannelRequestTimeoutMs_="+I)),I=v;const hn=u.g;if(hn){const cs=hn.g?hn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(cs){var q=I.h;q.g||cs.indexOf("spdy")==-1&&cs.indexOf("quic")==-1&&cs.indexOf("h2")==-1||(q.j=q.l,q.g=new Set,q.h&&(Ta(q,q.h),q.h=null))}if(I.D){const uo=hn.g?hn.g.getResponseHeader("X-HTTP-Session-Id"):null;uo&&(I.ya=uo,We(I.I,I.D,uo))}}v.G=3,v.l&&v.l.ua(),v.ba&&(v.R=Date.now()-u.F,v.j.info("Handshake RTT: "+v.R+"ms")),I=v;var oe=u;if(I.qa=nu(I,I.J?I.ia:null,I.W),oe.K){Wl(I.h,oe);var ze=oe,wt=I.L;wt&&(ze.I=wt),ze.B&&(rs(ze),qe(ze)),I.g=oe}else us(I);0<v.i.length&&or(v)}else Le[0]!="stop"&&Le[0]!="close"||Or(v,7);else v.G==3&&(Le[0]=="stop"||Le[0]=="close"?Le[0]=="stop"?Or(v,7):Nt(v):Le[0]!="noop"&&v.l&&v.l.ta(Le),v.v=0)}}Pr(4)}catch{}}var zl=class{constructor(u,m){this.g=u,this.map=m}};function is(u){this.l=u||10,f.PerformanceNavigationTiming?(u=f.performance.getEntriesByType("navigation"),u=0<u.length&&(u[0].nextHopProtocol=="hq"||u[0].nextHopProtocol=="h2")):u=!!(f.chrome&&f.chrome.loadTimes&&f.chrome.loadTimes()&&f.chrome.loadTimes().wasFetchedViaSpdy),this.j=u?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function un(u){return u.h?!0:u.g?u.g.size>=u.j:!1}function $l(u){return u.h?1:u.g?u.g.size:0}function Ht(u,m){return u.h?u.h==m:u.g?u.g.has(m):!1}function Ta(u,m){u.g?u.g.add(m):u.h=m}function Wl(u,m){u.h&&u.h==m?u.h=null:u.g&&u.g.has(m)&&u.g.delete(m)}is.prototype.cancel=function(){if(this.i=ql(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const u of this.g.values())u.cancel();this.g.clear()}};function ql(u){if(u.h!=null)return u.i.concat(u.h.D);if(u.g!=null&&u.g.size!==0){let m=u.i;for(const v of u.g.values())m=m.concat(v.D);return m}return W(u.i)}function Js(u){if(u.V&&typeof u.V=="function")return u.V();if(typeof Map<"u"&&u instanceof Map||typeof Set<"u"&&u instanceof Set)return Array.from(u.values());if(typeof u=="string")return u.split("");if(p(u)){for(var m=[],v=u.length,I=0;I<v;I++)m.push(u[I]);return m}m=[],v=0;for(I in u)m[v++]=u[I];return m}function Xs(u){if(u.na&&typeof u.na=="function")return u.na();if(!u.V||typeof u.V!="function"){if(typeof Map<"u"&&u instanceof Map)return Array.from(u.keys());if(!(typeof Set<"u"&&u instanceof Set)){if(p(u)||typeof u=="string"){var m=[];u=u.length;for(var v=0;v<u;v++)m.push(v);return m}m=[],v=0;for(const I in u)m[v++]=I;return m}}}function ri(u,m){if(u.forEach&&typeof u.forEach=="function")u.forEach(m,void 0);else if(p(u)||typeof u=="string")Array.prototype.forEach.call(u,m,void 0);else for(var v=Xs(u),I=Js(u),j=I.length,q=0;q<j;q++)m.call(void 0,I[q],v&&v[q],u)}var ss=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function _d(u,m){if(u){u=u.split("&");for(var v=0;v<u.length;v++){var I=u[v].indexOf("="),j=null;if(0<=I){var q=u[v].substring(0,I);j=u[v].substring(I+1)}else q=u[v];m(q,j?decodeURIComponent(j.replace(/\+/g," ")):"")}}}function xr(u){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,u instanceof xr){this.h=u.h,os(this,u.j),this.o=u.o,this.g=u.g,ii(this,u.s),this.l=u.l;var m=u.i,v=new rr;v.i=m.i,m.g&&(v.g=new Map(m.g),v.h=m.h),si(this,v),this.m=u.m}else u&&(m=String(u).match(ss))?(this.h=!1,os(this,m[1]||"",!0),this.o=Ve(m[2]||""),this.g=Ve(m[3]||"",!0),ii(this,m[4]),this.l=Ve(m[5]||"",!0),si(this,m[6]||"",!0),this.m=Ve(m[7]||"")):(this.h=!1,this.i=new rr(null,this.h))}xr.prototype.toString=function(){var u=[],m=this.j;m&&u.push(ai(m,Zs,!0),":");var v=this.g;return(v||m=="file")&&(u.push("//"),(m=this.o)&&u.push(ai(m,Zs,!0),"@"),u.push(encodeURIComponent(String(v)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),v=this.s,v!=null&&u.push(":",String(v))),(v=this.l)&&(this.g&&v.charAt(0)!="/"&&u.push("/"),u.push(ai(v,v.charAt(0)=="/"?Gl:Kl,!0))),(v=this.i.toString())&&u.push("?",v),(v=this.m)&&u.push("#",ai(v,Ia)),u.join("")};function cn(u){return new xr(u)}function os(u,m,v){u.j=v?Ve(m,!0):m,u.j&&(u.j=u.j.replace(/:$/,""))}function ii(u,m){if(m){if(m=Number(m),isNaN(m)||0>m)throw Error("Bad port number "+m);u.s=m}else u.s=null}function si(u,m,v){m instanceof rr?(u.i=m,ir(u.i,u.h)):(v||(m=ai(m,Ql)),u.i=new rr(m,u.h))}function We(u,m,v){u.i.set(m,v)}function oi(u){return We(u,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),u}function Ve(u,m){return u?m?decodeURI(u.replace(/%25/g,"%2525")):decodeURIComponent(u):""}function ai(u,m,v){return typeof u=="string"?(u=encodeURI(u).replace(m,Hl),v&&(u=u.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u):null}function Hl(u){return u=u.charCodeAt(0),"%"+(u>>4&15).toString(16)+(u&15).toString(16)}var Zs=/[#\/\?@]/g,Kl=/[#\?:]/g,Gl=/[#\?]/g,Ql=/[#\?@]/g,Ia=/#/g;function rr(u,m){this.h=this.g=null,this.i=u||null,this.j=!!m}function xt(u){u.g||(u.g=new Map,u.h=0,u.i&&_d(u.i,function(m,v){u.add(decodeURIComponent(m.replace(/\+/g," ")),v)}))}n=rr.prototype,n.add=function(u,m){xt(this),this.i=null,u=Tn(this,u);var v=this.g.get(u);return v||this.g.set(u,v=[]),v.push(m),this.h+=1,this};function Fn(u,m){xt(u),m=Tn(u,m),u.g.has(m)&&(u.i=null,u.h-=u.g.get(m).length,u.g.delete(m))}function Un(u,m){return xt(u),m=Tn(u,m),u.g.has(m)}n.forEach=function(u,m){xt(this),this.g.forEach(function(v,I){v.forEach(function(j){u.call(m,j,I,this)},this)},this)},n.na=function(){xt(this);const u=Array.from(this.g.values()),m=Array.from(this.g.keys()),v=[];for(let I=0;I<m.length;I++){const j=u[I];for(let q=0;q<j.length;q++)v.push(m[I])}return v},n.V=function(u){xt(this);let m=[];if(typeof u=="string")Un(this,u)&&(m=m.concat(this.g.get(Tn(this,u))));else{u=Array.from(this.g.values());for(let v=0;v<u.length;v++)m=m.concat(u[v])}return m},n.set=function(u,m){return xt(this),this.i=null,u=Tn(this,u),Un(this,u)&&(this.h-=this.g.get(u).length),this.g.set(u,[m]),this.h+=1,this},n.get=function(u,m){return u?(u=this.V(u),0<u.length?String(u[0]):m):m};function li(u,m,v){Fn(u,m),0<v.length&&(u.i=null,u.g.set(Tn(u,m),W(v)),u.h+=v.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const u=[],m=Array.from(this.g.keys());for(var v=0;v<m.length;v++){var I=m[v];const q=encodeURIComponent(String(I)),oe=this.V(I);for(I=0;I<oe.length;I++){var j=q;oe[I]!==""&&(j+="="+encodeURIComponent(String(oe[I]))),u.push(j)}}return this.i=u.join("&")};function Tn(u,m){return m=String(m),u.j&&(m=m.toLowerCase()),m}function ir(u,m){m&&!u.j&&(xt(u),u.i=null,u.g.forEach(function(v,I){var j=I.toLowerCase();I!=j&&(Fn(this,I),li(this,j,v))},u)),u.j=m}function wd(u,m){const v=new es;if(f.Image){const I=new Image;I.onload=N(Jt,v,"TestLoadImage: loaded",!0,m,I),I.onerror=N(Jt,v,"TestLoadImage: error",!1,m,I),I.onabort=N(Jt,v,"TestLoadImage: abort",!1,m,I),I.ontimeout=N(Jt,v,"TestLoadImage: timeout",!1,m,I),f.setTimeout(function(){I.ontimeout&&I.ontimeout()},1e4),I.src=u}else m(!1)}function Yl(u,m){const v=new es,I=new AbortController,j=setTimeout(()=>{I.abort(),Jt(v,"TestPingServer: timeout",!1,m)},1e4);fetch(u,{signal:I.signal}).then(q=>{clearTimeout(j),q.ok?Jt(v,"TestPingServer: ok",!0,m):Jt(v,"TestPingServer: server error",!1,m)}).catch(()=>{clearTimeout(j),Jt(v,"TestPingServer: error",!1,m)})}function Jt(u,m,v,I,j){try{j&&(j.onload=null,j.onerror=null,j.onabort=null,j.ontimeout=null),I(v)}catch{}}function Ed(){this.g=new pa}function Jl(u,m,v){const I=v||"";try{ri(u,function(j,q){let oe=j;y(j)&&(oe=ha(j)),m.push(I+q+"="+encodeURIComponent(oe))})}catch(j){throw m.push(I+"type="+encodeURIComponent("_badmap")),j}}function Nr(u){this.l=u.Ub||null,this.j=u.eb||!1}B(Nr,Xi),Nr.prototype.g=function(){return new as(this.l,this.j)},Nr.prototype.i=(function(u){return function(){return u}})({});function as(u,m){vt.call(this),this.D=u,this.o=m,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}B(as,vt),n=as.prototype,n.open=function(u,m){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=u,this.A=m,this.readyState=1,zn(this)},n.send=function(u){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const m={headers:this.u,method:this.B,credentials:this.m,cache:void 0};u&&(m.body=u),(this.D||f).fetch(new Request(this.A,m)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Bn(this)),this.readyState=0},n.Sa=function(u){if(this.g&&(this.l=u,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=u.headers,this.readyState=2,zn(this)),this.g&&(this.readyState=3,zn(this),this.g)))if(this.responseType==="arraybuffer")u.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof f.ReadableStream<"u"&&"body"in u){if(this.j=u.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Xl(this)}else u.text().then(this.Ra.bind(this),this.ga.bind(this))};function Xl(u){u.j.read().then(u.Pa.bind(u)).catch(u.ga.bind(u))}n.Pa=function(u){if(this.g){if(this.o&&u.value)this.response.push(u.value);else if(!this.o){var m=u.value?u.value:new Uint8Array(0);(m=this.v.decode(m,{stream:!u.done}))&&(this.response=this.responseText+=m)}u.done?Bn(this):zn(this),this.readyState==3&&Xl(this)}},n.Ra=function(u){this.g&&(this.response=this.responseText=u,Bn(this))},n.Qa=function(u){this.g&&(this.response=u,Bn(this))},n.ga=function(){this.g&&Bn(this)};function Bn(u){u.readyState=4,u.l=null,u.j=null,u.v=null,zn(u)}n.setRequestHeader=function(u,m){this.u.append(u,m)},n.getResponseHeader=function(u){return this.h&&this.h.get(u.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const u=[],m=this.h.entries();for(var v=m.next();!v.done;)v=v.value,u.push(v[0]+": "+v[1]),v=m.next();return u.join(`\r
`)};function zn(u){u.onreadystatechange&&u.onreadystatechange.call(u)}Object.defineProperty(as.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(u){this.m=u?"include":"same-origin"}});function br(u){let m="";return ke(u,function(v,I){m+=I,m+=":",m+=v,m+=`\r
`}),m}function ui(u,m,v){e:{for(I in v){var I=!1;break e}I=!0}I||(v=br(v),typeof u=="string"?v!=null&&encodeURIComponent(String(v)):We(u,m,v))}function Xe(u){vt.call(this),this.headers=new Map,this.o=u||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}B(Xe,vt);var Td=/^https?$/i,Sa=["POST","PUT"];n=Xe.prototype,n.Ha=function(u){this.J=u},n.ea=function(u,m,v,I){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+u);m=m?m.toUpperCase():"GET",this.D=u,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Mn.g(),this.v=this.o?$s(this.o):$s(Mn),this.g.onreadystatechange=S(this.Ea,this);try{this.B=!0,this.g.open(m,String(u),!0),this.B=!1}catch(q){ls(this,q);return}if(u=v||"",v=new Map(this.headers),I)if(Object.getPrototypeOf(I)===Object.prototype)for(var j in I)v.set(j,I[j]);else if(typeof I.keys=="function"&&typeof I.get=="function")for(const q of I.keys())v.set(q,I.get(q));else throw Error("Unknown input type for opt_headers: "+String(I));I=Array.from(v.keys()).find(q=>q.toLowerCase()=="content-type"),j=f.FormData&&u instanceof f.FormData,!(0<=Array.prototype.indexOf.call(Sa,m,void 0))||I||j||v.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[q,oe]of v)this.g.setRequestHeader(q,oe);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{to(this),this.u=!0,this.g.send(u),this.u=!1}catch(q){ls(this,q)}};function ls(u,m){u.h=!1,u.g&&(u.j=!0,u.g.abort(),u.j=!1),u.l=m,u.m=5,eo(u),dn(u)}function eo(u){u.A||(u.A=!0,_t(u,"complete"),_t(u,"error"))}n.abort=function(u){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=u||7,_t(this,"complete"),_t(this,"abort"),dn(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),dn(this,!0)),Xe.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Aa(this):this.bb())},n.bb=function(){Aa(this)};function Aa(u){if(u.h&&typeof c<"u"&&(!u.v[1]||Xt(u)!=4||u.Z()!=2)){if(u.u&&Xt(u)==4)ua(u.Ea,0,u);else if(_t(u,"readystatechange"),Xt(u)==4){u.h=!1;try{const oe=u.Z();e:switch(oe){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var m=!0;break e;default:m=!1}var v;if(!(v=m)){var I;if(I=oe===0){var j=String(u.D).match(ss)[1]||null;!j&&f.self&&f.self.location&&(j=f.self.location.protocol.slice(0,-1)),I=!Td.test(j?j.toLowerCase():"")}v=I}if(v)_t(u,"complete"),_t(u,"success");else{u.m=6;try{var q=2<Xt(u)?u.g.statusText:""}catch{q=""}u.l=q+" ["+u.Z()+"]",eo(u)}}finally{dn(u)}}}}function dn(u,m){if(u.g){to(u);const v=u.g,I=u.v[0]?()=>{}:null;u.g=null,u.v=null,m||_t(u,"ready");try{v.onreadystatechange=I}catch{}}}function to(u){u.I&&(f.clearTimeout(u.I),u.I=null)}n.isActive=function(){return!!this.g};function Xt(u){return u.g?u.g.readyState:0}n.Z=function(){try{return 2<Xt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(u){if(this.g){var m=this.g.responseText;return u&&m.indexOf(u)==0&&(m=m.substring(u.length)),fa(m)}};function Ca(u){try{if(!u.g)return null;if("response"in u.g)return u.g.response;switch(u.H){case"":case"text":return u.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in u.g)return u.g.mozResponseArrayBuffer}return null}catch{return null}}function no(u){const m={};u=(u.g&&2<=Xt(u)&&u.g.getAllResponseHeaders()||"").split(`\r
`);for(let I=0;I<u.length;I++){if(ne(u[I]))continue;var v=O(u[I]);const j=v[0];if(v=v[1],typeof v!="string")continue;v=v.trim();const q=m[j]||[];m[j]=q,q.push(v)}b(m,function(I){return I.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function sr(u,m,v){return v&&v.internalChannelParams&&v.internalChannelParams[u]||m}function ka(u){this.Aa=0,this.i=[],this.j=new es,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=sr("failFast",!1,u),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=sr("baseRetryDelayMs",5e3,u),this.cb=sr("retryDelaySeedMs",1e4,u),this.Wa=sr("forwardChannelMaxRetries",2,u),this.wa=sr("forwardChannelRequestTimeoutMs",2e4,u),this.pa=u&&u.xmlHttpFactory||void 0,this.Xa=u&&u.Tb||void 0,this.Ca=u&&u.useFetchStreams||!1,this.L=void 0,this.J=u&&u.supportsCrossDomainXhr||!1,this.K="",this.h=new is(u&&u.concurrentRequestLimit),this.Da=new Ed,this.P=u&&u.fastHandshake||!1,this.O=u&&u.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=u&&u.Rb||!1,u&&u.xa&&this.j.xa(),u&&u.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&u&&u.detectBufferingProxy||!1,this.ja=void 0,u&&u.longPollingTimeout&&0<u.longPollingTimeout&&(this.ja=u.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=ka.prototype,n.la=8,n.G=1,n.connect=function(u,m,v,I){lt(0),this.W=u,this.H=m||{},v&&I!==void 0&&(this.H.OSID=v,this.H.OAID=I),this.F=this.X,this.I=nu(this,null,this.W),or(this)};function Nt(u){if(ro(u),u.G==3){var m=u.U++,v=cn(u.I);if(We(v,"SID",u.K),We(v,"RID",m),We(v,"TYPE","terminate"),Dr(u,v),m=new jn(u,u.j,m),m.L=2,m.v=oi(cn(v)),v=!1,f.navigator&&f.navigator.sendBeacon)try{v=f.navigator.sendBeacon(m.v.toString(),"")}catch{}!v&&f.Image&&(new Image().src=m.v,v=!0),v||(m.g=ru(m.j,null),m.g.ea(m.v)),m.F=Date.now(),qe(m)}tu(u)}function $n(u){u.g&&(Ra(u),u.g.cancel(),u.g=null)}function ro(u){$n(u),u.u&&(f.clearTimeout(u.u),u.u=null),oo(u),u.h.cancel(),u.s&&(typeof u.s=="number"&&f.clearTimeout(u.s),u.s=null)}function or(u){if(!un(u.h)&&!u.s){u.s=!0;var m=u.Ga;je||ae(),ie||(je(),ie=!0),me.add(m,u),u.B=0}}function Id(u,m){return $l(u.h)>=u.h.j-(u.s?1:0)?!1:u.s?(u.i=m.D.concat(u.i),!0):u.G==1||u.G==2||u.B>=(u.Va?0:u.Wa)?!1:(u.s=Vn(S(u.Ga,u,m),eu(u,u.B)),u.B++,!0)}n.Ga=function(u){if(this.s)if(this.s=null,this.G==1){if(!u){this.U=Math.floor(1e5*Math.random()),u=this.U++;const j=new jn(this,this.j,u);let q=this.o;if(this.S&&(q?(q=A(q),x(q,this.S)):q=this.S),this.m!==null||this.O||(j.H=q,q=null),this.P)e:{for(var m=0,v=0;v<this.i.length;v++){t:{var I=this.i[v];if("__data__"in I.map&&(I=I.map.__data__,typeof I=="string")){I=I.length;break t}I=void 0}if(I===void 0)break;if(m+=I,4096<m){m=v;break e}if(m===4096||v===this.i.length-1){m=v+1;break e}}m=1e3}else m=1e3;m=ci(this,j,m),v=cn(this.I),We(v,"RID",u),We(v,"CVER",22),this.D&&We(v,"X-HTTP-Session-Id",this.D),Dr(this,v),q&&(this.O?m="headers="+encodeURIComponent(String(br(q)))+"&"+m:this.m&&ui(v,this.m,q)),Ta(this.h,j),this.Ua&&We(v,"TYPE","init"),this.P?(We(v,"$req",m),We(v,"SID","null"),j.T=!0,Ys(j,v,null)):Ys(j,v,m),this.G=2}}else this.G==3&&(u?io(this,u):this.i.length==0||un(this.h)||io(this))};function io(u,m){var v;m?v=m.l:v=u.U++;const I=cn(u.I);We(I,"SID",u.K),We(I,"RID",v),We(I,"AID",u.T),Dr(u,I),u.m&&u.o&&ui(I,u.m,u.o),v=new jn(u,u.j,v,u.B+1),u.m===null&&(v.H=u.o),m&&(u.i=m.D.concat(u.i)),m=ci(u,v,1e3),v.I=Math.round(.5*u.wa)+Math.round(.5*u.wa*Math.random()),Ta(u.h,v),Ys(v,I,m)}function Dr(u,m){u.H&&ke(u.H,function(v,I){We(m,I,v)}),u.l&&ri({},function(v,I){We(m,I,v)})}function ci(u,m,v){v=Math.min(u.i.length,v);var I=u.l?S(u.l.Na,u.l,u):null;e:{var j=u.i;let q=-1;for(;;){const oe=["count="+v];q==-1?0<v?(q=j[0].g,oe.push("ofs="+q)):q=0:oe.push("ofs="+q);let ze=!0;for(let wt=0;wt<v;wt++){let Le=j[wt].g;const St=j[wt].map;if(Le-=q,0>Le)q=Math.max(0,j[wt].g-100),ze=!1;else try{Jl(St,oe,"req"+Le+"_")}catch{I&&I(St)}}if(ze){I=oe.join("&");break e}}}return u=u.i.splice(0,v),m.D=u,I}function us(u){if(!u.g&&!u.u){u.Y=1;var m=u.Fa;je||ae(),ie||(je(),ie=!0),me.add(m,u),u.v=0}}function so(u){return u.g||u.u||3<=u.v?!1:(u.Y++,u.u=Vn(S(u.Fa,u),eu(u,u.v)),u.v++,!0)}n.Fa=function(){if(this.u=null,Zl(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var u=2*this.R;this.j.info("BP detection timer enabled: "+u),this.A=Vn(S(this.ab,this),u)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,lt(10),$n(this),Zl(this))};function Ra(u){u.A!=null&&(f.clearTimeout(u.A),u.A=null)}function Zl(u){u.g=new jn(u,u.j,"rpc",u.Y),u.m===null&&(u.g.H=u.o),u.g.O=0;var m=cn(u.qa);We(m,"RID","rpc"),We(m,"SID",u.K),We(m,"AID",u.T),We(m,"CI",u.F?"0":"1"),!u.F&&u.ja&&We(m,"TO",u.ja),We(m,"TYPE","xmlhttp"),Dr(u,m),u.m&&u.o&&ui(m,u.m,u.o),u.L&&(u.g.I=u.L);var v=u.g;u=u.ia,v.L=1,v.v=oi(cn(m)),v.m=null,v.P=!0,wa(v,u)}n.Za=function(){this.C!=null&&(this.C=null,$n(this),so(this),lt(19))};function oo(u){u.C!=null&&(f.clearTimeout(u.C),u.C=null)}function ao(u,m){var v=null;if(u.g==m){oo(u),Ra(u),u.g=null;var I=2}else if(Ht(u.h,m))v=m.D,Wl(u.h,m),I=1;else return;if(u.G!=0){if(m.o)if(I==1){v=m.m?m.m.length:0,m=Date.now()-m.F;var j=u.B;I=Zi(),_t(I,new Hs(I,v)),or(u)}else us(u);else if(j=m.s,j==3||j==0&&0<m.X||!(I==1&&Id(u,m)||I==2&&so(u)))switch(v&&0<v.length&&(m=u.h,m.i=m.i.concat(v)),j){case 1:Or(u,5);break;case 4:Or(u,10);break;case 3:Or(u,6);break;default:Or(u,2)}}}function eu(u,m){let v=u.Ta+Math.floor(Math.random()*u.cb);return u.isActive()||(v*=2),v*m}function Or(u,m){if(u.j.info("Error code "+m),m==2){var v=S(u.fb,u),I=u.Xa;const j=!I;I=new xr(I||"//www.google.com/images/cleardot.gif"),f.location&&f.location.protocol=="http"||os(I,"https"),oi(I),j?wd(I.toString(),v):Yl(I.toString(),v)}else lt(2);u.G=0,u.l&&u.l.sa(m),tu(u),ro(u)}n.fb=function(u){u?(this.j.info("Successfully pinged google.com"),lt(2)):(this.j.info("Failed to ping google.com"),lt(1))};function tu(u){if(u.G=0,u.ka=[],u.l){const m=ql(u.h);(m.length!=0||u.i.length!=0)&&(M(u.ka,m),M(u.ka,u.i),u.h.i.length=0,W(u.i),u.i.length=0),u.l.ra()}}function nu(u,m,v){var I=v instanceof xr?cn(v):new xr(v);if(I.g!="")m&&(I.g=m+"."+I.g),ii(I,I.s);else{var j=f.location;I=j.protocol,m=m?m+"."+j.hostname:j.hostname,j=+j.port;var q=new xr(null);I&&os(q,I),m&&(q.g=m),j&&ii(q,j),v&&(q.l=v),I=q}return v=u.D,m=u.ya,v&&m&&We(I,v,m),We(I,"VER",u.la),Dr(u,I),I}function ru(u,m,v){if(m&&!u.J)throw Error("Can't create secondary domain capable XhrIo object.");return m=u.Ca&&!u.pa?new Xe(new Nr({eb:v})):new Xe(u.pa),m.Ha(u.J),m}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Pa(){}n=Pa.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function lo(){}lo.prototype.g=function(u,m){return new Kt(u,m)};function Kt(u,m){vt.call(this),this.g=new ka(m),this.l=u,this.h=m&&m.messageUrlParams||null,u=m&&m.messageHeaders||null,m&&m.clientProtocolHeaderRequired&&(u?u["X-Client-Protocol"]="webchannel":u={"X-Client-Protocol":"webchannel"}),this.g.o=u,u=m&&m.initMessageHeaders||null,m&&m.messageContentType&&(u?u["X-WebChannel-Content-Type"]=m.messageContentType:u={"X-WebChannel-Content-Type":m.messageContentType}),m&&m.va&&(u?u["X-WebChannel-Client-Profile"]=m.va:u={"X-WebChannel-Client-Profile":m.va}),this.g.S=u,(u=m&&m.Sb)&&!ne(u)&&(this.g.m=u),this.v=m&&m.supportsCrossDomainXhr||!1,this.u=m&&m.sendRawJson||!1,(m=m&&m.httpSessionIdParam)&&!ne(m)&&(this.g.D=m,u=this.h,u!==null&&m in u&&(u=this.h,m in u&&delete u[m])),this.j=new ar(this)}B(Kt,vt),Kt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Kt.prototype.close=function(){Nt(this.g)},Kt.prototype.o=function(u){var m=this.g;if(typeof u=="string"){var v={};v.__data__=u,u=v}else this.u&&(v={},v.__data__=ha(u),u=v);m.i.push(new zl(m.Ya++,u)),m.G==3&&or(m)},Kt.prototype.N=function(){this.g.l=null,delete this.j,Nt(this.g),delete this.g,Kt.aa.N.call(this)};function iu(u){tr.call(this),u.__headers__&&(this.headers=u.__headers__,this.statusCode=u.__status__,delete u.__headers__,delete u.__status__);var m=u.__sm__;if(m){e:{for(const v in m){u=v;break e}u=void 0}(this.i=u)&&(u=this.i,m=m!==null&&u in m?m[u]:void 0),this.data=m}else this.data=u}B(iu,tr);function su(){qs.call(this),this.status=1}B(su,qs);function ar(u){this.g=u}B(ar,Pa),ar.prototype.ua=function(){_t(this.g,"a")},ar.prototype.ta=function(u){_t(this.g,new iu(u))},ar.prototype.sa=function(u){_t(this.g,new su)},ar.prototype.ra=function(){_t(this.g,"b")},lo.prototype.createWebChannel=lo.prototype.g,Kt.prototype.send=Kt.prototype.o,Kt.prototype.open=Kt.prototype.m,Kt.prototype.close=Kt.prototype.close,kw=function(){return new lo},Cw=function(){return Zi()},Aw=nr,Sf={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Gs.NO_ERROR=0,Gs.TIMEOUT=8,Gs.HTTP_ERROR=6,cc=Gs,jl.COMPLETE="complete",Sw=jl,Ws.EventType=wn,wn.OPEN="a",wn.CLOSE="b",wn.ERROR="c",wn.MESSAGE="d",vt.prototype.listen=vt.prototype.K,nl=Ws,Xe.prototype.listenOnce=Xe.prototype.L,Xe.prototype.getLastError=Xe.prototype.Ka,Xe.prototype.getLastErrorCode=Xe.prototype.Ba,Xe.prototype.getStatus=Xe.prototype.Z,Xe.prototype.getResponseJson=Xe.prototype.Oa,Xe.prototype.getResponseText=Xe.prototype.oa,Xe.prototype.send=Xe.prototype.ea,Xe.prototype.setWithCredentials=Xe.prototype.Ha,Iw=Xe}).apply(typeof ec<"u"?ec:typeof self<"u"?self:typeof window<"u"?window:{});const Zy="@firebase/firestore",ev="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(n,e,t){let i="Unexpected state";typeof e=="string"?i=e:t=e,Rw(n,i,t)}function Rw(n,e,t){let i=`FIRESTORE (${ea}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{i+=" CONTEXT: "+JSON.stringify(t)}catch{i+=" CONTEXT: "+t}throw Yr(i),new Error(i)}function Be(n,e,t,i){let o="Unexpected state";typeof t=="string"?o=t:i=t,n||Rw(e,o,i)}function Re(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e((t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)}),(t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)}))}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&Se(59440),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new J(((i,o)=>{this.nextCallback=l=>{this.wrapSuccess(e,l).next(i,o)},this.catchCallback=l=>{this.wrapFailure(t,l).next(i,o)}}))}toPromise(){return new Promise(((e,t)=>{this.next(e,t)}))}wrapUserFunction(e){try{const t=e();return t instanceof J?t:J.resolve(t)}catch(t){return J.reject(t)}}wrapSuccess(e,t){return e?this.wrapUserFunction((()=>e(t))):J.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction((()=>e(t))):J.reject(t)}static resolve(e){return new J(((t,i)=>{t(e)}))}static reject(e){return new J(((t,i)=>{i(e)}))}static waitFor(e){return new J(((t,i)=>{let o=0,l=0,c=!1;e.forEach((f=>{++o,f.next((()=>{++l,c&&l===o&&t()}),(p=>i(p)))})),c=!0,l===o&&t()}))}static or(e){let t=J.resolve(!1);for(const i of e)t=t.next((o=>o?J.resolve(o):i()));return t}static forEach(e,t){const i=[];return e.forEach(((o,l)=>{i.push(t.call(this,o,l))})),this.waitFor(i)}static mapArray(e,t){return new J(((i,o)=>{const l=e.length,c=new Array(l);let f=0;for(let p=0;p<l;p++){const y=p;t(e[y]).next((w=>{c[y]=w,++f,f===l&&i(c)}),(w=>o(w)))}}))}static doWhile(e,t){return new J(((i,o)=>{const l=()=>{e()===!0?t().next((()=>{l()}),o):i()};l()}))}}function lk(n){const e=n.match(/Android ([\d.]+)/i),t=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(t)}function na(n){return n.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gR{constructor(){this.Dn=new yR}addToCollectionParentIndex(e,t){return this.Dn.add(t),J.resolve()}getCollectionParents(e,t){return J.resolve(this.Dn.getEntries(t))}addFieldIndex(e,t){return J.resolve()}deleteFieldIndex(e,t){return J.resolve()}deleteAllFieldIndexes(e){return J.resolve()}createTargetIndexes(e,t){return J.resolve()}getDocumentsMatchingTarget(e,t){return J.resolve(null)}getIndexType(e,t){return J.resolve(0)}getFieldIndexes(e,t){return J.resolve([])}getNextCollectionGroupToUpdate(e){return J.resolve(null)}getMinOffset(e,t){return J.resolve(ji.min())}getMinOffsetFromCollectionGroup(e,t){return J.resolve(ji.min())}updateCollectionGroup(e,t,i){return J.resolve()}updateIndexEntries(e,t){return J.resolve()}}class yR{constructor(){this.index={}}add(e){const t=e.lastSegment(),i=e.popLast(),o=this.index[t]||new It(Ke.comparator),l=!o.has(i);return this.index[t]=o.add(i),l}has(e){const t=e.lastSegment(),i=e.popLast(),o=this.index[t];return o&&o.has(i)}getEntries(e){return(this.index[e]||new It(Ke.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IR{constructor(){this.changes=new Ls((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Wt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const i=this.changes.get(t);return i!==void 0?J.resolve(i):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CR{constructor(e){this.serializer=e,this.Br=new Map,this.Lr=new Map}getBundleMetadata(e,t){return J.resolve(this.Br.get(t))}saveBundleMetadata(e,t){return this.Br.set(t.id,(function(o){return{id:o.id,version:o.version,createTime:vr(o.createTime)}})(t)),J.resolve()}getNamedQuery(e,t){return J.resolve(this.Lr.get(t))}saveNamedQuery(e,t){return this.Lr.set(t.name,(function(o){return{name:o.name,query:mR(o.bundledQuery),readTime:vr(o.readTime)}})(t)),J.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kR{constructor(){this.overlays=new rt(ve.comparator),this.kr=new Map}getOverlay(e,t){return J.resolve(this.overlays.get(t))}getOverlays(e,t){const i=Ss();return J.forEach(t,(o=>this.getOverlay(e,o).next((l=>{l!==null&&i.set(o,l)})))).next((()=>i))}saveOverlays(e,t,i){return i.forEach(((o,l)=>{this.wt(e,t,l)})),J.resolve()}removeOverlaysForBatchId(e,t,i){const o=this.kr.get(i);return o!==void 0&&(o.forEach((l=>this.overlays=this.overlays.remove(l))),this.kr.delete(i)),J.resolve()}getOverlaysForCollection(e,t,i){const o=Ss(),l=t.length+1,c=new ve(t.child("")),f=this.overlays.getIteratorFrom(c);for(;f.hasNext();){const p=f.getNext().value,y=p.getKey();if(!t.isPrefixOf(y.path))break;y.path.length===l&&p.largestBatchId>i&&o.set(p.getKey(),p)}return J.resolve(o)}getOverlaysForCollectionGroup(e,t,i,o){let l=new rt(((y,w)=>y-w));const c=this.overlays.getIterator();for(;c.hasNext();){const y=c.getNext().value;if(y.getKey().getCollectionGroup()===t&&y.largestBatchId>i){let w=l.get(y.largestBatchId);w===null&&(w=Ss(),l=l.insert(y.largestBatchId,w)),w.set(y.getKey(),y)}}const f=Ss(),p=l.getIterator();for(;p.hasNext()&&(p.getNext().value.forEach(((y,w)=>f.set(y,w))),!(f.size()>=o)););return J.resolve(f)}wt(e,t,i){const o=this.overlays.get(i.key);if(o!==null){const c=this.kr.get(o.largestBatchId).delete(i.key);this.kr.set(o.largestBatchId,c)}this.overlays=this.overlays.insert(i.key,new Hk(t,i));let l=this.kr.get(t);l===void 0&&(l=Oe(),this.kr.set(t,l)),this.kr.set(t,l.add(i.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RR{constructor(){this.sessionToken=Lt.EMPTY_BYTE_STRING}getSessionToken(e){return J.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,J.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PR{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.er=1,this.Yr=new It(Rt.Qr)}checkEmpty(e){return J.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,i,o){const l=this.er;this.er++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const c=new qk(l,t,i,o);this.mutationQueue.push(c);for(const f of o)this.Yr=this.Yr.add(new Rt(f.key,l)),this.indexManager.addToCollectionParentIndex(e,f.key.path.popLast());return J.resolve(c)}lookupMutationBatch(e,t){return J.resolve(this.Zr(t))}getNextMutationBatchAfterBatchId(e,t){const i=t+1,o=this.Xr(i),l=o<0?0:o;return J.resolve(this.mutationQueue.length>l?this.mutationQueue[l]:null)}getHighestUnacknowledgedBatchId(){return J.resolve(this.mutationQueue.length===0?up:this.er-1)}getAllMutationBatches(e){return J.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const i=new Rt(t,0),o=new Rt(t,Number.POSITIVE_INFINITY),l=[];return this.Yr.forEachInRange([i,o],(c=>{const f=this.Zr(c.Hr);l.push(f)})),J.resolve(l)}getAllMutationBatchesAffectingDocumentKeys(e,t){let i=new It(xe);return t.forEach((o=>{const l=new Rt(o,0),c=new Rt(o,Number.POSITIVE_INFINITY);this.Yr.forEachInRange([l,c],(f=>{i=i.add(f.Hr)}))})),J.resolve(this.ei(i))}getAllMutationBatchesAffectingQuery(e,t){const i=t.path,o=i.length+1;let l=i;ve.isDocumentKey(l)||(l=l.child(""));const c=new Rt(new ve(l),0);let f=new It(xe);return this.Yr.forEachWhile((p=>{const y=p.key.path;return!!i.isPrefixOf(y)&&(y.length===o&&(f=f.add(p.Hr)),!0)}),c),J.resolve(this.ei(f))}ei(e){const t=[];return e.forEach((i=>{const o=this.Zr(i);o!==null&&t.push(o)})),t}removeMutationBatch(e,t){Be(this.ti(t.batchId,"removed")===0,55003),this.mutationQueue.shift();let i=this.Yr;return J.forEach(t.mutations,(o=>{const l=new Rt(o.key,t.batchId);return i=i.delete(l),this.referenceDelegate.markPotentiallyOrphaned(e,o.key)})).next((()=>{this.Yr=i}))}rr(e){}containsKey(e,t){const i=new Rt(t,0),o=this.Yr.firstAfterOrEqual(i);return J.resolve(t.isEqual(o&&o.key))}performConsistencyCheck(e){return this.mutationQueue.length,J.resolve()}ti(e,t){return this.Xr(e)}Xr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Zr(e){const t=this.Xr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bR{constructor(e){this.persistence=e,this.ii=new Ls((t=>hp(t)),fp),this.lastRemoteSnapshotVersion=Ce.min(),this.highestTargetId=0,this.si=0,this.oi=new _p,this.targetCount=0,this._i=qo.ar()}forEachTarget(e,t){return this.ii.forEach(((i,o)=>t(o))),J.resolve()}getLastRemoteSnapshotVersion(e){return J.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return J.resolve(this.si)}allocateTargetId(e){return this.highestTargetId=this._i.next(),J.resolve(this.highestTargetId)}setTargetsMetadata(e,t,i){return i&&(this.lastRemoteSnapshotVersion=i),t>this.si&&(this.si=t),J.resolve()}hr(e){this.ii.set(e.target,e);const t=e.targetId;t>this.highestTargetId&&(this._i=new qo(t),this.highestTargetId=t),e.sequenceNumber>this.si&&(this.si=e.sequenceNumber)}addTargetData(e,t){return this.hr(t),this.targetCount+=1,J.resolve()}updateTargetData(e,t){return this.hr(t),J.resolve()}removeTargetData(e,t){return this.ii.delete(t.target),this.oi.zr(t.targetId),this.targetCount-=1,J.resolve()}removeTargets(e,t,i){let o=0;const l=[];return this.ii.forEach(((c,f)=>{f.sequenceNumber<=t&&i.get(f.targetId)===null&&(this.ii.delete(c),l.push(this.removeMatchingKeysForTargetId(e,f.targetId)),o++)})),J.waitFor(l).next((()=>o))}getTargetCount(e){return J.resolve(this.targetCount)}getTargetData(e,t){const i=this.ii.get(t)||null;return J.resolve(i)}addMatchingKeys(e,t,i){return this.oi.Kr(t,i),J.resolve()}removeMatchingKeys(e,t,i){this.oi.Gr(t,i);const o=this.persistence.referenceDelegate,l=[];return o&&t.forEach((c=>{l.push(o.markPotentiallyOrphaned(e,c))})),J.waitFor(l)}removeMatchingKeysForTargetId(e,t){return this.oi.zr(t),J.resolve()}getMatchingKeysForTargetId(e,t){const i=this.oi.Jr(t);return J.resolve(i)}containsKey(e,t){return J.resolve(this.oi.containsKey(t))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VR{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=(function(){return lS()?8:lk(qt())>0?6:4})()}initialize(e,t){this.gs=e,this.indexManager=t,this.As=!0}getDocumentsMatchingQuery(e,t,i,o){const l={result:null};return this.ps(e,t).next((c=>{l.result=c})).next((()=>{if(!l.result)return this.ys(e,t,o,i).next((c=>{l.result=c}))})).next((()=>{if(l.result)return;const c=new OR;return this.ws(e,t,c).next((f=>{if(l.result=f,this.Rs)return this.Ss(e,t,c,f.size)}))})).next((()=>l.result))}Ss(e,t,i,o){return i.documentReadCount<this.Vs?(No()<=De.DEBUG&&de("QueryEngine","SDK will not create cache indexes for query:",bo(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),J.resolve()):(No()<=De.DEBUG&&de("QueryEngine","Query:",bo(t),"scans",i.documentReadCount,"local documents and returns",o,"documents as results."),i.documentReadCount>this.fs*o?(No()<=De.DEBUG&&de("QueryEngine","The SDK decides to create cache indexes for query:",bo(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,yr(t))):J.resolve())}ps(e,t){if(_v(t))return J.resolve(null);let i=yr(t);return this.indexManager.getIndexType(e,i).next((o=>o===0?null:(t.limit!==null&&o===1&&(t=Nf(t,null,"F"),i=yr(t)),this.indexManager.getDocumentsMatchingTarget(e,i).next((l=>{const c=Oe(...l);return this.gs.getDocuments(e,c).next((f=>this.indexManager.getMinOffset(e,i).next((p=>{const y=this.bs(t,f);return this.Ds(t,y,c,p.readTime)?this.ps(e,Nf(t,null,"F")):this.vs(e,y,t,p)}))))})))))}ys(e,t,i,o){return _v(t)||o.isEqual(Ce.min())?J.resolve(null):this.gs.getDocuments(e,i).next((l=>{const c=this.bs(t,l);return this.Ds(t,c,i,o)?J.resolve(null):(No()<=De.DEBUG&&de("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),bo(t)),this.vs(e,c,t,rk(o,gl)).next((f=>f)))}))}bs(e,t){let i=new It(Jw(e));return t.forEach(((o,l)=>{Zc(e,l)&&(i=i.add(l))})),i}Ds(e,t,i,o){if(e.limit===null)return!1;if(i.size!==t.size)return!0;const l=e.limitType==="F"?t.last():t.first();return!!l&&(l.hasPendingWrites||l.version.compareTo(o)>0)}ws(e,t,i){return No()<=De.DEBUG&&de("QueryEngine","Using full collection scan to execute query:",bo(t)),this.gs.getDocumentsMatchingQuery(e,t,ji.min(),i)}vs(e,t,i,o){return this.gs.getDocumentsMatchingQuery(e,i,o).next((l=>(t.forEach((c=>{l=l.insert(c.key,c)})),l)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
